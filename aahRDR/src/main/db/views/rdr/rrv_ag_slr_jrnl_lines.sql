...
select
  ...
  left join ( select
            ...
            group by
                     faei2.ae_client_spare_id14
                   , faei2.ae_client_spare_id12
                   , faei2.ae_client_spare_id16 ) faei  on jl.jl_source_jrnl_id = faei.ae_acc_event_id
union all
select
       jlu_jrnl_hdr_id
...
select
     ...
     , jlu_fak_id
     , jlu_eba_id
     , decode( jle1.jle_error_code , null , jlu_jrnl_status , 'E' )           jlu_jrnl_status
     , nvl( substr( jle1.jle_error_string , 1 , 20 ) , jlu_jrnl_status_text ) jlu_jrnl_status_text
     , jlu_jrnl_process_id
     , jlu_description
     , jlu_source_jrnl_id
     , jlu_effective_date
  ...
  left join ( select
            ...
            group by
                     jle.jle_jrnl_hdr_id ) jle1  on gjlu.jlu_jrnl_hdr_id = jle1.jle_jrnl_hdr_id
;