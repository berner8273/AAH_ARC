...
Begin
  ...
  For cRec1 in (Select distinct lkt_lookup_type_code
	...
	dbms_output.put_line('DREW' || mySQL_JLT);
    dbms_output.put_line('Tony' || mySelect_JLT);
    dbms_output.put_line('Tony' || myfrom_JLT);
    dbms_output.put_line('Tony' || mywhere_JLT);
    dbms_output.put_line('Tony' || mywhere_JLT_ex);
    dbms_output.put_line('Tony' || mywhere_JLT_IN);
    dbms_output.put_line('Tony' || myhaving_JLT);
    ...
    sys.dbms_application_info.set_action('Insert into RR_GLINT_JOURNAL_LINE');
		dbms_output.put_line('DREW  mySQL_JL ' || mySQL_JL);
