		...
		(
			...
			(
             ...
             AND ((JT_BALANCE_TYPE = ''20'' AND ent.ENT_ADJUSTMENT_FLAG = ''Y'') OR JT_BALANCE_TYPE <> ''20'')
				...
				GROUP BY EDB_BALANCE_DATE, EDB_EBA_ID, EDB_FAK_ID, EDB_BALANCE_TYPE, EDB_ENTITY, EDB_EPG_ID, EDB_PERIOD_MONTH, EDB_PERIOD_MONTH, EDB_PERIOD_QTR, EDB_PERIOD_LTD
				UNION ALL
				SELECT /*+ NO_MERGE */
