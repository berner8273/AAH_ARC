CREATE OR REPLACE PACKAGE BODY GUI.PGUI_MANUAL_JOURNAL AS

    /******************************************************************************************
    Declare private processes
    ******************************************************************************************/

    FUNCTION fnui_validate_journal_header                             RETURN CHAR;
    FUNCTION fnui_validate_journal_line(clear_errors BOOLEAN DEFAULT TRUE)					    RETURN CHAR;
    FUNCTION fnui_resync_journal_lines(sync_temp BOOLEAN DEFAULT TRUE)					    	RETURN BOOLEAN;
    FUNCTION fnui_validate_header_dates														    RETURN BOOLEAN;
    ...
    FUNCTION fnui_validate_chartfield1                         RETURN BOOLEAN; -- AG Custom
    ...
    FUNCTION fnui_get_entity                                    RETURN BOOLEAN;
    FUNCTION fnui_get_fak_definitions                               RETURN BOOLEAN;
    FUNCTION fnui_get_eba_definitions                               RETURN BOOLEAN;
    FUNCTION fnui_check_month_end_limits                                RETURN BOOLEAN;
    FUNCTION fnui_validate_segment_n( segment_no IN NUMBER )                      RETURN BOOLEAN;
    FUNCTION fnui_validate_attribute_n( attribute_no IN NUMBER )                    RETURN BOOLEAN;
    FUNCTION fnui_requires_authorisation                                RETURN BOOLEAN;
    FUNCTION fnui_check_copy_journal                                  RETURN BOOLEAN;
    FUNCTION fnui_check_quick_reversal                                  RETURN BOOLEAN;
    FUNCTION fnui_check_deletion(journal_id VARCHAR2)                           RETURN BOOLEAN;
    FUNCTION fnui_check_copy_line(journal_id VARCHAR2, line_number NUMBER)                RETURN BOOLEAN;
    FUNCTION fnui_check_delete_line(journal_id VARCHAR2, line_number NUMBER)                RETURN BOOLEAN;
    FUNCTION fnui_check_header_definitions                                RETURN BOOLEAN;
    FUNCTION fnui_check_line_definitions                                RETURN BOOLEAN;
    FUNCTION fnui_journal_edit_permission(owner VARCHAR2, editor VARCHAR2)                RETURN BOOLEAN;
    FUNCTION fnui_does_journal_exist(journal_id VARCHAR2)                         RETURN BOOLEAN;
    FUNCTION fnui_does_line_exist(journal_id VARCHAR2, line_no NUMBER)                  RETURN BOOLEAN;
    FUNCTION fnui_merge_header                                      RETURN BOOLEAN;
    FUNCTION fnui_merge_lines                                     RETURN BOOLEAN;
    FUNCTION fnui_decode_journal_lines                                  RETURN BOOLEAN;
    FUNCTION fnui_any_errors(journal_id VARCHAR2)                             RETURN BOOLEAN;
    FUNCTION fnui_create_copy_journal(original_jrnl_id VARCHAR2)                      RETURN BOOLEAN;
    FUNCTION fnui_create_reversing_journal(orignal_jrnl_id SLR_JRNL_HEADERS_UNPOSTED.JHU_JRNL_ID%TYPE, reversing_date DATE, entity_proc_group VARCHAR2, status CHAR) RETURN BOOLEAN;
    FUNCTION fnui_check_calendar                                                                RETURN BOOLEAN;
    FUNCTION fnui_get_reversing_journal( journal_id IN VARCHAR2)                      RETURN VARCHAR2;
    FUNCTION fnui_get_adjustment_journal( journal_id IN VARCHAR2)                   RETURN VARCHAR2;
    FUNCTION fnui_check_ent_proc_group_conf                                                     RETURN BOOLEAN;

    -- AG custom functions
	FUNCTION fnui_validate_madj_source    RETURN BOOLEAN;
    FUNCTION fnui_validate_madj_effective_date RETURN BOOLEAN;
    FUNCTION fnui_validate_acc_event_type RETURN BOOLEAN;
    FUNCTION fnui_validate_ledger         RETURN BOOLEAN;
    PROCEDURE prui_process_param_list(list_string IN VARCHAR2, return_array OUT array_list, array_count OUT NUMBER);
    PROCEDURE prui_set_status(journal_id VARCHAR2, status CHAR);
    ...
    PROCEDURE prui_write_errors_to_database(journal_id VARCHAR2 DEFAULT NULL);
    PROCEDURE prui_update_header_stats(journal_id IN VARCHAR2);
    PROCEDURE prui_reorder_journal_lines(journal_id VARCHAR2);
    PROCEDURE prui_populate_header( session_id      IN    VARCHAR2,
                                    ...
                                    department_id   IN SLR_JRNL_HEADERS_UNPOSTED.JHU_DEPARTMENT_ID%TYPE DEFAULT 'DEFAULT'
                  );
    PROCEDURE prui_populate_line( session_id    IN VARCHAR2,
                                  ...
                                  attribute_4   IN TEMP_GUI_JRNL_LINES_UNPOSTED.JLU_ATTRIBUTE_4%TYPE DEFAULT 'MANUAL_ADJ', -- AG Custom
    ...
    PROCEDURE prui_clear_errors( journal_id  IN SLR_JRNL_LINES_UNPOSTED.JLU_JRNL_HDR_ID%TYPE,
                                 line_number IN SLR_JRNL_LINES.JL_JRNL_LINE_NUMBER%TYPE DEFAULT 0 );

    FUNCTION fGetEntityProcGroup( pJrnlHdrID          in SLR_JRNL_HEADERS_UNPOSTED.JHU_JRNL_ID%TYPE,
                                  session_id          in VARCHAR2
                                 )  RETURN SLR_ENTITY_PROC_GROUP.EPG_ID%TYPE;
                                 FUNCTION fnui_validate_jrnl_type                                                  RETURN BOOLEAN;

    PROCEDURE prui_increment_journal_version(journal_id IN VARCHAR2, updated_by IN SLR_JRNL_HEADERS.JH_CREATED_BY%TYPE  );
    ...
    PROCEDURE prui_set_gui_jrnls_status(journal_id_list IN VARCHAR2, status IN CHAR);
    FUNCTION fnui_anything_to_post(journal_id_list VARCHAR2, status CHAR) RETURN BOOLEAN;
    PROCEDURE prui_mark_future_dated_jrnls(epg_id IN VARCHAR2,journal_id_list IN VARCHAR2, status CHAR);
    PROCEDURE prui_lock_journal(journal_id IN VARCHAR2,locked_by IN VARCHAR2);
    PROCEDURE prui_unlock_journal(journal_id IN VARCHAR2, locked_by in varchar2);
    PROCEDURE prui_check_journal_version(journal_id IN VARCHAR2, journal_version IN NUMBER);
  ...
  -- TTP 775
    ...
    ******************************************************************************************/
    ...
    BEGIN
        ...
        IF journal_type != gSTATUS_POSTED THEN
        ...
        lv_sql_statement :=
            'SELECT '
                ||lv_head_prefix||'_jrnl_id,'
                ||lv_head_prefix||'_jrnl_entity,'
                ||lv_head_prefix||'_jrnl_type,'
                ||lv_head_prefix||'_jrnl_source,'
                ||lv_head_prefix||'_jrnl_date,'
                ||lv_head_prefix||'_jrnl_rev_date, '
                ||lv_head_prefix||'_created_by,'
                ||lv_head_prefix||'_department_id,'
                ||lv_head_prefix||'_created_on,'
                ||lv_head_prefix||'_amended_by,'
                ||lv_head_prefix||'_amended_on,'
                ||lv_head_prefix||'_jrnl_authorised_by,'
                ||lv_head_prefix||'_jrnl_authorised_on,'
                ||lv_head_prefix||'_jrnl_total_lines,'
                ||lv_head_prefix||'_jrnl_status, '
                ||lv_head_prefix||'_jrnl_status_text, '
                ||lv_head_prefix||'_jrnl_validated_by, '
                ||lv_head_prefix||'_jrnl_validated_on, '
                ||lv_head_prefix||'_jrnl_posted_by, '
                ||lv_head_prefix||'_jrnl_posted_on, '
                ||'SUM(SIGN('||lv_line_prefix||'_base_amount),-1,'||lv_line_prefix||'_base_amount,0)) as base_credits,'
                ||'SUM(SIGN('||lv_line_prefix||'_base_amount),1,'||lv_line_prefix||'_base_amount,0)) as base_debits,'
                ||'SUM(SIGN('||lv_line_prefix||'_local_amount),-1,'||lv_line_prefix||'_local_amount,0)) as local_credits,'
                ||'SUM(SIGN('||lv_line_prefix||'_amount),1,'||lv_line_prefix||'_local_amount,0)) as local_debits,'
                ||'SUM(SIGN('||lv_line_prefix||'_tran_amount),-1,'||lv_line_prefix||'_tran_amount,0)) as tran_credits,'
                ||'SUM(SIGN('||lv_line_prefix||'_tran_amount),1,'||lv_line_prefix||'_tran_amount,0)) as tran_debits,'
                ||'SUM('||lv_line_prefix||'_base_amount) as total_base,'
                ||'SUM('||lv_line_prefix||'_local_amount) as total_local, '
                ||'SUM('||lv_line_prefix||'_tran_amount) as total_tran, '
                ||'MAX('||lv_line_prefix||'_base_currency) as base_currency, '
                ||'MAX('||lv_line_prefix||'_local_currency) as local_currency, '
                ||'DECODE('''||UPPER(user_id)||''',UPPER(amended_by), 1, '
            ...
            lv_sql_statement := lv_sql_statement
                ||'WHERE '
                ||lv_head_prefix||'_jrnl_id = '||lv_line_prefix||'_jrnl_hdr_id(+) '
                ||'AND '||lv_head_prefix||'_jrnl_entity IN ('''||REPLACE(entity_list, ',', ''',''')||''') '
                ||'AND '||lv_head_prefix||'_created_by IN ' -- Restrict user to view journals in their groups or sub-groups
                ...
                ||'   AND    parent.mmg_user_id = '''||user_id||''' '
                ||'   UNION '
                ||'   SELECT child.mmg_user_id '
        ...
        IF journal_id IS NOT NULL THEN
           lv_sql_statement := lv_sql_statement || ' AND '||lv_head_prefix||'_jrnl_id = '''||journal_id||'''';
        END IF;

        IF journal_type IS NOT NULL AND journal_type != gSTATUS_POSTED THEN
           lv_sql_statement := lv_sql_statement || ' AND '||lv_head_prefix||'_jrnl_type = '''||journal_type||''' ';
        END IF;

        IF entity IS NOT NULL THEN
           lv_sql_statement := lv_sql_statement || ' AND '||lv_head_prefix||'_jrnl_entity = '''||entity||''' ';
        END IF;

        IF source_system IS NOT NULL THEN
           lv_sql_statement := lv_sql_statement || ' AND '||lv_head_prefix||'_jrnl_source = '''||source_system||''' ';
        END IF;

        IF effective_date IS NOT NULL THEN
           lv_sql_statement := lv_sql_statement || ' AND '||lv_head_prefix||'_jrnl_date = TO_DATE('''||effective_date||''', ''dd-mm-yyyy hh24:mi:ss'') ';
        END IF;

        IF reversing_date IS NOT NULL THEN
           lv_sql_statement := lv_sql_statement || ' AND '||lv_head_prefix||'_jrnl_rev_date = TO_DATE('''||reversing_date||''', ''DD-MM-YYYY'') ';
        END IF;

        IF description IS NOT NULL THEN
           lv_sql_statement := lv_sql_statement || ' AND '||lv_head_prefix||'_jrnl_description LIKE ''%'||description||'%'' ';
        END IF;

        IF created_by IS NOT NULL THEN
           lv_sql_statement := lv_sql_statement ||  ' AND '||lv_head_prefix||'_created_by LIKE ''%'||created_by||'%'' ';
        END IF;

        IF created_on IS NOT NULL THEN
           lv_sql_statement := lv_sql_statement || ' AND '||lv_head_prefix||'_created_on = TO_DATE('''||created_on||''', ''dd-mm-yyyy hh24:mi:ss'') ';
        END IF;

        IF updated_by IS NOT NULL THEN
           lv_sql_statement := lv_sql_statement || ' AND '||lv_head_prefix||'_updated_by LIKE ''%'||updated_by||'%'' ';
        END IF;

        IF updated_on IS NOT NULL THEN
           lv_sql_statement := lv_sql_statement || ' AND '||lv_head_prefix||'_updated_on = TO_DATE('''||updated_on||''', ''dd-mm-yyyy hh24:mi:ss'') ';
        END IF;

        IF posted_by IS NOT NULL THEN
           lv_sql_statement := lv_sql_statement || ' AND '||lv_head_prefix||'_posted_by LIKE ''%'||posted_by||'%'' ';
        END IF;

        IF posted_on IS NOT NULL THEN
           lv_sql_statement := lv_sql_statement || ' AND '||lv_head_prefix||'_jrnl_posted_on = TO_DATE('''||posted_on||''', ''dd-mm-yyyy hh24:mi:ss'') ';
        END IF;

        IF authorised_by IS NOT NULL THEN
           lv_sql_statement := lv_sql_statement || ' AND '||lv_head_prefix||'_authorised_by LIKE ''%'||authorised_by||'%'' ';
        END IF;

        IF authorised_on IS NOT NULL THEN
           lv_sql_statement := lv_sql_statement || ' AND '||lv_head_prefix||'_jrnl_authorised_on = TO_DATE('''||authorised_on||''', ''dd-mm-yyyy hh24:mi:ss'') ';
        END IF;

        -- Limit the max number of row to return
        lv_sql_statement := lv_sql_statement || ' AND rownum < '||TO_CHAR(lv_max_no_rows);
        ...
        lv_sql_statement := lv_sql_statement
            ||'GROUP BY '
                ...
                ||lv_head_prefix||'_jrnl_posted_on '
            ||'ORDER BY '
                ||lv_head_prefix||'_amended_on desc';

        EXECUTE IMMEDIATE lv_sql_statement INTO resultset;

    EXCEPTION
        WHEN OTHERS THEN
            pr_error(1, SQLERRM, 0, 'prui_search_headers', 'slr_jrnl_headers_unposted', NULL, NULL, gPackageName, 'PL/SQL', NULL, NULL, NULL, NULL, NULL, NULL, NULL);
    END;
    ...
    PROCEDURE prui_get_header(
        ...
        resultset       OUT   global_ref_cursor )
    IS
      jrnl_id SLR_JRNL_HEADERS_UNPOSTED.JHU_JRNL_ID%TYPE;
    BEGIN
        ...
        EXCEPTION
            WHEN NO_DATA_FOUND THEN
                 NULL;
            WHEN OTHERS THEN
                 pr_error(1, SQLERRM, 0, 'prui_get_header', 'slr_jrnl_headers_unposted', NULL, NULL, gPackageName, 'PL/SQL', NULL, NULL, NULL, NULL, NULL, NULL, NULL);
                 RAISE;
        END;
        ...
        OPEN resultset FOR
            SELECT
                ...
                SUM(DECODE(SIGN(sjlu.jlu_base_amount),-1,sjlu.jlu_base_amount,0)) as base_credits,
                SUM(DECODE(SIGN(sjlu.jlu_base_amount),1,sjlu.jlu_base_amount,0)) as base_debits,
                SUM(DECODE(SIGN(sjlu.jlu_local_amount),-1,sjlu.jlu_local_amount,0)) as local_credits,
                SUM(DECODE(SIGN(sjlu.jlu_local_amount),1,sjlu.jlu_local_amount,0)) as local_debits,
                SUM(DECODE(SIGN(sjlu.jlu_tran_amount),-1,sjlu.jlu_tran_amount,0)) as tran_credits,
                SUM(DECODE(SIGN(sjlu.jlu_tran_amount),1,sjlu.jlu_tran_amount,0)) as tran_debits,
            ...
            FROM
                ...
                slr_jrnl_lines_unposted sjlu
            WHERE
                sjhu.jhu_jrnl_id = sjlu.jlu_jrnl_hdr_id(+) AND
                sjhu.jhu_jrnl_id = jrnl_id
            GROUP BY
                sjhu.jhu_jrnl_id,
                sjhu.jhu_jrnl_type,
                sjhu.jhu_jrnl_date,
    ...
    BEGIN
        ...
        OPEN resultset FOR
            SELECT
                ...
                fnui_fdr_to_source('segment_1',coding_convention,sjlu.jlu_segment_1) as jlu_segment_1,
                fnui_fdr_to_source('segment_2',coding_convention,sjlu.jlu_segment_2) as jlu_segment_2,
                fnui_fdr_to_source('segment_3',coding_convention,sjlu.jlu_segment_3) as jlu_segment_3,
                fnui_fdr_to_source('segment_4',coding_convention,sjlu.jlu_segment_4) as jlu_segment_4,
                fnui_fdr_to_source('segment_5',coding_convention,sjlu.jlu_segment_5) as jlu_segment_5,
                fnui_fdr_to_source('segment_6',coding_convention,sjlu.jlu_segment_6) as jlu_segment_6,
                fnui_fdr_to_source('segment_7',coding_convention,sjlu.jlu_segment_7) as jlu_segment_7,
                fnui_fdr_to_source('segment_8',coding_convention,sjlu.jlu_segment_8) as jlu_segment_8,
                fnui_fdr_to_source('segment_9',coding_convention,sjlu.jlu_segment_9) as jlu_segment_9,
                fnui_fdr_to_source('segment_10',coding_convention,sjlu.jlu_segment_10) as jlu_segment_10,
                fnui_fdr_to_source('attribute_1',coding_convention,sjlu.jlu_attribute_1) as jlu_attribute_1,
                fnui_fdr_to_source('attribute_2',coding_convention,sjlu.jlu_attribute_2) as jlu_attribute_2,
                fnui_fdr_to_source('attribute_3',coding_convention,sjlu.jlu_attribute_3) as jlu_attribute_3,
                fnui_fdr_to_source('attribute_4',coding_convention,sjlu.jlu_attribute_4) as jlu_attribute_4,
                fnui_fdr_to_source('attribute_5',coding_convention,sjlu.jlu_attribute_5) as jlu_attribute_5,
                ...
                CASE WHEN sjlu.jlu_tran_amount<0 THEN 'D' ELSE 'C' END as lineType,
            ...
            FROM
                ...
                fr_currency syuc
            WHERE
                sjlu.jlu_jrnl_hdr_id = sjhu.jhu_jrnl_id AND
                sjlu.jlu_tran_ccy = syuc.cu_currency_id(+) AND
                sjlu.jlu_jrnl_hdr_id = journal_id;

    EXCEPTION
        WHEN OTHERS THEN
            pr_error(1, SQLERRM, 0, 'prui_get_lines', 'slr_jrnl_lines_unposted', NULL, NULL, gPackageName, 'PL/SQL', NULL, NULL, NULL, NULL, NULL, NULL, NULL);
    END prui_get_lines;
    ...
    BEGIN
        ...
        OPEN resultset FOR
            SELECT
                ...
                sjlu.jlu_base_ccy,
                NVL(sjlu.jlu_base_amount,0),
                CASE WHEN sjlu.jlu_tran_amount<0 THEN 'C' ELSE 'D' END as lineType,
                NVL(sjlu.jlu_local_rate,0),
                sjhu.jhu_jrnl_pref_static_src,
                sjhu.jhu_jrnl_type
            FROM
            ...
            WHERE
                sjlu.jlu_jrnl_hdr_id = sjhu.jhu_jrnl_id AND
                sjlu.jlu_tran_ccy = syuc.cu_currency_id(+) AND
                sjlu.jlu_jrnl_hdr_id = journal_id AND
                jlu_jrnl_line_number = line_no;

    EXCEPTION
        WHEN OTHERS THEN
            pr_error(1, SQLERRM, 0, 'prui_get_line', 'slr_jrnl_lines_unposted', NULL, NULL, gPackageName, 'PL/SQL', NULL, NULL, NULL, NULL, NULL, NULL, NULL);
    END prui_get_line;
    ...
    BEGIN
         ...
         prui_populate_header( session_id, journal_id,  journal_type, entity, source_system,
                               TO_DATE(effective_date, 'dd-mm-yyyy hh24:mi:ss'), TO_DATE(reversing_date, 'dd-mm-yyyy hh24:mi:ss'),
                               description, coding_convention, updated_by, 'Y', department_id );

         journal_id_out := gJournalHeader.jhu_jrnl_id;

         IF NOT fnui_resync_journal_lines(TRUE) THEN
            prui_log_error(gJournalHeader.jhu_jrnl_id, 0, 1090, 'Failed to synchronise Journal reference data in temp lines');
            success := 'F';
            journal_version_out := gJournalVersion;
            RETURN;
         END IF;
         ...
         IF no_validate = 'N' THEN

             lvValidateState := fnui_validate_journal_header;
             IF lvValidateState IN (gSTATE_CRITICAL) THEN
                success := 'F';
             END IF;

             -- Save changes
             IF lvValidateState IN (gSTATE_OK, gSTATE_ERRORED) THEN
                 IF NOT fnui_merge_header THEN
                    success := 'F';
				 ELSE
					 IF NOT fnui_resync_journal_lines(FALSE) THEN
						prui_log_error(gJournalHeader.jhu_jrnl_id, 0, 1090, 'Failed to synchronise Journal reference data in lines');
						success := 'F';
						journal_version_out := gJournalVersion;
						RETURN;
					 END IF;
    ...
    BEGIN
         ...
         prui_populate_line( session_id, journal_id, line_number, account, entity,
                             TO_DATE(effective_date, 'dd-mm-yyyy hh24:mi:ss'), TO_DATE(value_date, 'dd-mm-yyyy hh24:mi:ss'),
                             segment_1, segment_2, segment_3, segment_4, segment_5, segment_6,
                             segment_7, segment_8, segment_9, segment_10, attribute_1, attribute_2,
                             attribute_3, attribute_4, attribute_5, reference_1, reference_2, reference_3, reference_4,
                             reference_5, reference_6, reference_7, reference_8, reference_9, reference_10, description,
                             tran_currency, tran_amount, base_currency, base_rate, base_amount, local_currency,
                             local_rate, local_amount, updated_by);
    ...
    BEGIN
         ...
         EXCEPTION
            WHEN OTHERS THEN
                pr_error(1, SQLERRM, 0, 'prui_bulk_submission', 'gui_jrnl_headers_unposted', NULL, NULL, gPackageName, 'PL/SQL', NULL, NULL, NULL, NULL, NULL, NULL, NULL);
                success := 'F';
                RAISE;
         END;
    ...
    EXCEPTION
        WHEN OTHERS THEN
            pr_error(1, SQLERRM, 0, 'prui_bulk_submission', 'gui_jrnl_headers_unposted/gui_jrnl_lines_unposted', NULL, NULL, gPackageName, 'PL/SQL', NULL, NULL, NULL, NULL, NULL, NULL, NULL);
            success := 'F';
    END prui_bulk_submission;

    --********************************************************************************

    PROCEDURE prui_delete_all_attachments(
        journal_id      IN SLR_JRNL_HEADERS_UNPOSTED.JHU_JRNL_ID%TYPE
    )
    IS
    BEGIN

      DELETE FROM GUI_JRNL_FILE WHERE JF_JRNL_HDR_ID = journal_id;

      EXCEPTION
        WHEN others THEN
          pr_error(1, 'Unable to delete Journal Attachments of journal '||journal_id, 0, 'prui_delete_all_attachments', 'gui_jrnl_file', NULL, NULL, gPackageName, 'PL/SQL', NULL, NULL, NULL, NULL, NULL, NULL, NULL);
    end prui_delete_all_attachments;
        ...
        exception
         ...
         IF fnui_check_deletion(journal_id) THEN
            ...
            BEGIN
                 ...
                 --delete attachments/journal files first
                 prui_delete_all_attachments(journal_id);

            EXCEPTION
                WHEN OTHERS THEN
                    ROLLBACK TO SAVEPOINT prui_delete_journal;
                    prui_log_error(journal_id, 0, 1070, 'Unable to delete Journal');
         ...
         FOR loop_count IN 1..list_count LOOP
          ...
          IF lv_success <> 'S' THEN
              ...
              if journal_list_in_error is not null then
                journal_list_in_error := journal_list_in_error||','||lv_journal_id;
              ELSE
                journal_list_in_error := lv_journal_id;
              END IF;
    ...
    BEGIN
        ...
        exception
         ...
         FOR loop_count IN 1..line_count LOOP

             -- Delete line (if action valid)
             IF fnui_check_delete_line(journal_id, TO_NUMBER(line_list(loop_count))) = TRUE THEN
                ...
                EXCEPTION
                    WHEN OTHERS THEN
                        ...
                        prui_log_error(journal_id, line_list(loop_count), 1070, 'Unable to delete Journal Line');
    ...
    BEGIN
        ...
        IF fnui_check_quick_reversal THEN
           IF NOT fnui_create_reversing_journal(journal_id, reversing_date, NULL, NULL) THEN
              success := 'N';
           ELSE
    ...
    EXCEPTION
        WHEN OTHERS THEN
             pr_error(1, SQLERRM, 0, 'prui_reverse_line', 'slr_jrnl_headers_unposted', NULL, NULL, gPackageName, 'PL/SQL', NULL, NULL, NULL, NULL, NULL, NULL, NULL);
             success := 'N';
    ...
    BEGIN
        ...
        IF fnui_check_copy_journal THEN
           IF NOT fnui_create_copy_journal(journal_id) THEN
              success := 'N';
           ELSE
              new_jrnl_id := gJournalHeader.jhu_jrnl_id;
           END IF;
    ...
    EXCEPTION
        WHEN OTHERS THEN
             pr_error(1, SQLERRM, 0, 'prui_copy_journal', 'slr_jrnl_headers_unposted', NULL, NULL, gPackageName, 'PL/SQL', NULL, NULL, NULL, NULL, NULL, NULL, NULL);
             success := 'N';
    ...
    EXCEPTION
      when others then
       pr_error(1, SQLERRM, 0, 'prui_post_journals', 'gui_jrnl_headers_unposted', NULL, NULL, gPackageName, 'PL/SQL', NULL, NULL, NULL, NULL, NULL, NULL, NULL);
       success := 'F';
         ...
         ELSE
           ...
           exception
            WHEN others THEN
              ...
              prui_log_error(journal_id, 0, 9999, 'Failed to add journal to the posting queue.');
              prui_write_errors_to_database(journal_id);
              --commit;
              raise;
           end;
    ...
    BEGIN
         ...
         FOR loop_count IN 1..line_count LOOP
             ...
             IF fnui_check_copy_line(journal_id, TO_NUMBER(line_list(loop_count))) THEN
                ...
                BEGIN
                    ...
                    INSERT INTO temp_gui_jrnl_lines_unposted (
                        user_session_id, jlu_jrnl_hdr_id, jlu_jrnl_line_number, jlu_fak_id, jlu_eba_id, jlu_jrnl_status,
                        ...
                        jlu_amended_on, db_state, jlu_epg_id, jlu_period_month, jlu_period_year, jlu_period_ltd
                     )
                     SELECT	  /* user_session_id */		 		gSessionId,
                              /* jlu_jrnl_hdr_id */ 	   	 	jlu_jrnl_hdr_id,
                              /* jlu_jrnl_line_number */		new_line,
                              /* jlu_fak_id	*/					jlu_fak_id,
                              /* jlu_eba_id	*/					jlu_eba_id,
                              /* jlu_jrnl_status */ 			jlu_jrnl_status,
                              /* jlu_jrnl_status_text */ 		jlu_jrnl_status_text,
                              /* jlu_jrnl_process_id */ 		jlu_jrnl_process_id,
                              /* jlu_description */				jlu_description,
                              /* jlu_source_jrnl_id */			jlu_source_jrnl_id,
                              /* jlu_effective_date */			jlu_effective_date,
                              /* jlu_value_date */				jlu_value_date,
                              /* jlu_entity */					jlu_entity,
                              /* jlu_account */					jlu_account,
                              /* jlu_segment_1 */				jlu_segment_1,
                              /* jlu_segment_2 */				jlu_segment_2,
                              /* jlu_segment_3 */				jlu_segment_3,
                              /* jlu_segment_4 */				jlu_segment_4,
                              /* jlu_segment_5 */				jlu_segment_5,
                              /* jlu_segment_6 */				jlu_segment_6,
                              /* jlu_segment_7 */				jlu_segment_7,
                              /* jlu_segment_8 */				jlu_segment_8,
                              /* jlu_segment_9 */				jlu_segment_9,
                              /* jlu_segment_10 */				jlu_segment_10,
                              /* jlu_attribute_1 */				jlu_attribute_1,
                              /* jlu_attribute_2 */				jlu_attribute_2,
                              /* jlu_attribute_3 */ 			jlu_attribute_3,
                              /* jlu_attribute_4 */				jlu_attribute_4,
                              /* jlu_attribute_5 */				jlu_attribute_5,
                              /* jlu_reference_1 */				jlu_reference_1,
                              /* jlu_reference_2 */				jlu_reference_2,
                              /* jlu_reference_3 */				jlu_reference_3,
                              /* jlu_reference_4 */				jlu_reference_4,
                              /* jlu_reference_5 */				jlu_reference_5,
                              /* jlu_reference_6 */				jlu_reference_6,
                              /* jlu_reference_7 */				jlu_reference_7,
                              /* jlu_reference_8 */				jlu_reference_8,
                              /* jlu_reference_9 */				jlu_reference_9,
                              /* jlu_reference_10 */			jlu_reference_10,
                              /* jlu_tran_ccy */				jlu_tran_ccy,
                              /* jlu_tran_amount */				jlu_tran_amount,
                              /* jlu_base_rate */				jlu_base_rate,
                              /* jlu_base_ccy */				DECODE(NVL(jlu_base_amount,0),0,NULL,jlu_base_ccy),
                              /* jlu_base_amount */				DECODE(NVL(jlu_base_amount,0),0,NULL,jlu_base_amount),
                              /* jlu_local_rate */				jlu_local_rate,
                              /* jlu_local_ccy */				DECODE(NVL(jlu_local_amount,0),0,NULL,jlu_local_ccy),
                              /* jlu_local_amount */			DECODE(NVL(jlu_local_amount,0),0,NULL,jlu_local_amount),
                              /* jlu_created_by */				updated_by,
                              /* jlu_created_on */				SYSDATE,
                              /* jlu_amended_by */				updated_by,
                              /* jlu_amended_on */				SYSDATE,
                              /* db_state */			  		'I',
                              /* jlu_epg_id */                  jlu_epg_id,
                              /* jlu_period_month */            jlu_period_month,
                              /* jlu_period_year */             jlu_period_year,
                              /* jlu_period_ltd */              jlu_period_ltd
                ...
                EXCEPTION
                    WHEN OTHERS THEN
                        pr_error(1, SQLERRM, 0, 'prui_copy_lines.1', 'gui_jrnl_lines_unposted', NULL, NULL, gPackageName, 'PL/SQL', NULL, NULL, NULL, NULL, NULL, NULL, NULL);
                        success := 'F';
                END;
   ...
   --********************************************************************************
    ...
    begin
      ...
      exception
       ...
       prui_clear_errors(journal_id);
       prui_log_error(journal_id, 0, 1040, 'Journal rejected: '||reason_description);
    ...
    EXCEPTION
        WHEN NO_DATA_FOUND THEN
            RETURN;
        WHEN OTHERS THEN
            pr_error(1, SQLERRM, 0, 'prui_get_journal_errors', 'slr_jrnl_line_errors', NULL, NULL, gPackageName, 'PL/SQL', NULL, NULL, NULL, NULL, NULL, NULL, NULL);
    ...
    BEGIN
        ...
        lvValidateState := fnui_validate_journal_header;
        IF lvValidateState IN (gSTATE_CRITICAL, gSTATE_ERRORED) THEN
            success := 'N';
        END IF;
    ...
    EXCEPTION
        WHEN OTHERS THEN
             pr_error(1, SQLERRM, 0, 'prui_validate_journal', 'slr_jrnl_headers_unposted', NULL, NULL, gPackageName, 'PL/SQL', NULL, NULL, NULL, NULL, NULL, NULL, NULL);
             success := 'N';
    ...
    */
    ...
    BEGIN
        ...
        lvSuccess := gSTATE_OK;
         ...
         IF gSessionId IS NULL THEN
            pr_error(1, SQLERRM, 0, 'fnui_validate_journal_header', 'temp_gui_jrnl_line_errors', NULL, NULL, gPackageName, 'PL/SQL', NULL, NULL, NULL, NULL, NULL, NULL, NULL);
...
--        END IF;
    ...
    IF NOT fnui_get_entity THEN
        ...
        IF NOT fnui_check_calendar THEN
            lvSuccess := gSTATE_CRITICAL;
        END IF;

        -- Exit if not successful at this point
        IF lvSuccess IN (gSTATE_CRITICAL) THEN
            prui_log_error(gJournalHeader.jhu_jrnl_id, 0, 1001, 'Failed to initialise validation. Please check configuration');
            RETURN gSTATE_CRITICAL;
        END IF;

        -- Check mandatory fields
        IF NOT fnui_check_header_definitions THEN
            lvSuccess := gSTATE_CRITICAL;
        END IF;
        ...
        -- Exit if not successful at this point
        IF lvSuccess IN (gSTATE_CRITICAL) THEN
            prui_log_error(gJournalHeader.jhu_jrnl_id, 0, 1001, 'Failed to complete all the checks on the journal header');
            RETURN gSTATE_CRITICAL;
        END IF;
    ...
    IF NOT fnui_validate_header_dates THEN
        ...
        IF NOT fnui_validate_periods THEN
            lvSuccess := gSTATE_ERRORED;
        END IF;

        IF NOT fnui_validate_balances THEN
           lvSuccess := gSTATE_ERRORED;
        END IF;
...
--        END IF;
    ...
    IF NOT fnui_validate_jrnl_type THEN
            lvSuccess := gSTATE_ERRORED;
        END IF;
    ...
    END IF;*/
        ...
        IF NOT pgui_jrnl_custom.fnui_validate_header(gJournalHeader.jhu_jrnl_id, gSessionId) THEN
            lvSuccess := gSTATE_ERRORED;
        END IF;
       ...
       lvCount := gJournalHeader.jhu_jrnl_total_lines;
             ...
             IF lvCount > 0 THEN
                ...
                IF fnui_validate_journal_line(FALSE) IN (gSTATE_CRITICAL) THEN
                   lvSuccess := gSTATE_CRITICAL;
                END IF;
             END IF;
        ...
        EXCEPTION
            WHEN NO_DATA_FOUND THEN
                 NULL; -- do nothing
            WHEN OTHERS THEN
                 pr_error(1, SQLERRM, 0, 'fnui_validate_journal_header.1', 'gui_jrnl_headers_unposted', NULL, NULL, gPackageName, 'PL/SQL', NULL, NULL, NULL, NULL, NULL, NULL, NULL);
        END;
    ...
    EXCEPTION
        WHEN OTHERS THEN
            pr_error(1, SQLERRM, 0, 'fnui_validate_journal_header', 'gui_jrnl_headers_unposted', NULL, NULL, gPackageName, 'PL/SQL', NULL, NULL, NULL, NULL, NULL, NULL, NULL);
            RETURN gSTATE_CRITICAL;
    ...
    */
    ...
    BEGIN
        ...
        lvSuccess := gSTATE_OK;
         ...
         IF gSessionId IS NULL THEN
            pr_error(1, SQLERRM, 0, 'prui_clear_errors', 'fnui_validate_journal_line', NULL, NULL, gPackageName, 'PL/SQL', NULL, NULL, NULL, NULL, NULL, NULL, NULL);
            raise_application_error(-9001, 'Missing session id');
         END IF;
...
--        END LOOP;
        ...
        IF NOT fnui_get_fak_definitions THEN
            lvSuccess := gSTATE_CRITICAL;
        END IF;

        IF NOT fnui_get_eba_definitions THEN
            lvSuccess := gSTATE_CRITICAL;
        END IF;
        ...
        IF NOT fnui_decode_journal_lines THEN
           prui_log_error(gJournalHeader.jhu_jrnl_id, 0, 1001, 'Could not translate source system codes. Please check configuration');
           RETURN gSTATE_CRITICAL;
        END IF;

        -- Check mandatory fields
        IF NOT fnui_check_line_definitions THEN
            lvSuccess := gSTATE_CRITICAL;
        END IF;

        -- Exit if not successful at this point
        IF lvSuccess IN (gSTATE_CRITICAL) THEN
            prui_log_error(gJournalHeader.jhu_jrnl_id, 0, 1001, 'Failed to complete all the validation checks on the journal lines');
            RETURN gSTATE_CRITICAL;
        END IF;

            -- Validate Processing Entity Group
     IF NOT fnui_check_ent_proc_group_conf THEN
            prui_log_error(gJournalHeader.jhu_jrnl_id, 0, 1001, 'Failed to validate entity processing group settings. Please check configuration.');
            lvSuccess := gSTATE_ERRORED;
        END IF;

        IF NOT fnui_validate_line_dates THEN
            prui_log_error(gJournalHeader.jhu_jrnl_id, 0, 1001, 'Failed to complete validation of journal line dates'); -- AG custom
            lvSuccess := gSTATE_ERRORED;
        END IF;
        ...
        -- AG Custom
        IF NOT fnui_validate_ledger THEN
            lvSuccess := gSTATE_ERRORED;
        END IF;

        IF NOT fnui_check_currencies THEN
            lvSuccess := gSTATE_ERRORED;
        END IF;

        IF NOT fnui_validate_segment_n(1) THEN
            lvSuccess := gSTATE_ERRORED;
        END IF;

        IF NOT fnui_validate_segment_n(2) THEN
            lvSuccess := gSTATE_ERRORED;
        END IF;

        IF NOT fnui_validate_segment_n(3) THEN
            lvSuccess := gSTATE_ERRORED;
        END IF;

        IF NOT fnui_validate_segment_n(4) THEN
            lvSuccess := gSTATE_ERRORED;
        END IF;

        IF NOT fnui_validate_segment_n(5) THEN
            lvSuccess := gSTATE_ERRORED;
        END IF;

        IF NOT fnui_validate_segment_n(6) THEN
            lvSuccess := gSTATE_ERRORED;
        END IF;

        IF NOT fnui_validate_segment_n(7) THEN
            lvSuccess := gSTATE_ERRORED;
        END IF;

        IF NOT fnui_validate_segment_n(8) THEN
            lvSuccess := gSTATE_ERRORED;
        END IF;

        IF NOT fnui_validate_segment_n(9) THEN
            lvSuccess := gSTATE_ERRORED;
        END IF;

        IF NOT fnui_validate_segment_n(10) THEN
            lvSuccess := gSTATE_ERRORED;
        END IF;

        IF NOT fnui_validate_attribute_n(1) THEN
            lvSuccess := gSTATE_ERRORED;
        END IF;

        IF NOT fnui_validate_attribute_n(2) THEN
            lvSuccess := gSTATE_ERRORED;
        END IF;

        IF NOT fnui_validate_attribute_n(3) THEN
            lvSuccess := gSTATE_ERRORED;
        END IF;

        IF NOT fnui_validate_attribute_n(4) THEN
            lvSuccess := gSTATE_ERRORED;
        END IF;

        IF NOT fnui_validate_attribute_n(5) THEN
            lvSuccess := gSTATE_ERRORED;
        END IF;
        ...
        -- Execute any custom validation
        IF NOT pgui_jrnl_custom.fnui_validate_jrnl_line(gJournalHeader.jhu_jrnl_id, gSessionId) THEN
            lvSuccess := gSTATE_ERRORED;
        END IF;
    ...
    EXCEPTION
        WHEN OTHERS THEN
            pr_error(1, SQLERRM, 0, 'fnui_validate_journal_line', 'gui_jrnl_lines_unposted', NULL, NULL, gPackageName, 'PL/SQL', NULL, NULL, NULL, NULL, NULL, NULL, NULL);
            RETURN gSTATE_CRITICAL;
    ...
    BEGIN
      ...
      IF status = gSTATUS_MANUAL THEN
         STATUS_TEXT := 'Manual';
      END IF;
      IF status = gSTATUS_ERROR THEN
         STATUS_TEXT := 'Invalid';
      END IF;
      IF status = gSTATUS_AUTHORISE THEN
         STATUS_TEXT := 'Require Authoris.';
      END IF;
      IF status = gSTATUS_REJECT THEN
         STATUS_TEXT := 'Failed';
      END IF;
      IF status = gSTATUS_POSTED THEN
         STATUS_TEXT := 'Posted';
      END IF;

      IF status = gSTATUS_VALIDATED THEN
         STATUS_TEXT := 'Unposted';
      END IF;
      IF status = gSTATUS_VALIDATING THEN
    ...
    IF status = gSTATUS_WAITING THEN
      ...
      UPDATE  gui_jrnl_headers_unposted
        SET   jhu_jrnl_status = status, JHU_JRNL_STATUS_TEXT = STATUS_TEXT, jhu_version = jhu_version+1
        WHERE jhu_jrnl_id = journal_id;
    ...
    EXCEPTION
        WHEN OTHERS THEN
            pr_error(1, SQLERRM, 0, 'prui_set_status', 'gui_jrnl_headers_unposted', NULL, NULL, gPackageName, 'PL/SQL', NULL, NULL, NULL, NULL, NULL, NULL, NULL);
    END prui_set_status;
   ...
   --********************************************************************************
    ...
    BEGIN
        ...
        IF gJournalHeader.jhu_jrnl_entity IS NULL THEN
           prui_log_error(gJournalHeader.jhu_jrnl_id, 0, 1050, 'Entity is required');
           lvSuccess := FALSE;
        END IF;

        IF gJournalHeader.jhu_jrnl_description IS NULL THEN
           prui_log_error(gJournalHeader.jhu_jrnl_id, 0, 1050, 'Description is required');
           lvSuccess := FALSE;
        END IF;

        IF gJournalHeader.jhu_jrnl_date IS NULL THEN
           prui_log_error(gJournalHeader.jhu_jrnl_id, 0, 1050, 'Effective Date is required');
           lvSuccess := FALSE;
        END IF;

        IF gJournalHeader.jhu_jrnl_source IS NULL THEN
           prui_log_error(gJournalHeader.jhu_jrnl_id, 0, 1050, 'Source System is required');
           lvSuccess := FALSE;
        END IF;

        IF gJournalHeader.jhu_jrnl_type IS NULL THEN
           prui_log_error(gJournalHeader.jhu_jrnl_id, 0, 1050, 'Journal Type is required');
           lvSuccess := FALSE;
        END IF;

        -- Size checks
        IF LENGTH(gJournalHeader.jhu_jrnl_description) > 100 THEN
           prui_log_error(gJournalHeader.jhu_jrnl_id, 0, 1060, 'Description is too long');
           lvSuccess := FALSE;
        END IF;
    ...
    EXCEPTION
        WHEN OTHERS THEN
            pr_error(1, SQLERRM, 0, 'fnui_check_header_definitions', 'gui_jrnl_headers_unposted', NULL, NULL, gPackageName, 'PL/SQL', NULL, NULL, NULL, NULL, NULL, NULL, NULL);
            RETURN FALSE;
    ...
    BEGIN
        ...
        SELECT /* jle_jrnl_process_id */    0,
                  ...
                  /* jle_error_string */    'Entity is required.',
        ...
        SELECT /* jle_jrnl_process_id */    0,
                  ...
                  /* jle_jrnl_line_number */  jlu_jrnl_line_number,
                  /* jle_error_code */        'MADJ-1051',
                  /* jle_error_string */    'Account is required.',
                  /* jle_created_by */      'SYSTEM',
                  /* jle_created_on */      SYSDATE,
                  /* jle_amended_by */      'SYSTEM',
                  /* jle_amended_on */      SYSDATE
        ...
        SELECT /* jle_jrnl_process_id */    0,
                  ...
                  /* jle_jrnl_line_number */  jlu_jrnl_line_number,
                  /* jle_error_code */        'MADJ-1051',
                  /* jle_error_string */    'Effective Date is required.',
                  /* jle_created_by */      'SYSTEM',
                  /* jle_created_on */      SYSDATE,
                  /* jle_amended_by */      'SYSTEM',
                  /* jle_amended_on */      SYSDATE
        ...
        SELECT /* jle_jrnl_process_id */    0,
                  ...
                  /* jle_jrnl_line_number */  jlu_jrnl_line_number,
                  /* jle_error_code */        'MADJ-1051',
                  /* jle_error_string */    'Value Date is required.',
                  /* jle_created_by */      'SYSTEM',
                  /* jle_created_on */      SYSDATE,
                  /* jle_amended_by */      'SYSTEM',
                  /* jle_amended_on */      SYSDATE
        ...
        SELECT /* jle_jrnl_process_id */    0,
                  ...
                  /* jle_jrnl_line_number */  jlu_jrnl_line_number,
                  /* jle_error_code */        'MADJ-1051',
                  /* jle_error_string */    'Transaction Currency is required.',
                  /* jle_created_by */      'SYSTEM',
                  /* jle_created_on */      SYSDATE,
                  /* jle_amended_by */      'SYSTEM',
                  /* jle_amended_on */      SYSDATE
        ...
        SELECT /* jle_jrnl_process_id */    0,
               ...
               /* jle_jrnl_line_number */   jlu_jrnl_line_number,
               /* jle_error_code */         'MADJ-1051',
               /* jle_error_string */       case jlu_segment_1
        ...
        SELECT /* jle_jrnl_process_id */    0,
               ...
               /* jle_error_code */         'MADJ-1051',
               /* jle_error_string */       case jlu_segment_1
                                            when 'UKGAAP_ADJ' THEN 'Transaction amount must equal Local Amount'
                                            when 'EURGAAPADJ' THEN 'Transaction amount must equal Local Amount'
                                                              else 'Transaction amount must equal Base Amount'
                                            end,
               /* jle_created_by */         'SYSTEM',
               /* jle_created_on */         SYSDATE,
               /* jle_amended_by */         'SYSTEM',
        ...
        SELECT /* jle_jrnl_process_id */    0,
               ...
               /* jle_jrnl_line_number */   jlu_jrnl_line_number,
               /* jle_error_code */         'MADJ-1051',
               /* jle_error_string */       'Base Currency is required.',
               /* jle_created_by */         'SYSTEM',
               /* jle_created_on */         SYSDATE,
               /* jle_amended_by */         'SYSTEM',
               /* jle_amended_on */         SYSDATE
        ...
        WHERE jlu_jrnl_hdr_id = gJournalHeader.jhu_jrnl_id
          ...
          AND ((jlu_base_ccy IS NULL AND NVL (jlu_base_amount, 0) != 0)
           OR  ((jlu_segment_1 <> 'UKGAAP_ADJ' AND jlu_segment_1 <> 'EURGAAPADJ') and jlu_base_ccy IS NULL));
        ...
        SELECT /* jle_jrnl_process_id */    0,
               ...
               /* jle_jrnl_line_number */   jlu_jrnl_line_number,
               /* jle_error_code */         'MADJ-1051',
               /* jle_error_string */       'Local Currency Type is required.',
               /* jle_created_by */         'SYSTEM',
               /* jle_created_on */         SYSDATE,
               /* jle_amended_by */         'SYSTEM',
               /* jle_amended_on */         SYSDATE
        ...
        WHERE jlu_jrnl_hdr_id = gJournalHeader.jhu_jrnl_id
          ...
          AND ((jlu_local_ccy IS NULL AND NVL (jlu_local_amount, 0) != 0)
           OR  ((jlu_segment_1 = 'UKGAAP_ADJ' OR jlu_segment_1 = 'EURGAAPADJ' ) and jlu_local_ccy IS NULL));
        ...
        -- Check FAK Segments
        IF gFAKDefinitions.fd_segment_1_type = 'M' THEN
            INSERT INTO temp_gui_jrnl_line_errors (
                    jle_jrnl_process_id, user_session_id, jle_jrnl_hdr_id, jle_jrnl_line_number,
                    jle_error_code, jle_error_string, jle_created_by, jle_created_on,
                    jle_amended_by, jle_amended_on
            ...
            SELECT /* jle_jrnl_process_id */    0,
                      ...
                      /* jle_jrnl_line_number */  jlu_jrnl_line_number,
                      /* jle_error_code */        'MADJ-1051',
                      /* jle_error_string */    gFAKDefinitions.fd_segment_1_name||' is required.',
                      /* jle_created_by */      'SYSTEM',
                      /* jle_created_on */      SYSDATE,
                      /* jle_amended_by */      'SYSTEM',
                      /* jle_amended_on */      SYSDATE
        ...
        IF gFAKDefinitions.fd_segment_2_type = 'M' THEN
            INSERT INTO temp_gui_jrnl_line_errors (
                    jle_jrnl_process_id, user_session_id, jle_jrnl_hdr_id, jle_jrnl_line_number,
                    jle_error_code, jle_error_string, jle_created_by, jle_created_on,
                    jle_amended_by, jle_amended_on
            ...
            SELECT /* jle_jrnl_process_id */    0,
                      ...
                      /* jle_jrnl_line_number */  jlu_jrnl_line_number,
                      /* jle_error_code */        'MADJ-1051',
                      /* jle_error_string */    gFAKDefinitions.fd_segment_2_name||' is required.',
                      /* jle_created_by */      'SYSTEM',
                      /* jle_created_on */      SYSDATE,
                      /* jle_amended_by */      'SYSTEM',
                      /* jle_amended_on */      SYSDATE
        ...
        IF gFAKDefinitions.fd_segment_3_type = 'M' THEN
            INSERT INTO temp_gui_jrnl_line_errors (
                    jle_jrnl_process_id, user_session_id, jle_jrnl_hdr_id, jle_jrnl_line_number,
                    jle_error_code, jle_error_string, jle_created_by, jle_created_on,
                    jle_amended_by, jle_amended_on
            ...
            SELECT /* jle_jrnl_process_id */    0,
                      ...
                      /* jle_jrnl_line_number */  jlu_jrnl_line_number,
                      /* jle_error_code */        'MADJ-1051',
                      /* jle_error_string */    gFAKDefinitions.fd_segment_3_name||' is required.',
                      /* jle_created_by */      'SYSTEM',
                      /* jle_created_on */      SYSDATE,
                      /* jle_amended_by */      'SYSTEM',
                      /* jle_amended_on */      SYSDATE
        ...
        IF gFAKDefinitions.fd_segment_4_type = 'M' THEN
            INSERT INTO temp_gui_jrnl_line_errors (
                    jle_jrnl_process_id, user_session_id, jle_jrnl_hdr_id, jle_jrnl_line_number,
                    jle_error_code, jle_error_string, jle_created_by, jle_created_on,
                    jle_amended_by, jle_amended_on
            ...
            SELECT /* jle_jrnl_process_id */    0,
                      ...
                      /* jle_jrnl_line_number */  jlu_jrnl_line_number,
                      /* jle_error_code */        'MADJ-1051',
                      /* jle_error_string */    gFAKDefinitions.fd_segment_4_name||' is required.',
                      /* jle_created_by */      'SYSTEM',
                      /* jle_created_on */      SYSDATE,
                      /* jle_amended_by */      'SYSTEM',
                      /* jle_amended_on */      SYSDATE
        ...
        IF gFAKDefinitions.fd_segment_5_type = 'M' THEN
            INSERT INTO temp_gui_jrnl_line_errors (
                    jle_jrnl_process_id, user_session_id, jle_jrnl_hdr_id, jle_jrnl_line_number,
                    jle_error_code, jle_error_string, jle_created_by, jle_created_on,
                    jle_amended_by, jle_amended_on
            ...
            SELECT /* jle_jrnl_process_id */    0,
                      ...
                      /* jle_jrnl_line_number */  jlu_jrnl_line_number,
                      /* jle_error_code */        'MADJ-1051',
                      /* jle_error_string */    gFAKDefinitions.fd_segment_5_name||' is required.',
                      /* jle_created_by */      'SYSTEM',
                      /* jle_created_on */      SYSDATE,
                      /* jle_amended_by */      'SYSTEM',
                      /* jle_amended_on */      SYSDATE
        ...
        IF gFAKDefinitions.fd_segment_6_type = 'M' THEN
            INSERT INTO temp_gui_jrnl_line_errors (
                    jle_jrnl_process_id, user_session_id, jle_jrnl_hdr_id, jle_jrnl_line_number,
                    jle_error_code, jle_error_string, jle_created_by, jle_created_on,
                    jle_amended_by, jle_amended_on
            ...
            SELECT /* jle_jrnl_process_id */    0,
                      ...
                      /* jle_jrnl_line_number */  jlu_jrnl_line_number,
                      /* jle_error_code */        'MADJ-1051',
                      /* jle_error_string */    gFAKDefinitions.fd_segment_6_name||' is required.',
                      /* jle_created_by */      'SYSTEM',
                      /* jle_created_on */      SYSDATE,
                      /* jle_amended_by */      'SYSTEM',
                      /* jle_amended_on */      SYSDATE
        ...
        IF gFAKDefinitions.fd_segment_7_type = 'M' THEN
            INSERT INTO temp_gui_jrnl_line_errors (
                    jle_jrnl_process_id, user_session_id, jle_jrnl_hdr_id, jle_jrnl_line_number,
                    jle_error_code, jle_error_string, jle_created_by, jle_created_on,
                    jle_amended_by, jle_amended_on
            ...
            SELECT /* jle_jrnl_process_id */    0,
                      ...
                      /* jle_jrnl_line_number */  jlu_jrnl_line_number,
                      /* jle_error_code */        'MADJ-1051',
                      /* jle_error_string */    gFAKDefinitions.fd_segment_7_name||' is required.',
                      /* jle_created_by */      'SYSTEM',
                      /* jle_created_on */      SYSDATE,
                      /* jle_amended_by */      'SYSTEM',
                      /* jle_amended_on */      SYSDATE
        ...
        IF gFAKDefinitions.fd_segment_8_type = 'M' THEN
            INSERT INTO temp_gui_jrnl_line_errors (
                    jle_jrnl_process_id, user_session_id, jle_jrnl_hdr_id, jle_jrnl_line_number,
                    jle_error_code, jle_error_string, jle_created_by, jle_created_on,
                    jle_amended_by, jle_amended_on
            ...
            SELECT /* jle_jrnl_process_id */    0,
                      ...
                      /* jle_jrnl_line_number */  jlu_jrnl_line_number,
                      /* jle_error_code */        'MADJ-1051',
                      /* jle_error_string */    gFAKDefinitions.fd_segment_8_name||' is required.',
                      /* jle_created_by */      'SYSTEM',
                      /* jle_created_on */      SYSDATE,
                      /* jle_amended_by */      'SYSTEM',
                      /* jle_amended_on */      SYSDATE
        ...
        IF gFAKDefinitions.fd_segment_9_type = 'M' THEN
            INSERT INTO temp_gui_jrnl_line_errors (
                    jle_jrnl_process_id, user_session_id, jle_jrnl_hdr_id, jle_jrnl_line_number,
                    jle_error_code, jle_error_string, jle_created_by, jle_created_on,
                    jle_amended_by, jle_amended_on
            ...
            SELECT /* jle_jrnl_process_id */    0,
                      ...
                      /* jle_jrnl_line_number */  jlu_jrnl_line_number,
                      /* jle_error_code */        'MADJ-1051',
                      /* jle_error_string */    gFAKDefinitions.fd_segment_9_name||' is required.',
                      /* jle_created_by */      'SYSTEM',
                      /* jle_created_on */      SYSDATE,
                      /* jle_amended_by */      'SYSTEM',
                      /* jle_amended_on */      SYSDATE
        ...
        IF gFAKDefinitions.fd_segment_10_type = 'M' THEN
            INSERT INTO temp_gui_jrnl_line_errors (
                    jle_jrnl_process_id, user_session_id, jle_jrnl_hdr_id, jle_jrnl_line_number,
                    jle_error_code, jle_error_string, jle_created_by, jle_created_on,
                    jle_amended_by, jle_amended_on
            ...
            SELECT /* jle_jrnl_process_id */    0,
                      ...
                      /* jle_jrnl_line_number */  jlu_jrnl_line_number,
                      /* jle_error_code */        'MADJ-1051',
                      /* jle_error_string */    gFAKDefinitions.fd_segment_10_name||' is required.',
                      /* jle_created_by */      'SYSTEM',
                      /* jle_created_on */      SYSDATE,
                      /* jle_amended_by */      'SYSTEM',
                      /* jle_amended_on */      SYSDATE
        ...
        */
        ...
        SELECT /* jle_jrnl_process_id */    0,
                  ...
                  /* jle_jrnl_hdr_id */     jlu_jrnl_hdr_id,
                  /* jle_jrnl_line_number */  jlu_jrnl_line_number,
                  /* jle_error_code */        'MADJ-1061',
                  /* jle_error_string */    'Description is required',
                  /* jle_created_by */      'SYSTEM',
                  /* jle_created_on */      SYSDATE,
                  /* jle_amended_by */      'SYSTEM',
                  /* jle_amended_on */      SYSDATE
        ...
        WHERE jlu_jrnl_hdr_id = gJournalHeader.jhu_jrnl_id
        AND   user_session_id = gSessionId
        AND   jlu_description IS NULL OR LENGTH(jlu_description) = 0;
        ...
        SELECT /* jle_jrnl_process_id */    0,
                  ...
                  /* jle_jrnl_line_number */  jlu_jrnl_line_number,
                  /* jle_error_code */        'MADJ-1061',
                  /* jle_error_string */    'Description is too long',
                  /* jle_created_by */      'SYSTEM',
                  /* jle_created_on */      SYSDATE,
                  /* jle_amended_by */      'SYSTEM',
                  /* jle_amended_on */      SYSDATE
        ...
        EXCEPTION
              WHEN NO_DATA_FOUND THEN
                   NULL; -- do nothing
              WHEN OTHERS THEN
                   pr_error(1, SQLERRM, 0, 'fnui_check_line_definitions.1', 'temp_gui_jrnl_line_errors', NULL, NULL, gPackageName, 'PL/SQL', NULL, NULL, NULL, NULL, NULL, NULL, NULL);
        END;
    ...
    EXCEPTION
        WHEN OTHERS THEN
            pr_error(1, SQLERRM, 0, 'fnui_check_line_definitions', 'gui_jrnl_lines_unposted', NULL, NULL, gPackageName, 'PL/SQL', NULL, NULL, NULL, NULL, NULL, NULL, NULL);
            RETURN FALSE;
    ...
    BEGIN
        ...
        EXCEPTION
            WHEN NO_DATA_FOUND THEN
                 prui_log_error(gJournalHeader.jhu_jrnl_id, 0, 9999, 'Effective Date is not a valid business date');
                 lvSuccess := FALSE;
            WHEN OTHERS THEN
                 RETURN FALSE;
        END;
        ...
        SELECT
                     ...
                     LEFT OUTER JOIN fdr.FR_PARTY_LEGAL par ON (head.jhu_jrnl_entity = par.pl_party_legal_id)
                     JOIN slr.SLR_EXT_JRNL_TYPES ext ON (ext.ejt_type = head.jhu_jrnl_type)
                     JOIN slr.SLR_EXT_JRNL_TYPE_RULE rul ON (rul.ejtr_code = ext.ejt_eff_ejtr_code)
                     JOIN slr.SLR_EXT_JRNL_TYPE_RULE rev_rul ON (rev_rul.ejtr_code = ext.ejt_rev_ejtr_code)
                     JOIN slr.SLR_ERROR_MESSAGE  mes ON (mes.EM_ERROR_CODE = rul.ejtr_em_error_code)
                     JOIN slr.SLR_ERROR_MESSAGE  rev_mes ON (rev_mes.EM_ERROR_CODE = rev_rul.ejtr_em_error_code)
                     WHERE  jhu_jrnl_id = gJournalHeader.jhu_jrnl_id
                     and user_session_id  = gSessionId;

        -- Get the calendar details for the current business date
        prui_get_calendar_details(gEntityConfiguration.ent_business_date,
      ...
      IF v_prior_next_both IS NOT NULL AND v_period_day IS NOT NULL THEN
         ...
         IF v_prior_next_both = 'P' THEN
			...
			IF lvPrevPeriodStartDate IS NULL OR lvPrevPeriodEndDate IS NULL
			THEN
				prui_log_error(gJournalHeader.jhu_jrnl_id, 0, 9999, 'No Entity Period data for current business date. Cannot check Effective Date');
				RETURN FALSE;
			END IF;
         ...
         ELSIF v_prior_next_both = 'C' THEN
			-- Check that calendar details are present
			IF lvPeriodStartDate IS NULL OR lvPeriodEndDate IS NULL
			THEN
				prui_log_error(gJournalHeader.jhu_jrnl_id, 0, 9999, 'No Entity Period data for current business date. Cannot check Effective Date');
				RETURN FALSE;
			END IF;
         ...
         ELSIF v_prior_next_both = 'N' THEN
			-- Check that calendar details are present
			IF lvNextPeriodEndDate IS NULL 
			THEN
				prui_log_error(gJournalHeader.jhu_jrnl_id, 0, 9999, 'No Entity Period data for current business date. Cannot check Effective Date');
				RETURN FALSE;
			END IF;
         ...
         IF v_period_day = 'S' THEN
            IF v_rul_typ = '=' AND gJournalHeader.jhu_jrnl_date <> v_compare_start_date THEN
                ...
                lvSuccess := FALSE;
            ELSIF v_rul_typ = '>' AND gJournalHeader.jhu_jrnl_date <= v_compare_start_date THEN
                   prui_log_error(gJournalHeader.jhu_jrnl_id, 0, 9999, v_err_msg );
                lvSuccess := FALSE;
            ELSIF v_rul_typ = '>=' AND gJournalHeader.jhu_jrnl_date < v_compare_start_date THEN
                   prui_log_error(gJournalHeader.jhu_jrnl_id, 0, 9999, v_err_msg );
         ...
         ELSIF v_period_day = 'E' THEN
            IF v_rul_typ = '=' AND gJournalHeader.jhu_jrnl_date <> v_compare_end_date THEN
                  prui_log_error(gJournalHeader.jhu_jrnl_id, 0, 9999, v_err_msg );
                lvSuccess := FALSE;
            ELSIF v_rul_typ = '>' AND gJournalHeader.jhu_jrnl_date <= v_compare_end_date THEN
                 prui_log_error(gJournalHeader.jhu_jrnl_id, 0, 9999, v_err_msg );
                lvSuccess := FALSE;
            ELSIF v_rul_typ = '<' AND gJournalHeader.jhu_jrnl_date >= v_compare_end_date THEN
                   prui_log_error(gJournalHeader.jhu_jrnl_id, 0, 9999, v_err_msg );
                lvSuccess := FALSE;
            END IF;
         ELSIF v_period_day = 'B' THEN
            IF v_rul_typ = 'BETWEEN' AND NOT gJournalHeader.jhu_jrnl_date BETWEEN v_compare_start_date AND v_compare_end_date THEN
                  prui_log_error(gJournalHeader.jhu_jrnl_id, 0, 9999, v_err_msg );
                lvSuccess := FALSE;
            END IF;
         END IF;
...
lvPeriodStartDate := NULL;
  ...
  lvNextPeriodStartDate := NULL;
     ...
     prui_get_calendar_details(gJournalHeader.jhu_jrnl_date,
      ...
      IF (v_ejt_jt_type = 'Reversing') OR (v_ejt_jt_type = 'Conditional' AND gJournalHeader.jhu_jrnl_rev_date IS NOT NULL) THEN
         ...
         BEGIN
             ...
             AND to_char(gJournalHeader.jhu_jrnl_rev_date,'mmdd') <> '0101'  -- ag customization
             AND    ed_status      = 'O';
          ...
          IF(v_rev_validation_flag = 'Y' AND gJournalHeader.jhu_jrnl_rev_date IS NOT NULL) THEN
             ...
             IF v_rev_prior_next_both IS NOT NULL AND v_rev_period_day IS NOT NULL THEN
                ...
                IF v_rev_prior_next_both = 'P' THEN
					...
					IF lvPrevPeriodStartDate IS NULL OR lvPrevPeriodEndDate IS NULL
					THEN
						prui_log_error(gJournalHeader.jhu_jrnl_id, 0, 9999, 'No Entity Period data for current business date. Cannot check Reversing Date');
						RETURN FALSE;
					END IF;
                ...
                ELSIF v_rev_prior_next_both = 'N' THEN
					-- Check that calendar details are present
					IF lvNextPeriodStartDate IS NULL OR lvNextPeriodEndDate IS NULL
					THEN
						prui_log_error(gJournalHeader.jhu_jrnl_id, 0, 9999, 'No Entity Period data for current business date. Cannot check Reversing Date');
						RETURN FALSE;
					END IF;
                ...
                IF v_rev_period_day = 'S' THEN
                   ...
                   IF v_rev_rul_typ = '=' AND gJournalHeader.jhu_jrnl_rev_date <> v_rev_compare_start_date THEN
					  ...
					  lvSuccess := FALSE;
                   ELSIF v_rev_rul_typ = '>' AND gJournalHeader.jhu_jrnl_rev_date <= v_rev_compare_start_date THEN
                ...
                ELSIF v_rev_period_day = 'E' THEN
                   ...
                   IF v_rev_rul_typ = '=' AND gJournalHeader.jhu_jrnl_rev_date <> v_rev_compare_end_date THEN
                      ...
                      prui_log_error(gJournalHeader.jhu_jrnl_id, 0, 9999, v_rev_err_msg );
                      lvSuccess := FALSE;
                   ELSIF v_rev_rul_typ = '>' AND gJournalHeader.jhu_jrnl_rev_date <= v_rev_compare_end_date THEN
                ...
                ELSIF v_rev_period_day = 'B' THEN
                   ...
                   IF v_rev_rul_typ = 'BETWEEN' AND NOT gJournalHeader.jhu_jrnl_rev_date BETWEEN v_rev_compare_start_date AND v_rev_compare_end_date THEN
             ...
             ELSIF v_rev_prior_next_both IS NOT NULL AND v_rev_period_day IS NULL THEN
                ...
                IF v_rev_prior_next_both = 'P' THEN
                   ...
                   IF v_rev_rul_typ = '=' AND gJournalHeader.jhu_jrnl_rev_date <> v_rev_compare_date THEN
                        ...
                        prui_log_error(gJournalHeader.jhu_jrnl_id, 0, 9999, v_rev_err_msg );
						lvSuccess := FALSE;
                   ELSIF v_rev_rul_typ = '>' AND gJournalHeader.jhu_jrnl_rev_date <= v_rev_compare_date THEN
   ...
   END IF;
    ...
    EXCEPTION
        WHEN OTHERS THEN
            pr_error(1, SQLERRM, 0, 'fnui_validate_header_dates', 'gui_jrnl_headers_unposted', NULL, NULL, gPackageName, 'PL/SQL', NULL, NULL, NULL, NULL, NULL, NULL, NULL);
            RETURN FALSE;
    ...
    BEGIN
        ...
        BEGIN
              ...
              SELECT /* jle_jrnl_process_id */	 	0,
                     ...
                     /* jle_jrnl_hdr_id */	 	 	jlu_jrnl_hdr_id,
                     /* jle_jrnl_line_number */		jlu_jrnl_line_number,
                     /* jle_error_code */	  		'MADJ-1014',
                     -- AG Custom
                     /* jle_error_string */            CASE to_char(jlu_effective_date,'MMDD') --AG CUSTOM
                                                        WHEN '0101' THEN ' Effective date cannot be January 1st'
                                                        ELSE 'Effective Date is invalid, earlier than 1/1/2017 or is not open'
                                                        END,
                     /* jle_created_by */			'SYSTEM',
                     /* jle_created_on */			SYSDATE,
                     /* jle_amended_by */			'SYSTEM',
              ...
              FROM temp_gui_jrnl_lines_unposted
              WHERE 
                jlu_jrnl_hdr_id = gJournalHeader.jhu_jrnl_id
                AND   user_session_id = gSessionId
                AND (NOT EXISTS (SELECT 1
                                FROM  slr_entity_days
                                WHERE 
                                    ed_entity_set  = gEntityConfiguration.ent_periods_and_days_set
                                    AND   ed_date      = jlu_effective_date
                                    AND   ed_status    = 'O'))                                     
                        OR jlu_effective_date < to_date('01/01/2017','mm/dd/yyyy')    -- AG Custom.  Or statement put in for performance                                    
                        OR to_char(jlu_effective_date,'MMDD')='0101';

        -- AG Custom 
        EXCEPTION
            WHEN OTHERS THEN
                 pr_error(1, SQLERRM, 0, 'fnui_validate_line_dates.1', 'temp_gui_jrnl_lines_unposted', NULL, NULL, gPackageName, 'PL/SQL', NULL, NULL, NULL, NULL, NULL, NULL, NULL);
                 RETURN FALSE;
        END;
        ...
        BEGIN
              ...
              SELECT /* jle_jrnl_process_id */         0,
                     ...
                     /* jle_jrnl_line_number */        jlu_jrnl_line_number,
                     /* jle_error_code */              'MADJ-1014',
                     /* jle_error_string */            CASE to_char(jlu_value_date,'MMDD')
                                                        WHEN '0101' THEN ' Value date cannot be January 1st'
                                                        END,
                     /* jle_created_by */            'SYSTEM',
                     /* jle_created_on */            SYSDATE,
                     /* jle_amended_by */            'SYSTEM',
              ...
              AND   (NOT EXISTS (SELECT 1
                                 ...
                                 AND    ed_date           = jlu_effective_date
                                 AND    ed_status       = 'O'))
                 OR to_char(jlu_value_date,'MMDD')='0101';
        ...
        BEGIN
              ...
              SELECT /* jle_jrnl_process_id */    0,
                     ...
                     /* jle_jrnl_hdr_id */      jlu_jrnl_hdr_id,
                     /* jle_jrnl_line_number */   jlu_jrnl_line_number,
                     /* jle_error_code */       'MADJ-1016',
                     /* jle_error_string */     'Effective Date on header is not equal to the Effective Date on the line',
                     /* jle_created_by */     'SYSTEM',
                     /* jle_created_on */     SYSDATE,
                     /* jle_amended_by */     'SYSTEM',
                     /* jle_amended_on */     SYSDATE
        ...
        EXCEPTION
            WHEN OTHERS THEN
                 pr_error(1, SQLERRM, 0, 'fnui_validate_line_dates.2', 'temp_gui_jrnl_lines_unposted', NULL, NULL, gPackageName, 'PL/SQL', NULL, NULL, NULL, NULL, NULL, NULL, NULL);
                 RETURN FALSE;
        END;
        ...
        BEGIN
              ...
              IF lvPostValueDateFlag = 'Y' THEN
                  ...
                  SELECT /* jle_jrnl_process_id */    0,
                         ...
                         /* jle_jrnl_hdr_id */      jlu_jrnl_hdr_id,
                         /* jle_jrnl_line_number */   jlu_jrnl_line_number,
                         /* jle_error_code */       'MADJ-1015',
                         /* jle_error_string */     'Value Date is invalid or is not open',
                         /* jle_created_by */     'SYSTEM',
                         /* jle_created_on */     SYSDATE,
                         /* jle_amended_by */     'SYSTEM',
                         /* jle_amended_on */     SYSDATE
        ...
        EXCEPTION
            WHEN OTHERS THEN
                 pr_error(1, SQLERRM, 0, 'fnui_validate_line_dates.3', 'temp_gui_jrnl_lines_unposted', NULL, NULL, gPackageName, 'PL/SQL', NULL, NULL, NULL, NULL, NULL, NULL, NULL);
                 RETURN FALSE;
        END;
    ...
    -- TTP 775 - MADJ-1025 error code added to condition so that errors for new journal type validation will be caught
        BEGIN
              ...
              WHERE  jle_jrnl_hdr_id = gJournalHeader.jhu_jrnl_id
              AND    user_session_id = gSessionId
              AND  jle_error_code IN ('MADJ-1014','MADJ-1015','MADJ-1016',
                                        'MADJ-1021','MADJ-1022','MADJ-1025');
        EXCEPTION
              WHEN NO_DATA_FOUND THEN
                   NULL; -- do nothing
              WHEN OTHERS THEN
                   pr_error(1, SQLERRM, 0, 'fnui_validate_line_dates.4', 'temp_gui_jrnl_line_errors', NULL, NULL, gPackageName, 'PL/SQL', NULL, NULL, NULL, NULL, NULL, NULL, NULL);
        END;
    ...
    EXCEPTION
        WHEN OTHERS THEN
            pr_error(1, SQLERRM, 0, 'fnui_validate_line_dates', 'gui_jrnl_lines_unposted', NULL, NULL, gPackageName, 'PL/SQL', NULL, NULL, NULL, NULL, NULL, NULL, NULL);
            RETURN FALSE;
    ...
    IS
          ...
          CURSOR cur_meta_data IS
            SELECT COLUMN_SCREEN_LABEL,
                   COLUMN_NAME,
                   NVL(FRL.LK_LOOKUP_VALUE1,COLUMN_USED_IN_BALANCE) COLUMN_USED_IN_BALANCE,-- AG custom was COLUMN_USED_IN_BALANCE,
              ...
              LEFT OUTER JOIN fdr.fr_general_lookup frl on COLUMN_NAME = FRL.LK_MATCH_KEY2 and FRL.LK_LKT_LOOKUP_TYPE_CODE = 'MADJ_BALANCE_COLUMNS' -- AG custom
              LEFT JOIN (SELECT FD_SEGMENT_1_BALANCE_CHECK,FD_SEGMENT_2_BALANCE_CHECK,FD_SEGMENT_3_BALANCE_CHECK,
          ...
          CURSOR cur_complex_balance_check IS
            SELECT 'Y'
         ...
         BEGIN
            ...
            IF gJournalHeader.jhu_jrnl_total_lines IS NULL OR
               gJournalHeader.jhu_jrnl_total_lines = 0
            THEN
               RETURN lvSuccess;
            END IF;
         ...
         FOR rec IN cur_meta_data
           ...
           IF UPPER(rec.COLUMN_USED_IN_BALANCE) = 'Y' or nvl(upper(rec.FD_BALANCE_CHECK),'N') = 'Y' THEN
              lv_sql_template := lv_sql_template||', jlu_'||LOWER(rec.COLUMN_NAME);
              lvTemplateMessage := lvTemplateMessage||LOWER(rec.COLUMN_SCREEN_LABEL)||', ';
           END IF;
         END LOOP;
         ...
         lvDTemplateMessage := lv_orig_TemplateMessage; -- AG custom 


           EXCEPTION
         WHEN OTHERS THEN
           pr_error(1, SQLERRM, 0, 'fnui_validate_balances.1', 'gui_jrnl_lines_unposted', NULL, NULL, gPackageName, 'PL/SQL', NULL, NULL, NULL, NULL, NULL, NULL, NULL);
               RETURN FALSE;
           END;
           ...
           BEGIN
             ...
             lvD_sql_template := REPLACE(lvD_sql_template,'##NAME##','jlu_tran_amount');  -- AG Custom
             lvDTemplateMessage := REPLACE(lvDTemplateMessage,'##NAME##','jlu_tran_amount'); -- AG Custom
           ...
           EXCEPTION
             WHEN OTHERS THEN
               pr_error(1, SQLERRM, 0, 'fnui_validate_balances.2', 'gui_jrnl_lines_unposted', NULL, NULL, gPackageName, 'PL/SQL', NULL, NULL, NULL, NULL, NULL, NULL, NULL);
           ...
           IF NVL(lvComplexCheck,'N') = 'Y' THEN
             ...
             lvD_sql_template := REPLACE(lvD_sql_template,'##NAME##','jlu_base_amount'); -- AG Custom
             lvDTemplateMessage := REPLACE(lv_orig_TemplateMessage,'##NAME##','jlu_base_amount'); -- AG Custom
               ...
               IF lvCount > 0 THEN
                ...
                END LOOP;
                   ...
                   lvMessage := lvDTemplateMessage; -- AG custom 
                   prui_log_error(gJournalHeader.jhu_jrnl_id, 0, 1013, SUBSTR(lvMessage,1,1000));
                   lvSuccess := FALSE;
               END IF;
             ...
             EXCEPTION
               WHEN OTHERS THEN
                 pr_error(1, SQLERRM, 0, 'fnui_validate_balances.3', 'gui_jrnl_lines_unposted', NULL, NULL, gPackageName, 'PL/SQL', NULL, NULL, NULL, NULL, NULL, NULL, NULL);
                 prui_log_error(gJournalHeader.jhu_jrnl_id, 0, 9999, 'Failed journal balance check');
                 lvSuccess := FALSE;
             END;
        ...
        END IF;
             ...
             EXCEPTION
               WHEN OTHERS THEN
                 pr_error(1, SQLERRM, 0, 'fnui_validate_balances.4', 'gui_jrnl_lines_unposted', NULL, NULL, gPackageName, 'PL/SQL', NULL, NULL, NULL, NULL, NULL, NULL, NULL);
                 prui_log_error(gJournalHeader.jhu_jrnl_id, 0, 9999, 'Failed journal balance check');
                 lvSuccess := FALSE;
             END;
    ...
    EXCEPTION
          WHEN OTHERS THEN
            pr_error(1, SQLERRM, 0, 'fnui_validate_balances.5', 'gui_jrnl_lines_unposted', NULL, NULL, gPackageName, 'PL/SQL', NULL, NULL, NULL, NULL, NULL, NULL, NULL);
            RETURN FALSE;
  ...
  --********************************************************************************
    ...
    IS
      ...
      vJrnlLinesDimention VARCHAR2(1000);
          vJrnlHdrId            SLR_JRNL_HEADERS_UNPOSTED.JHU_JRNL_ID%TYPE;
      ...
      if(v_not_configured_entity>0)then
       ...
       WHEN TOO_MANY_ROWS THEN
        pr_error(1, SQLERRM ||
                 ': Too many matching entity processing groups found. Please check your configuration'
                    || case when vEPG_DIMENSION_column_name is not null then
                  ' and/or make sure all lines within header have the same value in ' || vEPG_DIMENSION_column_name || ' column.'
                    else '.' end, 0, 'fnui_check_ent_proc_group_conf.1', 'gui_jrnl_lines_unposted', NULL, NULL, gPackageName, 'PL/SQL', NULL, NULL, NULL, NULL, NULL, NULL, NULL);
           RETURN FALSE;
         WHEN NO_DATA_FOUND OR NoEntGroupFound THEN
        pr_error(1, SQLERRM ||': No matching entity processing group found. Please check your configuration.', 0, 'fnui_check_ent_proc_group_conf.2', 'gui_jrnl_lines_unposted', NULL, NULL, gPackageName, 'PL/SQL', NULL, NULL, NULL, NULL, NULL, NULL, NULL);
           RETURN FALSE;
       WHEN OTHERS THEN
         pr_error(1, SQLERRM, 0, 'fnui_check_ent_proc_group_conf.3', 'gui_jrnl_lines_unposted', NULL, NULL, gPackageName, 'PL/SQL', NULL, NULL, NULL, NULL, NULL, NULL, NULL);
           RETURN FALSE;
           END;
       ...
       gJrnlEntityProcGroup := v_entity_proc_group;
           ...
           --set entity processing group for all lines
            ...
            WHERE jlu_jrnl_hdr_id       = vJrnlHdrId
                AND user_session_id     = gSessionId
            ;
    ...
    EXCEPTION
          WHEN OTHERS THEN
            pr_error(1, SQLERRM, 0, 'fnui_check_ent_proc_group_conf.4', 'gui_jrnl_lines_unposted', NULL, NULL, gPackageName, 'PL/SQL', NULL, NULL, NULL, NULL, NULL, NULL, NULL);
            RETURN FALSE;
    ...
    BEGIN
         ...
         BEGIN
              ...
              SELECT /* jle_jrnl_process_id */    0,
                     ...
                     /* jle_error_string */     'Account is invalid',
                     /* jle_created_by */     'SYSTEM',
                     /* jle_created_on */     SYSDATE,
                     /* jle_amended_by */     'SYSTEM',
                     /* jle_amended_on */     SYSDATE
              ...
              AND jlu_account NOT IN (SELECT ea_account
                                             ...
                                             WHERE  ea_entity_set = gEntityConfiguration.ent_accounts_set
                                             AND  ea_status = 'A');

         EXCEPTION
            WHEN OTHERS THEN
                 pr_error(1, SQLERRM, 0, 'fnui_validate_account', 'slr_entity_accounts', NULL, NULL, gPackageName, 'PL/SQL', NULL, NULL, NULL, NULL, NULL, NULL, NULL);
                 lvSuccess := FALSE;
         END;
         ...
         EXCEPTION
              WHEN NO_DATA_FOUND THEN
                   NULL; -- do nothing
              WHEN OTHERS THEN
                   pr_error(1, SQLERRM, 0, 'fnui_validate_account', 'temp_gui_jrnl_lines_unposted', NULL, NULL, gPackageName, 'PL/SQL', NULL, NULL, NULL, NULL, NULL, NULL, NULL);
         END;
    ...
    BEGIN
        ...
        EXCEPTION
            WHEN NO_DATA_FOUND THEN
                 prui_log_error(gJournalHeader.jhu_jrnl_id, 0, 1023,
                                        'Invalid period or period is closed for the Effective Date '||to_char(gJournalHeader.jhu_jrnl_date, 'DD-MON-YYYY'));
                 lvSuccess := FALSE;
            WHEN OTHERS THEN
                 pr_error(1, SQLERRM, 0, 'fnui_validate_periods.1', 'slr_entity_periods', NULL, NULL, gPackageName, 'PL/SQL', NULL, NULL, NULL, NULL, NULL, NULL, NULL);
                 lvSuccess := FALSE;
        END;

        -- Check value date on line (if exists)
        IF gJournalHeader.jhu_jrnl_total_lines > 0 THEN
		  ...
		  IF lvPostValueDateFlag = 'Y' THEN
              BEGIN
                  ...
                  SELECT /* jle_jrnl_process_id */    0,
                         ...
                         /* jle_jrnl_hdr_id */      jlu_jrnl_hdr_id,
                         /* jle_jrnl_line_number */   jlu_jrnl_line_number,
                         /* jle_error_code */       'MADJ-1024',
                         /* jle_error_string */     'Period containing Value Date '||TO_CHAR(jlu_value_date, 'dd-mon-yyyy')||' is invalid or is closed',
                         /* jle_created_by */     'SYSTEM',
                         /* jle_created_on */     SYSDATE,
                         /* jle_amended_by */     'SYSTEM',
                         /* jle_amended_on */     SYSDATE
                  ...
                  AND   NOT EXISTS (SELECT 1
                                    ...
                                    WHERE  jlu_value_date >= ep_bus_period_start --TO_DATE('01/'||ep_month||'/'||ep_year, 'DD/MM/YYYY')
              ...
              EXCEPTION
                WHEN OTHERS THEN
                     pr_error(1, SQLERRM, 0, 'fnui_validate_periods.2', 'slr_entity_periods', NULL, NULL, gPackageName, 'PL/SQL', NULL, NULL, NULL, NULL, NULL, NULL, NULL);
                     lvSuccess := FALSE;
              END;
		  END IF;
        ...
        END IF;
         ...
         EXCEPTION
              WHEN NO_DATA_FOUND THEN
                   NULL; -- do nothing
              WHEN OTHERS THEN
                   pr_error(1, SQLERRM, 0, 'fnui_validate_periods.3', 'temp_gui_jrnl_lines_unposted', NULL, NULL, gPackageName, 'PL/SQL', NULL, NULL, NULL, NULL, NULL, NULL, NULL);
         END;
    ...
    EXCEPTION
        WHEN OTHERS THEN
            pr_error(1, SQLERRM, 0, 'fnui_validate_periods', 'slr_entity_periods', NULL, NULL, gPackageName, 'PL/SQL', NULL, NULL, NULL, NULL, NULL, NULL, NULL);
            RETURN FALSE;
    ...
    BEGIN
         ...
         BEGIN
            ...
            SELECT /* jle_jrnl_process_id */    0,
                      ...
                      /* jle_jrnl_hdr_id */     jlu_jrnl_hdr_id,
                      /* jle_jrnl_line_number */  jlu_jrnl_line_number,
                      /* jle_error_code */        'MADJ-1011',
                      /* jle_error_string */    'Transaction currency does not exist or is not active.',
                      /* jle_created_by */      'SYSTEM',
                      /* jle_created_on */      SYSDATE,
                      /* jle_amended_by */      'SYSTEM',
                      /* jle_amended_on */      SYSDATE
            ...
            AND   TRIM(jlu_tran_ccy) NOT IN (SELECT TRIM(ec_ccy)
                                       ...
                                       WHERE  ec_entity_set = gEntityConfiguration.ent_currency_set
                                       AND    ec_status  = 'A');

         EXCEPTION
            WHEN OTHERS THEN
                 pr_error(1, SQLERRM, 0, 'fnui_check_currencies.1', 'slr_entity_currencies', NULL, NULL, gPackageName, 'PL/SQL', NULL, NULL, NULL, NULL, NULL, NULL, NULL);
                 lvSuccess := FALSE;
         END;
         ...
         BEGIN
             ...
             SELECT /* jle_jrnl_process_id */   0,
                      ...
                      /* jle_jrnl_line_number */  jlu_jrnl_line_number,
                      /* jle_error_code */        'MADJ-1061',
                      /* jle_error_string */    'Currency '||jlu_tran_ccy||' contains too many decimal places',
                      /* jle_created_by */      'SYSTEM',
                      /* jle_created_on */      SYSDATE,
                      /* jle_amended_by */      'SYSTEM',
                      /* jle_amended_on */      SYSDATE
             ...
             AND   EXISTS(SELECT 1
                            ...
                            AND   cu_digits_after_point < LENGTH(TO_CHAR(jlu_tran_amount))
                                                            - DECODE(INSTR(TO_CHAR(jlu_tran_amount), '.'),
                                                                        0,LENGTH(TO_CHAR(jlu_tran_amount)),
                                                                        INSTR(TO_CHAR(jlu_tran_amount), '.')));
         EXCEPTION
            WHEN OTHERS THEN
                 pr_error(1, SQLERRM, 0, 'fnui_check_currencies.2', 'slr_entity_currencies', NULL, NULL, gPackageName, 'PL/SQL', NULL, NULL, NULL, NULL, NULL, NULL, NULL);
                 lvSuccess := FALSE;
         END;
         ...
         BEGIN
            ...
            SELECT /* jle_jrnl_process_id */    0,
                      ...
                      /* jle_jrnl_line_number */  jlu_jrnl_line_number,
                      /* jle_error_code */        'MADJ-1011',
                      /* jle_error_string */    'Base currency does not exist or is not active.',
                      /* jle_created_by */      'SYSTEM',
                      /* jle_created_on */      SYSDATE,
                      /* jle_amended_by */      'SYSTEM',
                      /* jle_amended_on */      SYSDATE
         ...
         EXCEPTION
            WHEN OTHERS THEN
                 pr_error(1, SQLERRM, 0, 'fnui_check_currencies.3', 'slr_entity_currencies', NULL, NULL, gPackageName, 'PL/SQL', NULL, NULL, NULL, NULL, NULL, NULL, NULL);
                 lvSuccess := FALSE;
         END;
         ...
         BEGIN
             ...
             SELECT /* jle_jrnl_process_id */   0,
                      ...
                      /* jle_jrnl_line_number */  jlu_jrnl_line_number,
                      /* jle_error_code */        'MADJ-1061',
                      /* jle_error_string */    'Currency '||jlu_base_ccy||' contains too many decimal places',
                      /* jle_created_by */      'SYSTEM',
                      /* jle_created_on */      SYSDATE,
                      /* jle_amended_by */      'SYSTEM',
                      /* jle_amended_on */      SYSDATE
             ...
             AND   EXISTS(SELECT 1
                            ...
                            AND   cu_digits_after_point < LENGTH(TO_CHAR(jlu_base_amount))
                                                            - DECODE(INSTR(TO_CHAR(jlu_base_amount), '.'),
                                                                        0,LENGTH(TO_CHAR(jlu_base_amount)),
                                                                        INSTR(TO_CHAR(jlu_base_amount), '.')));
         EXCEPTION
            WHEN OTHERS THEN
                 pr_error(1, SQLERRM, 0, 'fnui_check_currencies.4', 'slr_entity_currencies', NULL, NULL, gPackageName, 'PL/SQL', NULL, NULL, NULL, NULL, NULL, NULL, NULL);
                 lvSuccess := FALSE;
         END;
         ...
         BEGIN
            ...
            SELECT /* jle_jrnl_process_id */            0,
                      ...
                      /* jle_jrnl_line_number */          jlu_jrnl_line_number,
                      /* jle_error_code */        'MADJ-1011',
                      /* jle_error_string */    'Local currency does not exist or is not active.',
                      /* jle_created_by */      'SYSTEM',
                      /* jle_created_on */      SYSDATE,
                      /* jle_amended_by */      'SYSTEM',
                      /* jle_amended_on */      SYSDATE
         ...
         EXCEPTION
            WHEN OTHERS THEN
                 pr_error(1, SQLERRM, 0, 'fnui_check_currencies.5', 'slr_entity_currencies', NULL, NULL, gPackageName, 'PL/SQL', NULL, NULL, NULL, NULL, NULL, NULL, NULL);
                 lvSuccess := FALSE;
         END;
         ...
         BEGIN
             ...
             SELECT /* jle_jrnl_process_id */   0,
                      ...
                      /* jle_jrnl_line_number */  jlu_jrnl_line_number,
                      /* jle_error_code */        'MADJ-1061',
                      /* jle_error_string */    'Currency '||jlu_local_ccy||' contains too many decimal places',
                      /* jle_created_by */      'SYSTEM',
                      /* jle_created_on */      SYSDATE,
                      /* jle_amended_by */      'SYSTEM',
                      /* jle_amended_on */      SYSDATE
             ...
             AND   EXISTS(SELECT 1
                                      ...
                                      AND   cu_digits_after_point < LENGTH(TO_CHAR(jlu_local_amount))
                                                                             - DECODE(INSTR(TO_CHAR(jlu_local_amount), '.'),
                                                                        0,LENGTH(TO_CHAR(jlu_local_amount)),
                                                                        INSTR(TO_CHAR(jlu_local_amount), '.')));
         EXCEPTION
            WHEN OTHERS THEN
         ...
         END;
                ...
                --AG CUSTOM - this created false positives and was commented out
...
--                AND  ( tgjlu.jlu_base_amount IS NOT NULL
--                     OR     tgjlu.jlu_local_amount IS NOT NULL) );
--
--         EXCEPTION
--            WHEN OTHERS THEN
--                 pr_error(1, SQLERRM, 0, 'fnui_check_currencies.6', 'slr_entity_currencies', NULL, NULL, gPackageName, 'PL/SQL', NULL, NULL, NULL, NULL, NULL, NULL, NULL);
...
--         END;
		...
		SELECT EJT_EFF_EJTR_CODE INTO lvValRuleCode
		FROM slr.SLR_EXT_JRNL_TYPES WHERE ejt_type = gJournalHeader.jhu_jrnl_type;
        ...
        if ( gEntityConfiguration.ENT_APPLY_FX_TRANSLATION = 'Y' and (
			 ( lvValRuleCode <> 'EQUALNEXT' and gJournalHeader.jhu_jrnl_date <= gEntityConfiguration.ENT_BUSINESS_DATE ) or
			 ( lvValRuleCode = 'EQUALNEXT' and gJournalHeader.jhu_jrnl_date -1 <= gEntityConfiguration.ENT_BUSINESS_DATE))) then
          begin
...
/*-----------UPGRADE 20.1.1 MERGE START-----------*/
      ...
      AND   tjlu.jlu_local_amount IS NULL
            AND   user_session_id = gSessionId
      ...
      LEFT JOIN slr.SLR_FX_TRANSLATION_CONFIG SFTC_base
         on SFTC_base.FTC_ENTITY = tjlu.JLU_ENTITY
           ...
           and SFTC_base.FTC_TARGET_AMOUNT_TYPE = 'Base'
            WHERE jlu_jrnl_hdr_id = gJournalHeader.jhu_jrnl_id
      AND   JLU_ENTITY = gEntityConfiguration.ENT_ENTITY
      AND   tjlu.jlu_base_amount IS NULL
            AND   user_session_id = gSessionId
            AND NOT EXISTS (SELECT 1 FROM SLR_ENTITY_RATES
...
/*-----------UPGRADE 20.1.1 MERGE END-----------*/
         EXCEPTION
              WHEN NO_DATA_FOUND THEN
                   NULL;
              WHEN OTHERS THEN
                   pr_error(1, SQLERRM, 0, 'fnui_check_currencies.9', 'temp_gui_jrnl_lines_unposted', NULL, NULL, gPackageName, 'PL/SQL', NULL, NULL, NULL, NULL, NULL, NULL, NULL);
         END;
    ...
    EXCEPTION
        WHEN OTHERS THEN
            pr_error(1, SQLERRM, 0, 'fnui_check_currencies', 'slr_entity_currencies', NULL, NULL, gPackageName, 'PL/SQL', NULL, NULL, NULL, NULL, NULL, NULL, NULL);
            RETURN FALSE;
    ...
    BEGIN
         ...
         EXCEPTION
            WHEN NO_DATA_FOUND THEN
                 prui_log_error(gJournalHeader.jhu_jrnl_id, 0, 9999,
                                        'Journal Type '||gJournalHeader.jhu_jrnl_type||' does not exist or is not activated');
                 lvSuccess := FALSE;
            WHEN OTHERS THEN
                 pr_error(1, SQLERRM, 0, 'fnui_get_journal_type.1', 'slr_jrnl_types', NULL, NULL, gPackageName, 'PL/SQL', NULL, NULL, NULL, NULL, NULL, NULL, NULL);
                 lvSuccess := FALSE;
         END;
         ...
         EXCEPTION
            ...
            WHEN OTHERS THEN
                 pr_error(1, SQLERRM, 0, 'fnui_get_journal_type.2', 'slr_jrnl_types', NULL, NULL, gPackageName, 'PL/SQL', NULL, NULL, NULL, NULL, NULL, NULL, NULL);
                 lvFound := NULL;
         END;

         IF lvFound > 0 THEN
            prui_log_error(gJournalHeader.jhu_jrnl_id, 0, 1035,
                                        'This action is not permitted for Journal Type '||gJournalHeader.jhu_jrnl_type);
            lvSuccess := FALSE;
         END IF;
    ...
    BEGIN
         ...
         EXCEPTION
            WHEN NO_DATA_FOUND THEN
                 prui_log_error(gJournalHeader.jhu_jrnl_id, 0, 9999,
                                        'FAK Definitions for entity '||gJournalHeader.jhu_jrnl_entity||' does not exist');
                 lvSuccess := FALSE;
            WHEN OTHERS THEN
                 pr_error(1, SQLERRM, 0, 'fnui_get_fak_definitions', 'slr_fak_definitions', NULL, NULL, gPackageName, 'PL/SQL', NULL, NULL, NULL, NULL, NULL, NULL, NULL);
                 lvSuccess := FALSE;
         END;
    ...
    BEGIN
         ...
         EXCEPTION
            WHEN NO_DATA_FOUND THEN
                 prui_log_error(gJournalHeader.jhu_jrnl_id, 0, 9999,
                                        'EBA Definitions for entity '||gJournalHeader.jhu_jrnl_entity||' does not exist');
                 lvSuccess := FALSE;
            WHEN OTHERS THEN
                 pr_error(1, SQLERRM, 0, 'fnui_get_eba_definitions', 'slr_eba_definitions', NULL, NULL, gPackageName, 'PL/SQL', NULL, NULL, NULL, NULL, NULL, NULL, NULL);
                 lvSuccess := FALSE;
         END;
    ...
    BEGIN
         ...
         BEGIN
            ...
            WHERE  ent_entity = gJournalHeader.jhu_jrnl_entity
            AND    ent_status = 'A'
            -- following AND is AG Custom.  Gets only real insurance companies, elim companies, and consolidation companies
            AND    EXISTS (SELECT NULL
                           FROM FDR.FR_PARTY_LEGAL pl
                           WHERE PL.PL_PARTY_LEGAL_ID = ENT_ENTITY
                             AND PL.PL_CLIENT_TEXT7 = 'Y');
         EXCEPTION
            WHEN NO_DATA_FOUND THEN
                 prui_log_error(gJournalHeader.jhu_jrnl_id, 0, 9999,
                                        'Entity '||gJournalHeader.jhu_jrnl_entity||' does not exist or is not activated or is not a standalone insurance co');  --AG custom message after activated is custom
                 lvSuccess := FALSE;
            WHEN OTHERS THEN
                 pr_error(1, SQLERRM, 0, 'fnui_get_entity', 'slr_entities', NULL, NULL, gPackageName, 'PL/SQL', NULL, NULL, NULL, NULL, NULL, NULL, NULL);
                 lvSuccess := FALSE;
         END;
    ...
    IS
       ...
       v_screen_segment_name T_UI_JRNL_LINE_META.COLUMN_NAME%TYPE;
       v_column_screen_label T_UI_JRNL_LINE_META.COLUMN_SCREEN_LABEL%TYPE; 
    ...
    select column_screen_label into v_column_screen_label
    from gui.T_UI_JRNL_LINE_META
    ...
    and column_type = 'L';
        ...
        END;
         ...
         BEGIN
            lv_sql_statement := 'INSERT INTO temp_gui_jrnl_line_errors ( '
                                ||' jle_jrnl_process_id, user_session_id, jle_jrnl_hdr_id, jle_jrnl_line_number, '
                                ||' jle_error_code, jle_error_string, jle_created_by, jle_created_on, '
                                ||' jle_amended_by, jle_amended_on '
                                ||' ) '
                                ||' SELECT /* jle_jrnl_process_id */    0, '
                                           ...
                                           ||'/* jle_error_string */    '''||v_column_screen_label||' is greater than 100 characters.'', '
                                           ||'/* jle_created_by */      ''SYSTEM'', '
                                           ||'/* jle_created_on */      SYSDATE, '
                                           ||'/* jle_amended_by */      ''SYSTEM'', '
                                           ||'/* jle_amended_on */      SYSDATE '
                                ...
                                ||' WHERE jlu_jrnl_hdr_id = '''||gJournalHeader.jhu_jrnl_id || ''''
                                ||' AND user_session_id = '''||gSessionId||''' '
                                ||' AND LENGTH(jlu_segment_'||TO_CHAR(segment_no)||') > 100 ';

            EXECUTE IMMEDIATE lv_sql_statement;

        EXCEPTION
            WHEN OTHERS THEN
                 pr_error(1, SQLERRM||' '||lv_sql_statement, 0, 'fnui_validate_segment_n', 'slr_fak_segment_'||TO_CHAR(segment_no), NULL, NULL, gPackageName, 'PL/SQL', NULL, NULL, NULL, NULL, NULL, NULL, NULL);
                 lvSuccess := FALSE;
                 lvFound   := NULL;
        END;

         -- Check if validation required
         IF fak_type IN ('C', 'M') THEN
                ...
                IF fak_type = 'C' THEN
                    ...
                    lv_sql_statement := 'INSERT INTO temp_gui_jrnl_line_errors ( '
                                        ...
                                        ||' SELECT /* jle_jrnl_process_id */    0, '
                                                   ...
                                                   ||'/* jle_error_string */    ''Value for '||v_column_screen_label||' is invalid.'', '
                                                   ||'/* jle_created_by */      ''SYSTEM'', '
                                                   ||'/* jle_created_on */      SYSDATE, '
                                                   ||'/* jle_amended_by */      ''SYSTEM'', '
                                                   ||'/* jle_amended_on */      SYSDATE '
                                        ...
                                        ||' WHERE jlu_jrnl_hdr_id = '''||gJournalHeader.jhu_jrnl_id || ''''
                                        ||' AND user_session_id = '''||gSessionId||''' '
                                        ||' AND NVL(jlu_segment_'||TO_CHAR(segment_no)||',''NVS'') != ''NVS'' '
                                        ||' AND jlu_segment_'||TO_CHAR(segment_no)||' NOT IN '
                                        ||' (SELECT fs'||TO_CHAR(segment_no)||'_segment_value '
                                        ||'  FROM '||fak_table
                                        ||'  WHERE fs'||TO_CHAR(segment_no)||'_entity_set = '''||fak_set_name||''' '
                                        ||'  AND   fs'||TO_CHAR(segment_no)||'_status = ''A'') ';
         ...
         EXCEPTION
              WHEN NO_DATA_FOUND THEN
                   NULL; -- do nothing
              WHEN OTHERS THEN
                   pr_error(1, SQLERRM, 0, 'fnui_validate_segment_n', 'temp_gui_jrnl_lines_unposted', NULL, NULL, gPackageName, 'PL/SQL', NULL, NULL, NULL, NULL, NULL, NULL, NULL);
         END;
    ...
    EXCEPTION
        WHEN OTHERS THEN
            pr_error(1, SQLERRM, 0, 'fnui_validate_segment_n', 'slr_fak_segment_'||TO_CHAR(segment_no), NULL, NULL, gPackageName, 'PL/SQL', NULL, NULL, NULL, NULL, NULL, NULL, NULL);
            RETURN FALSE;
    ...
    BEGIN
         ...
         ELSE
            prui_log_error(gJournalHeader.jhu_jrnl_id, 0, 9999,
                                    'EBA Definition not found for attribute '||TO_CHAR(attribute_no));
            lvSuccess := FALSE;
         END IF;
         ...
         BEGIN
            lv_sql_statement := 'INSERT INTO temp_gui_jrnl_line_errors ( '
                                ...
                                ||' SELECT /* jle_jrnl_process_id */    0, '
                                           ...
                                           ||'/* jle_jrnl_line_number */  jlu_jrnl_line_number, '
                                           ||'/* jle_error_code */        ''MADJ-1013'', '
                                           ||'/* jle_error_string */    '''||eba_name||' is greater than 100 characters.'', '
                                           ||'/* jle_created_by */      ''SYSTEM'', '
                                           ||'/* jle_created_on */      SYSDATE, '
                                           ||'/* jle_amended_by */      ''SYSTEM'', '
                                           ||'/* jle_amended_on */      SYSDATE '
                                ...
                                ||' WHERE jlu_jrnl_hdr_id = '''||gJournalHeader.jhu_jrnl_id || ''''
                                ||' AND user_session_id = '''||gSessionId||''' '
                                ||' AND LENGTH(jlu_attribute_'||TO_CHAR(attribute_no)||') > 100 ';

            EXECUTE IMMEDIATE lv_sql_statement;

        EXCEPTION
            WHEN OTHERS THEN
                 pr_error(1, SQLERRM||' '||lv_sql_statement, 0, 'fnui_validate_attribute_n', 'slr_attribute_'||TO_CHAR(attribute_no), NULL, NULL, gPackageName, 'PL/SQL', NULL, NULL, NULL, NULL, NULL, NULL, NULL);
                 lvSuccess := FALSE;
                 lvFound   := NULL;
        END;

         -- Check if validation required
         IF eba_type IN ('C', 'M') THEN
                ...
                IF eba_type = 'C' THEN
                    ...
                    lv_sql_statement := 'INSERT INTO temp_gui_jrnl_line_errors ( '
                                        ...
                                        ||' SELECT /* jle_jrnl_process_id */    0, '
                                                   ...
                                                   ||'/* jle_jrnl_line_number */  jlu_jrnl_line_number, '
                                                   ||'/* jle_error_code */        ''MADJ-1012'', '
                                                   ||'/* jle_error_string */    ''Value for '||eba_name||' is missing.'', '
                                                   ||'/* jle_created_by */      ''SYSTEM'', '
                                                   ||'/* jle_created_on */      SYSDATE, '
                                                   ||'/* jle_amended_by */      ''SYSTEM'', '
                                                   ||'/* jle_amended_on */      SYSDATE '
                                        ...
                                        ||' WHERE jlu_jrnl_hdr_id = '''||gJournalHeader.jhu_jrnl_id || ''''
                                        ||' AND user_session_id = '''||gSessionId||''' '
                                        ||' AND jlu_attribute_'||TO_CHAR(attribute_no)||' != ''NVS'' '
                                        ||' AND jlu_attribute_'||TO_CHAR(attribute_no)||' IS NULL ';
         ...
         EXCEPTION
              WHEN NO_DATA_FOUND THEN
                   NULL; -- do nothing
              WHEN OTHERS THEN
                   pr_error(1, SQLERRM, 0, 'fnui_validate_attribute_n', 'temp_gui_jrnl_lines_unposted', NULL, NULL, gPackageName, 'PL/SQL', NULL, NULL, NULL, NULL, NULL, NULL, NULL);
         END;
    ...
    EXCEPTION
        WHEN OTHERS THEN
            pr_error(1, SQLERRM, 0, 'fnui_validate_attribute_n', 'slr_eba_attribute_'||TO_CHAR(attribute_no), NULL, NULL, gPackageName, 'PL/SQL', NULL, NULL, NULL, NULL, NULL, NULL, NULL);
            RETURN FALSE;
    ...
    BEGIN
         ...
         INSERT INTO temp_gui_jrnl_line_errors (
              user_session_id, jle_jrnl_process_id, jle_jrnl_hdr_id, jle_jrnl_line_number,
              jle_error_code, jle_error_string, jle_created_by, jle_created_on,
              jle_amended_by, jle_amended_on
         )
         VALUES (
              /* user_session_id */             gSessionId,
              /* jle_jrnl_process_id */           0,
              /* jle_jrnl_hdr_id */             journal_id,
              /* jle_jrnl_line_number */          line_no,
              /* jle_error_code */                'MADJ-'||error_no,
              /* jle_error_string */            message,
              /* jle_created_by */              'SYSTEM',
              /* jle_created_on */              SYSDATE,
              /* jle_amended_by */              'SYSTEM',
              /* jle_amended_on */              SYSDATE
    ...
    BEGIN
         ...
         IF gSessionId IS NULL THEN
            pr_error(1, SQLERRM, 0, 'prui_write_errors_to_database', 'temp_gui_jrnl_line_errors', NULL, NULL, gPackageName, 'PL/SQL', NULL, NULL, NULL, NULL, NULL, NULL, NULL);
            raise_application_error(-9001, 'Missing session id');
         END IF;
    ...
    BEGIN
         ...
         IF gSessionId IS NULL THEN
            pr_error(1, SQLERRM, 0, 'prui_clear_errors', 'temp_gui_jrnl_line_errors', NULL, NULL, gPackageName, 'PL/SQL', NULL, NULL, NULL, NULL, NULL, NULL, NULL);
            raise_application_error(-9001, 'Missing session id');
         END IF;
    ...
    BEGIN
         ...
         IF gJournalType.jt_requires_authorisation != 'Y' AND
            gJournalType.jt_madj_ind = 'Y'
         THEN
            lvSuccess := FALSE;
         END IF;
    ...
    BEGIN
         ...
         IF NOT fnui_does_journal_exist(gJournalHeader.jhu_jrnl_id) THEN
            lvSuccess := FALSE;
            prui_log_error(gJournalHeader.jhu_jrnl_id, 0, 9999,
    ...
    BEGIN
         ...
         -- Check if journal exists
         IF NOT fnui_does_journal_exist(journal_id) THEN
            lvSuccess := FALSE;
            prui_log_error(journal_id, 0, 9999, 'Journal '||journal_id||' does not exist');
         ELSE
          ...
          THEN
            lvSuccess := FALSE;
              prui_log_error(journal_id, 0, 9999, 'Journal '||journal_id||' is currently processed. Cannot delete running journal.');
            END IF;
         END IF;

         IF gJournalType.jt_madj_ind != 'Y' THEN
            prui_log_error(journal_id, 0, 9999, 'Only manual journals can be deleted');
            lvSuccess := FALSE;
         END IF;
    ...
    BEGIN
         ...
         IF NOT fnui_does_line_exist(gJournalHeader.jhu_jrnl_id, line_number) THEN
            lvSuccess := FALSE;
            prui_log_error(gJournalHeader.jhu_jrnl_id, line_number, 9999,
                                'Line'||line_number||' of journal '||gJournalHeader.jhu_jrnl_id||' does not exist');
         END IF;
    ...
    BEGIN
         ...
         -- Check if journal line exists
         IF NOT fnui_does_line_exist(journal_id, line_number) THEN
            lvSuccess := FALSE;
            prui_log_error(journal_id, line_number, 9999,
                                'Line'||line_number||' of journal '||journal_id||' does not exist');
         END IF;
    ...
    BEGIN
         ...
         IF UPPER(gJournalHeader.JHU_JRNL_PREF_STATIC_SRC) = gCLIENT_STATIC THEN
            RETURN lvSuccess;
         END IF;

         -- Convert source system codes to FDR codes using correlated query
         UPDATE temp_gui_jrnl_lines_unposted tsjlu
         SET  (jlu_segment_1, jlu_segment_2, jlu_segment_3, jlu_segment_4, jlu_segment_5,
                 jlu_segment_6, jlu_segment_7, jlu_segment_8, jlu_segment_9, jlu_segment_10,
                 ...
                 = (SELECT MAX(segment_1) AS segment_1,
                  ...
                  FROM
                    (SELECT jlu_jrnl_hdr_id, jlu_jrnl_line_number,
                            DECODE(column_order, 1, fdr_code) AS segment_1, DECODE(column_order, 2, fdr_code) AS segment_2,
                            DECODE(column_order, 3, fdr_code) AS segment_3, DECODE(column_order, 4, fdr_code) AS segment_4,
                            DECODE(column_order, 5, fdr_code) AS segment_5, DECODE(column_order, 6, fdr_code) AS segment_6,
                            DECODE(column_order, 7, fdr_code) AS segment_7, DECODE(column_order, 8, fdr_code) AS segment_8,
                            DECODE(column_order, 9, fdr_code) AS segment_9, DECODE(column_order, 10, fdr_code) AS segment_10,
                            DECODE(column_order, 11, fdr_code) AS attribute_1, DECODE(column_order, 12, fdr_code) AS attribute_2,
                            DECODE(column_order, 13, fdr_code) AS attribute_3, DECODE(column_order, 14, fdr_code) AS attribute_4,
                            DECODE(column_order, 15, fdr_code) AS attribute_5
                     FROM
                       (  SELECT 1 AS column_order, tsjlu.jlu_jrnl_hdr_id, tsjlu.jlu_jrnl_line_number, NVL(vug1.fdr_code, jlu_segment_1) as fdr_code
                          FROM temp_gui_jrnl_lines_unposted tsjlu
                          LEFT OUTER JOIN vw_ui_segment_1 vug1 ON tsjlu.jlu_segment_1 = vug1.lookup_key AND vug1.source_system_id = gJournalHeader.jhu_jrnl_pref_static_src
                          WHERE tsjlu.jlu_jrnl_hdr_id = gJournalHeader.jhu_jrnl_id
                          AND   tsjlu.user_session_id = gSessionId
                        UNION ALL
                          SELECT 2 AS column_order, tsjlu.jlu_jrnl_hdr_id, tsjlu.jlu_jrnl_line_number, NVL(vug2.fdr_code, jlu_segment_2) as fdr_code
                          FROM temp_gui_jrnl_lines_unposted tsjlu
                          LEFT OUTER JOIN vw_ui_segment_2 vug2 ON tsjlu.jlu_segment_2 = vug2.lookup_key AND vug2.source_system_id = gJournalHeader.jhu_jrnl_pref_static_src
                          WHERE tsjlu.jlu_jrnl_hdr_id = gJournalHeader.jhu_jrnl_id
                          AND   tsjlu.user_session_id = gSessionId
                        UNION ALL
                          SELECT 3 AS column_order, tsjlu.jlu_jrnl_hdr_id, tsjlu.jlu_jrnl_line_number, NVL(vug3.fdr_code, jlu_segment_3) as fdr_code
                          FROM temp_gui_jrnl_lines_unposted tsjlu
                          LEFT OUTER JOIN vw_ui_segment_3 vug3 ON tsjlu.jlu_segment_3 = vug3.lookup_key AND vug3.source_system_id = gJournalHeader.jhu_jrnl_pref_static_src
                          WHERE tsjlu.jlu_jrnl_hdr_id = gJournalHeader.jhu_jrnl_id
                          AND   tsjlu.user_session_id = gSessionId
                        UNION ALL
                          SELECT 4 AS column_order, tsjlu.jlu_jrnl_hdr_id, tsjlu.jlu_jrnl_line_number, NVL(vug4.fdr_code, jlu_segment_4) as fdr_code
                          FROM temp_gui_jrnl_lines_unposted tsjlu
                          LEFT OUTER JOIN vw_ui_segment_4 vug4 ON tsjlu.jlu_segment_4 = vug4.lookup_key AND vug4.source_system_id = gJournalHeader.jhu_jrnl_pref_static_src
                          WHERE tsjlu.jlu_jrnl_hdr_id = gJournalHeader.jhu_jrnl_id
                          AND   tsjlu.user_session_id = gSessionId
                        UNION ALL
                          SELECT 5 AS column_order, tsjlu.jlu_jrnl_hdr_id, tsjlu.jlu_jrnl_line_number, NVL(vug5.fdr_code, jlu_segment_5) as fdr_code
                          FROM temp_gui_jrnl_lines_unposted tsjlu
                          LEFT OUTER JOIN vw_ui_segment_5 vug5 ON tsjlu.jlu_segment_5 = vug5.lookup_key AND vug5.source_system_id = gJournalHeader.jhu_jrnl_pref_static_src
                          WHERE tsjlu.jlu_jrnl_hdr_id = gJournalHeader.jhu_jrnl_id
                          AND   tsjlu.user_session_id = gSessionId
                        UNION ALL
                          SELECT 6 AS column_order, tsjlu.jlu_jrnl_hdr_id, tsjlu.jlu_jrnl_line_number, NVL(vug6.fdr_code, jlu_segment_6) as fdr_code
                          FROM temp_gui_jrnl_lines_unposted tsjlu
                          LEFT OUTER JOIN vw_ui_segment_6 vug6 ON tsjlu.jlu_segment_6 = vug6.lookup_key AND vug6.source_system_id = gJournalHeader.jhu_jrnl_pref_static_src
                          WHERE tsjlu.jlu_jrnl_hdr_id = gJournalHeader.jhu_jrnl_id
                          AND   tsjlu.user_session_id = gSessionId
                        UNION ALL
                          SELECT 7 AS column_order, tsjlu.jlu_jrnl_hdr_id, tsjlu.jlu_jrnl_line_number, NVL(vug7.fdr_code, jlu_segment_7) as fdr_code
                          FROM temp_gui_jrnl_lines_unposted tsjlu
                          LEFT OUTER JOIN vw_ui_segment_7 vug7 ON tsjlu.jlu_segment_7 = vug7.lookup_key AND vug7.source_system_id = gJournalHeader.jhu_jrnl_pref_static_src
                          WHERE tsjlu.jlu_jrnl_hdr_id = gJournalHeader.jhu_jrnl_id
                          AND   tsjlu.user_session_id = gSessionId
                        UNION ALL
                          SELECT 8 AS column_order, tsjlu.jlu_jrnl_hdr_id, tsjlu.jlu_jrnl_line_number, NVL(vug8.fdr_code, jlu_segment_8) as fdr_code
                          FROM temp_gui_jrnl_lines_unposted tsjlu
                          LEFT OUTER JOIN vw_ui_segment_8 vug8 ON tsjlu.jlu_segment_8 = vug8.lookup_key AND vug8.source_system_id = gJournalHeader.jhu_jrnl_pref_static_src
                          WHERE tsjlu.jlu_jrnl_hdr_id = gJournalHeader.jhu_jrnl_id
                          AND   tsjlu.user_session_id = gSessionId
                        UNION ALL
                          SELECT 9 AS column_order, tsjlu.jlu_jrnl_hdr_id, tsjlu.jlu_jrnl_line_number, NVL(vug9.fdr_code, jlu_segment_9) as fdr_code
                          FROM temp_gui_jrnl_lines_unposted tsjlu
                          LEFT OUTER JOIN vw_ui_segment_9 vug9 ON tsjlu.jlu_segment_9 = vug9.lookup_key AND vug9.source_system_id = gJournalHeader.jhu_jrnl_pref_static_src
                          WHERE tsjlu.jlu_jrnl_hdr_id = gJournalHeader.jhu_jrnl_id
                          AND   tsjlu.user_session_id = gSessionId
                        UNION ALL
                          SELECT 10 AS column_order, tsjlu.jlu_jrnl_hdr_id, tsjlu.jlu_jrnl_line_number, NVL(vug10.fdr_code, jlu_segment_10) as fdr_code
                          FROM temp_gui_jrnl_lines_unposted tsjlu
                          LEFT OUTER JOIN vw_ui_segment_10 vug10 ON tsjlu.jlu_segment_10 = vug10.lookup_key AND vug10.source_system_id = gJournalHeader.jhu_jrnl_pref_static_src
                          WHERE tsjlu.jlu_jrnl_hdr_id = gJournalHeader.jhu_jrnl_id
                          AND   tsjlu.user_session_id = gSessionId
                        UNION ALL
                          SELECT 11 AS column_order, tsjlu.jlu_jrnl_hdr_id, tsjlu.jlu_jrnl_line_number, NVL(vua1.fdr_code, jlu_attribute_1) as fdr_code
                          FROM temp_gui_jrnl_lines_unposted tsjlu
                          LEFT OUTER JOIN vw_ui_attribute_1 vua1 ON tsjlu.jlu_attribute_1 = vua1.lookup_key  AND vua1.source_system_id = gJournalHeader.jhu_jrnl_pref_static_src
                          WHERE tsjlu.jlu_jrnl_hdr_id = gJournalHeader.jhu_jrnl_id
                          AND   tsjlu.user_session_id = gSessionId
                        UNION ALL
                          SELECT 12 AS column_order, tsjlu.jlu_jrnl_hdr_id, tsjlu.jlu_jrnl_line_number, NVL(vua2.fdr_code, jlu_attribute_2) as fdr_code
                          FROM temp_gui_jrnl_lines_unposted tsjlu
                          LEFT OUTER JOIN vw_ui_attribute_2 vua2 ON tsjlu.jlu_attribute_2 = vua2.lookup_key AND vua2.source_system_id = gJournalHeader.jhu_jrnl_pref_static_src
                          WHERE tsjlu.jlu_jrnl_hdr_id = gJournalHeader.jhu_jrnl_id
                          AND   tsjlu.user_session_id = gSessionId
                        UNION ALL
                          SELECT 13 AS column_order, tsjlu.jlu_jrnl_hdr_id, tsjlu.jlu_jrnl_line_number, NVL(vua3.fdr_code, jlu_attribute_3) as fdr_code
                          FROM temp_gui_jrnl_lines_unposted tsjlu
                          LEFT OUTER JOIN vw_ui_attribute_3 vua3 ON tsjlu.jlu_attribute_3 = vua3.lookup_key AND vua3.source_system_id = gJournalHeader.jhu_jrnl_pref_static_src
                          WHERE tsjlu.jlu_jrnl_hdr_id = gJournalHeader.jhu_jrnl_id
                          AND   tsjlu.user_session_id = gSessionId
                        UNION ALL
                          SELECT 14 AS column_order, tsjlu.jlu_jrnl_hdr_id, tsjlu.jlu_jrnl_line_number, NVL(vua4.fdr_code, jlu_attribute_4) as fdr_code
                          FROM temp_gui_jrnl_lines_unposted tsjlu
                          LEFT OUTER JOIN vw_ui_attribute_4 vua4 ON tsjlu.jlu_attribute_4 = vua4.lookup_key AND vua4.source_system_id = gJournalHeader.jhu_jrnl_pref_static_src
                          WHERE tsjlu.jlu_jrnl_hdr_id = gJournalHeader.jhu_jrnl_id
                          AND   tsjlu.user_session_id = gSessionId
                        UNION ALL
                          SELECT 15 AS column_order, tsjlu.jlu_jrnl_hdr_id, tsjlu.jlu_jrnl_line_number, NVL(vua5.fdr_code, jlu_attribute_5) as fdr_code
                          FROM temp_gui_jrnl_lines_unposted tsjlu
                          LEFT OUTER JOIN vw_ui_attribute_5 vua5 ON tsjlu.jlu_attribute_5 = vua5.lookup_key AND vua5.source_system_id = gJournalHeader.jhu_jrnl_pref_static_src
                          WHERE tsjlu.jlu_jrnl_hdr_id = gJournalHeader.jhu_jrnl_id
                          AND   tsjlu.user_session_id = gSessionId
                        )
                     ) coltmp
                WHERE coltmp.jlu_jrnl_hdr_id = tsjlu.jlu_jrnl_hdr_id
                AND   coltmp.jlu_jrnl_line_number = tsjlu.jlu_jrnl_line_number
    ...
    EXCEPTION
        WHEN NO_DATA_FOUND THEN
             RETURN FALSE;
        WHEN OTHERS THEN
            pr_error(1, SQLERRM, 0, 'fnui_decode_journal_lines', 'gui_jrnl_lines_unposted', NULL, NULL, gPackageName, 'PL/SQL', NULL, NULL, NULL, NULL, NULL, NULL, NULL);
            RETURN FALSE;
    ...
    PROCEDURE prui_populate_header( session_id      IN    VARCHAR2,
                                    ...
                                    overwrite_details IN    CHAR                            DEFAULT 'Y',
                                    department_id in SLR_JRNL_HEADERS_UNPOSTED.JHU_DEPARTMENT_ID%TYPE DEFAULT 'DEFAULT'
                  --pEntityProcGroup  IN    VARCHAR2                          DEFAULT NULL
                  )
    IS
        lvJournalId         VARCHAR2(32) := NULL;
    ...
    BEGIN
        ...
        IF gSessionId IS NULL THEN
            pr_error(1, 'Missing session id', 0, 'prui_populate_header', 'temp_gui_jrnl_headers_unposted', NULL, NULL, gPackageName, 'PL/SQL', NULL, NULL, NULL, NULL, NULL, NULL, NULL);
            raise_application_error(-20101, 'Missing session id');
        END IF;

        IF NOT gBulkSubmission THEN
        ...
        BEGIN
             INSERT INTO temp_gui_jrnl_headers_unposted (
                  user_session_id, jhu_jrnl_id, jhu_jrnl_type, jhu_jrnl_date, jhu_jrnl_entity, jhu_jrnl_status,
                  ...
                  db_state, jhu_epg_id, jhu_jrnl_rev_date, jhu_department_id
             )
             SELECT   /* user_session_id */         session_id,
                      /* jhu_jrnl_id */           jhu_jrnl_id,
                      /* jhu_jrnl_type */           DECODE(overwrite_details,'Y',journal_type,jhu_jrnl_type),
                      /* jhu_jrnl_date */           DECODE(overwrite_details,'Y',effective_date,jhu_jrnl_date),
                      /* jhu_jrnl_entity */         DECODE(overwrite_details,'Y',entity,jhu_jrnl_entity),
                      /* jhu_jrnl_status */         jhu_jrnl_status,
                      /* jhu_jrnl_status_text */      jhu_jrnl_status_text,
                      /* jhu_jrnl_process_id */       jhu_jrnl_process_id,
                      /* jhu_jrnl_description */      DECODE(overwrite_details,'Y',description,jhu_jrnl_description),
                      /* jhu_jrnl_source */           DECODE(overwrite_details,'Y',source_system,jhu_jrnl_source),
                      /* jhu_jrnl_source_jrnl_id */   jhu_jrnl_source_jrnl_id,
                      /* jhu_jrnl_authorised_by */    jhu_jrnl_authorised_by,
                      /* jhu_jrnl_authorised_on */    jhu_jrnl_authorised_on,
                      /* jhu_jrnl_validated_by */     jhu_jrnl_validated_by,
                      /* jhu_jrnl_validated_on */     jhu_jrnl_validated_on,
                      /* jhu_jrnl_posted_by */      jhu_jrnl_posted_by,
                      /* jhu_jrnl_posted_on */      jhu_jrnl_posted_on,
                      /* jhu_jrnl_total_hash_debit */   jhu_jrnl_total_hash_debit,
                      /* jhu_jrnl_total_hash_credit */  jhu_jrnl_total_hash_credit,
                      /* jhu_jrnl_total_lines */    jhu_jrnl_total_lines,
                      /* jhu_created_by */          jhu_created_by,
                      /* jhu_created_on */          jhu_created_on,
                      /* jhu_amended_by */        DECODE(overwrite_details,'Y',updated_by,jhu_amended_by),
                      /* jhu_amended_on */        DECODE(overwrite_details,'Y',SYSDATE,jhu_amended_on),
                      /* jhu_jrnl_pref_static_src */  DECODE(overwrite_details,'Y',coding_convention,jhu_jrnl_pref_static_src),
                      /* db_state */            'U',
            /* jhu_epg_id */                  jhu_epg_id,
/* jhu_jrnl_rev_date */           DECODE(overwrite_details,'Y',reversing_date,jhu_jrnl_rev_date),
                      /* jhu_department_id */     jhu_department_id
             FROM   gui_jrnl_headers_unposted
             WHERE  jhu_jrnl_id = NVL(journal_id, '-1');
             ...
             IF lvJournalId IS NULL THEN
                     ...
                     VALUES (
                              ...
                              /* jhu_jrnl_id */           NVL(journal_id,'-1'),
                              /* jhu_jrnl_type */           journal_type,
                              /* jhu_jrnl_date */           effective_date,
                              /* jhu_jrnl_entity */         entity,
                              /* jhu_jrnl_status */         'M',
                              /* jhu_jrnl_status_text */      'MANUAL',
                              /* jhu_jrnl_process_id */       0,
                              /* jhu_jrnl_description */      description,
                              /* jhu_jrnl_source */           source_system,
                              /* jhu_jrnl_source_jrnl_id */   NULL,
                              /* jhu_jrnl_authorised_by */    NULL,
                              /* jhu_jrnl_authorised_on */    NULL,
                              /* jhu_jrnl_validated_by */     NULL,
                              /* jhu_jrnl_validated_on */     NULL,
                              /* jhu_jrnl_posted_by */      NULL,
                              /* jhu_jrnl_posted_on */      NULL,
                              /* jhu_jrnl_total_hash_debit */   0,
                              /* jhu_jrnl_total_hash_credit */  0,
                              /* jhu_jrnl_total_lines */    0,
                              /* jhu_created_by */          updated_by,
                              /* jhu_created_on */          SYSDATE,
                              /* jhu_amended_by */        updated_by,
                              /* jhu_amended_on */        SYSDATE,
                              /* jhu_jrnl_pref_static_src */  coding_convention,
                              /* db_state */            'I',
                /* jhu_epg_id */                  'NULL',
  /* jhu_jrnl_rev_date */           reversing_date,
                              /* jhu_department_id */      department_id
                        );
                END IF;

        EXCEPTION
            WHEN OTHERS THEN
                pr_error(1, SQLERRM, 0, 'prui_populate_header.1', 'gui_jrnl_headers_unposted', NULL, NULL, gPackageName, 'PL/SQL', NULL, NULL, NULL, NULL, NULL, NULL, NULL);
                RAISE;
        END;
      ...
      INSERT INTO temp_gui_jrnl_lines_unposted (
             ...
             SELECT   /* user_session_id */       session_id,
                      /* jlu_jrnl_hdr_id */         jlu_jrnl_hdr_id,
                      /* jlu_jrnl_line_number */    jlu_jrnl_line_number,
                      /* jlu_fak_id */          jlu_fak_id,
                      /* jlu_eba_id */          jlu_eba_id,
                      /* jlu_jrnl_status */       jlu_jrnl_status,
                      /* jlu_jrnl_status_text */    jlu_jrnl_status_text,
                      ...
                      /* jlu_effective_date */      jlu_effective_date,
                      /* jlu_value_date */        jlu_value_date,
                      /* jlu_entity */          DECODE(overwrite_details,'Y',entity,jlu_entity),
                      /* jlu_account */         jlu_account,
                      /* jlu_segment_1 */       jlu_segment_1,
                      /* jlu_segment_2 */       jlu_segment_2,
                      /* jlu_segment_3 */       jlu_segment_3,
                      ...
                      /* jlu_base_amount */       jlu_base_amount,
                      /* jlu_local_rate */        jlu_local_rate,
                      /* jlu_local_ccy */       jlu_local_ccy,
                      /* jlu_local_amount */      jlu_local_amount,
                      /* jlu_created_by */        jlu_created_by,
                      /* jlu_created_on */        jlu_created_on,
                      /* jlu_amended_by */        jlu_amended_by,
                      /* jlu_amended_on */        jlu_amended_on,
                      /* db_state */            'X',
            /* jlu_epg_id */                  jlu_epg_id,
                      /*jlu_period_month */             jlu_period_month,
                      /* jlu_period_year */             jlu_period_year,
        ...
        EXCEPTION
            WHEN NO_DATA_FOUND THEN
                NULL; -- do nothing
            WHEN OTHERS THEN
                pr_error(1, SQLERRM, 0, 'prui_populate_header.2', 'gui_jrnl_headers_unposted', NULL, NULL, gPackageName, 'PL/SQL', NULL, NULL, NULL, NULL, NULL, NULL, NULL);
                RAISE;
        END;
        ...
        EXCEPTION
            WHEN OTHERS THEN
                pr_error(1, SQLERRM, 0, 'prui_populate_header', 'gui_jrnl_headers_unposted', NULL, NULL, gPackageName, 'PL/SQL', NULL, NULL, NULL, NULL, NULL, NULL, NULL);
                RAISE;
        END;
    ...
    BEGIN
        ...
        IF gSessionId IS NULL THEN
            pr_error(1, SQLERRM, 0, 'prui_populate_line', 'temp_gui_jrnl_lines_unposted', NULL, NULL, gPackageName, 'PL/SQL', NULL, NULL, NULL, NULL, NULL, NULL, NULL);
            raise_application_error(-9001, 'Missing session id');
        END IF;
        ...
        BEGIN
             ...
             EXCEPTION
                WHEN NO_DATA_FOUND THEN
                     lvJournalLine := NULL;
                WHEN OTHERS THEN
                     pr_error(1, SQLERRM, 0, 'prui_populate_line', 'gui_jrnl_lines_unposted', NULL, NULL, gPackageName, 'PL/SQL', NULL, NULL, NULL, NULL, NULL, NULL, NULL);
                     RAISE;
             END;

             --Check the it exists
             IF lvJournalLine IS NOT NULL THEN

                 UPDATE temp_gui_jrnl_lines_unposted
                 SET	jlu_jrnl_status				= 'M',
                        jlu_description				= DECODE(overwrite_details,'Y',description,jlu_description),
                        jlu_effective_date			= DECODE(overwrite_details,'Y',effective_date,jlu_effective_date),
                        jlu_value_date				= DECODE(overwrite_details,'Y',value_date,jlu_value_date),
                        jlu_entity					= DECODE(overwrite_details,'Y',entity,jlu_entity),
                        jlu_account					= DECODE(overwrite_details,'Y',account,jlu_account),
                        jlu_segment_1				= NVL(DECODE(overwrite_details,'Y',segment_1,jlu_segment_1),'NVS'),
                        jlu_segment_2				= NVL(DECODE(overwrite_details,'Y',segment_2,jlu_segment_2),'NVS'),
                        jlu_segment_3				= NVL(DECODE(overwrite_details,'Y',segment_3,jlu_segment_3),'NVS'),
                        jlu_segment_4				= NVL(DECODE(overwrite_details,'Y',segment_4,jlu_segment_4),'NVS'),
                        jlu_segment_5				= NVL(DECODE(overwrite_details,'Y',segment_5,jlu_segment_5),'NVS'),
                        jlu_segment_6				= NVL(DECODE(overwrite_details,'Y',segment_6,jlu_segment_6),'NVS'),
                        jlu_segment_7				= NVL(DECODE(overwrite_details,'Y',segment_7,jlu_segment_7),'NVS'),
                        jlu_segment_8				= NVL(DECODE(overwrite_details,'Y',segment_8,jlu_segment_8),'NVS'),
                        jlu_segment_9				= NVL(DECODE(overwrite_details,'Y',segment_9,jlu_segment_9),'NVS'),
                        jlu_segment_10				= NVL(DECODE(overwrite_details,'Y',segment_10,jlu_segment_10),'NVS'),
                        jlu_attribute_1				= NVL(DECODE(overwrite_details,'Y',attribute_1,jlu_attribute_1),'NVS'),
                        jlu_attribute_2				= NVL(DECODE(overwrite_details,'Y',attribute_2,jlu_attribute_2),'NVS'),
                        jlu_attribute_3				= NVL(DECODE(overwrite_details,'Y',attribute_3,jlu_attribute_3),'NVS'),
                        jlu_attribute_4				= NVL(DECODE(overwrite_details,'Y',attribute_4,jlu_attribute_4),'NVS'),
                        jlu_attribute_5				= NVL(DECODE(overwrite_details,'Y',attribute_5,jlu_attribute_5),'NVS'),
                        jlu_reference_1				= NVL(DECODE(overwrite_details,'Y',reference_1,jlu_reference_1),'NVS'),
                        jlu_reference_2				= NVL(DECODE(overwrite_details,'Y',reference_2,jlu_reference_2),'NVS'),
                        jlu_reference_3				= NVL(DECODE(overwrite_details,'Y',reference_3,jlu_reference_3),'NVS'),
                        jlu_reference_4				= NVL(DECODE(overwrite_details,'Y',reference_4,jlu_reference_4),'NVS'),
                        jlu_reference_5				= NVL(DECODE(overwrite_details,'Y',reference_5,jlu_reference_5),'NVS'),
                        jlu_reference_6				= NVL(DECODE(overwrite_details,'Y',reference_6,jlu_reference_6),'NVS'),
                        jlu_reference_7				= NVL(DECODE(overwrite_details,'Y',reference_7,jlu_reference_7),'NVS'),
                        jlu_reference_8				= NVL(DECODE(overwrite_details,'Y',reference_8,jlu_reference_8),'NVS'),
                        jlu_reference_9				= NVL(DECODE(overwrite_details,'Y',reference_9,jlu_reference_9),'NVS'),
                        jlu_reference_10			= NVL(DECODE(overwrite_details,'Y',reference_10,jlu_reference_10),'NVS'),
                        jlu_tran_ccy				= DECODE(overwrite_details,'Y',tran_currency,jlu_tran_ccy),
                        jlu_tran_amount				= DECODE(overwrite_details,'Y',tran_amount,jlu_tran_amount),
                        jlu_base_rate				= DECODE(overwrite_details,'Y',base_rate,jlu_base_rate),
                        jlu_base_ccy				= DECODE(overwrite_details,'Y',base_currency,jlu_base_ccy),
                        jlu_base_amount				= DECODE(overwrite_details,'Y',DECODE(NVL(base_amount,0),0,NULL,base_amount),DECODE(NVL(jlu_base_amount,0),0,NULL,jlu_base_amount)),
                        jlu_local_rate				= DECODE(overwrite_details,'Y',local_rate,jlu_local_rate),
                        Jlu_local_ccy				= DECODE(overwrite_details,'Y',local_currency,jlu_local_ccy),
                        jlu_local_amount			= DECODE(overwrite_details,'Y',DECODE(NVL(local_amount,0),0,NULL,local_amount),DECODE(NVL(jlu_local_amount,0),0,NULL,jlu_local_amount)),
                        jlu_amended_by				= DECODE(overwrite_details,'Y',updated_by,jlu_amended_by),
                        jlu_amended_on				= DECODE(overwrite_details,'Y',SYSDATE,jlu_amended_on),
                        db_state					= 'U',
						jlu_epg_id      			= DECODE(overwrite_details,'Y','NULL',jlu_epg_id),
						jlu_period_month			= 0,
						jlu_period_year				= 0,
						jlu_period_ltd				= 0
                 WHERE	jlu_jrnl_hdr_id	= journal_id
                 ...
                 AND	user_session_id = session_id
                 RETURNING jlu_jrnl_line_number INTO gJournalLineNumber;
             ...
             ELSE
                 ...
                 INSERT INTO temp_gui_jrnl_lines_unposted (
                     ...
                     VALUES (
                              /* user_session_id */       session_id,
                              /* jlu_jrnl_hdr_id */         NVL(journal_id,'-1'),
                              /* jlu_jrnl_line_number */    DECODE(NVL(line_number,-1),
                                                                            -1, NVL((SELECT MAX(jlu_jrnl_line_number)+1
                                                                                 FROM temp_gui_jrnl_lines_unposted
                                                                                 WHERE jlu_jrnl_hdr_id = NVL(journal_id,-1)
                                                                                 AND   user_session_id = gSessionId),1),
                                                                            line_number),
                              /* jlu_fak_id	*/					NULL,
                              /* jlu_eba_id	*/					NULL,
                              /* jlu_jrnl_status */ 			'M',
                              /* jlu_jrnl_status_text */ 		'MANUAL',
                              /* jlu_jrnl_process_id */ 		0,
                              /* jlu_description */				description,
                              /* jlu_source_jrnl_id */			NVL(journal_id,'-1'),
                              /* jlu_effective_date */			effective_date,
                              /* jlu_value_date */				value_date,
                              /* jlu_entity */					entity,
                              /* jlu_account */					account,
                              /* jlu_segment_1 */				NVL(segment_1,'NVS'),
                              /* jlu_segment_2 */				NVL(segment_2,'NVS'),
                              /* jlu_segment_3 */				NVL(segment_3,'NVS'),
                              /* jlu_segment_4 */				NVL(segment_4,'NVS'),
                              /* jlu_segment_5 */				NVL(segment_5,'NVS'),
                              /* jlu_segment_6 */				NVL(segment_6,'NVS'),
                              /* jlu_segment_7 */				NVL(segment_7,'NVS'),
                              /* jlu_segment_8 */				NVL(segment_8,'NVS'),
                              /* jlu_segment_9 */				NVL(segment_9,'NVS'),
                              /* jlu_segment_10 */				NVL(segment_10,'NVS'),
                              /* jlu_attribute_1 */				NVL(attribute_1,'NVS'),
                              /* jlu_attribute_2 */				NVL(attribute_2,'NVS'),
                              /* jlu_attribute_3 */ 			NVL(attribute_3,'NVS'),
                              /* jlu_attribute_4 */				NVL(attribute_4,'MANUAL_ADJ'), -- AG Custom 
                              /* jlu_attribute_5 */				NVL(attribute_5,'NVS'),
                              /* jlu_reference_1 */				NVL(reference_1,'NVS'),
                              /* jlu_reference_2 */				NVL(reference_2,'NVS'),
                              /* jlu_reference_3 */				NVL(reference_3,'NVS'),
                              /* jlu_reference_4 */				NVL(reference_4,'NVS'),
                              /* jlu_reference_5 */				NVL(reference_5,'NVS'),
                              /* jlu_reference_6 */				NVL(reference_6,'NVS'),
                              /* jlu_reference_7 */				NVL(reference_7,'NVS'),
                              /* jlu_reference_8 */				NVL(reference_8,'NVS'),
                              /* jlu_reference_9 */				NVL(reference_9,'NVS'),
                              /* jlu_reference_10 */			NVL(reference_10,'NVS'),
                              /* jlu_tran_ccy */				tran_currency,
                              /* jlu_tran_amount */				tran_amount,
                              /* jlu_base_rate */				NULL,
                              /* jlu_base_ccy */				DECODE(NVL(base_amount,0),0,NULL,base_currency),
                              /* jlu_base_amount */				DECODE(NVL(base_amount,0),0,NULL,base_amount),
                              /* jlu_local_rate */				NULL,
                              /* jlu_local_ccy */				DECODE(NVL(local_amount,0),0,NULL,local_currency),
                              /* jlu_local_amount */			DECODE(NVL(local_amount,0),0,NULL,local_amount),
                              /* jlu_created_by */				updated_by,
                              /* jlu_created_on */				SYSDATE,
                              /* jlu_amended_by */				updated_by,
                              /* jlu_amended_on */				SYSDATE,
    ...
    IS
        fdr_code VARCHAR2(100);
        sql_stmnt VARCHAR2(500);

    BEGIN

        sql_stmnt := 'SELECT DISTINCT fdr_code FROM vw_ui_' || field_name || ' WHERE source_system_id = '''|| src_sys_id || ''' AND lookup_key ='''|| src_code ||'''';
    ...
    EXCEPTION
            ...
            WHEN TOO_MANY_ROWS THEN
                --log the error
                pr_error(1, 'More than one FDR Code found in view uiv_' || field_name || ' for source_system_id = '''|| src_sys_id || ''' and lookup_key ='''|| src_code ||'''', 0, 'fnui_source_to_fdr', 'uiv_' || field_name, NULL, NULL, gPackageName, 'PL/SQL', NULL, NULL, NULL, NULL, src_sys_id, src_code, NULL);
                RETURN src_code;
            WHEN OTHERS THEN
                ...
                ELSE
                    --log the error
                    pr_error(1, SQLERRM, 0, 'fnui_source_to_fdr', 'uiv_' || field_name, NULL, NULL, gPackageName, 'PL/SQL', NULL, NULL, NULL, NULL, src_sys_id, src_code, NULL);
                    RETURN fdr_code;
                END IF;
    ...
    IS
        src_code VARCHAR2(100);
        sql_stmnt VARCHAR2(500);

    BEGIN

        -- This is probably a customization.  Prod had comment that it was customized but base AAH product was the same.statement
    ...
    EXCEPTION
            ...
            WHEN TOO_MANY_ROWS THEN
                --log the error
                pr_error(1, 'More than One Source Code found in view vw_ui_' || field_name || ' for source_system_id = '''|| src_sys_id || ''' and fdr_id ='''|| fdr_code ||'''', 0, 'fnui_fdr_to_source', 'vw_ui_' || field_name, NULL, NULL, gPackageName, 'PL/SQL', NULL, NULL, NULL, NULL, src_sys_id, fdr_code, NULL);
                RETURN fdr_code;
            WHEN OTHERS THEN
                -- Don't create log entry for 'Table or view not found' error...
                IF sqlcode = -942 THEN
                ...
                ELSE
                    --log the error
                    pr_error(1, SQLERRM, 0, 'fnui_fdr_to_source', 'vw_ui_' || field_name, NULL, NULL, gPackageName, 'PL/SQL', NULL, NULL, NULL, NULL, src_sys_id, fdr_code, NULL);
                    RETURN fdr_code;
                END IF;
    ...
    BEGIN
        ...
        sql_stmnt := 'SELECT DISTINCT lookup_value FROM vw_ui_'||field_name||'_rel_value WHERE fdr_code = '''||fdr_code||''' ';
    ...
    EXCEPTION
            ...
            WHEN TOO_MANY_ROWS THEN
                --log the error
                pr_error(1, 'More than one related value FOUND IN VIEW vw_ui_' || field_name || '_rel_value FOR fdr_code ='''|| fdr_code ||'''', 0, 'fnui_fdr_related_value', 'vw_ui_' || field_name, NULL, NULL, gPackageName, 'PL/SQL', NULL, NULL, NULL, NULL, NULL, fdr_code, NULL);
                RETURN NULL;
            WHEN OTHERS THEN
                -- Don't create log entry for 'Table or view not found' error...
                IF sqlcode = -942 THEN
                ...
                ELSE
                    --log the error
                    pr_error(1, SQLERRM, 0, 'fnui_fdr_related_value', 'vw_ui_' || field_name || '_rel_value', NULL, NULL, gPackageName, 'PL/SQL', NULL, NULL, NULL, NULL, NULL, fdr_code, NULL);
                    RETURN NULL;
                END IF;
    ...
    BEGIN
        ...
        sql_stmnt := 'SELECT DISTINCT fdr_description FROM vw_ui_' || field_name || ' WHERE source_system_id = ''Client Static'' and fdr_code = '''|| fdr_code || '''';
    ...
    EXCEPTION
            ...
            WHEN TOO_MANY_ROWS THEN
                --log the error
                pr_error(1, 'More than one FDR Description FOUND IN VIEW vw_ui_' || field_name || ' FOR fdr_code ='''|| fdr_code ||'''', 0, 'fnui_fdr_desc', 'vw_ui_' || field_name, NULL, NULL, gPackageName, 'PL/SQL', NULL, NULL, NULL, NULL, NULL, fdr_code, NULL);
                RETURN NULL;
            WHEN OTHERS THEN
                -- Don't create log entry for 'Table or view not found' error...
                IF sqlcode = -942 THEN
                ...
                ELSE
                    --log the error
                    pr_error(1, SQLERRM, 0, 'fnui_fdr_desc', 'vw_ui_' || field_name, NULL, NULL, gPackageName, 'PL/SQL', NULL, NULL, NULL, NULL, NULL, fdr_code, NULL);
                    RETURN NULL;
                END IF;
    ...
    lvID SLR_JRNL_HEADERS_UNPOSTED.JHU_JRNL_ID%TYPE;
    ...
    BEGIN
        ...
        INSERT INTO slr_jrnl_headers_unposted (
            ...
            jhu_jrnl_total_hash_debit, jhu_jrnl_total_hash_credit, jhu_jrnl_total_lines,
            jhu_created_by, jhu_created_on, jhu_amended_by, jhu_amended_on, jhu_jrnl_pref_static_src,
            jhu_manual_flag, jhu_epg_id, jhu_department_id
        )
        SELECT /* jhu_jrnl_id */                 lvId,
               /* jhu_jrnl_type */               jhu_jrnl_type,
               /* jhu_jrnl_date */               reversing_date,
               /* jhu_jrnl_entity */             jhu_jrnl_entity,
               /* jhu_jrnl_status */             'W',
               /* jhu_jrnl_status_text */        'Unposted',
               /* jhu_jrnl_process_id */         0,
               /* jhu_jrnl_description */        jhu_jrnl_description,
               /* jhu_jrnl_source */             jhu_jrnl_source,
               /* jhu_jrnl_source_jrnl_id */     jhu_jrnl_id,
               /* jhu_jrnl_authorised_by */      jhu_jrnl_authorised_by,
               /* jhu_jrnl_authorised_on */      jhu_jrnl_authorised_on,
               /* jhu_jrnl_validated_by */       jhu_jrnl_validated_by,
               /* jhu_jrnl_validated_on */       jhu_jrnl_validated_on,
               /* jhu_jrnl_posted_by */          jhu_jrnl_posted_by,
               /* jhu_jrnl_posted_on */          jhu_jrnl_posted_on,
               /* jhu_jrnl_total_hash_debit */   jhu_jrnl_total_hash_credit,
               /* jhu_jrnl_total_hash_credit */  jhu_jrnl_total_hash_debit,
               /* jhu_jrnl_total_lines */        jhu_jrnl_total_lines,
               /* jhu_created_by */              gJournalHeader.jhu_amended_by,
               /* jhu_created_on */              SYSDATE,
               /* jhu_amended_by */              gJournalHeader.jhu_amended_by,
               /* jhu_amended_on */              SYSDATE,
               /* jhu_jrnl_pref_static_src */    jhu_jrnl_pref_static_src,
               /* jhu_manual_flag */             'Y',
         /* jhu_epg_id */       jhu_epg_id,
               /* jhu_department_id */           jhu_department_id
        FROM slr_jrnl_headers_unposted
        WHERE jhu_jrnl_source_jrnl_id = to_char(orignal_jrnl_id);

        IF entity_proc_group IS NOT NULL AND status IS NOT NULL THEN
            ...
            SELECT /* jlu_jrnl_hdr_id */       lvId,
                /* jlu_jrnl_line_number */  jlu_jrnl_line_number,
                /* jlu_fak_id */         jlu_fak_id,
                /* jlu_eba_id */         jlu_eba_id,
                /* jlu_jrnl_status */       'W',
                /* jlu_jrnl_status_text */  'Unposted',
                /* jlu_jrnl_process_id */   0,
                /* jlu_description */       jlu_description,
                /* jlu_source_jrnl_id */    jlu_jrnl_hdr_id,
                /* jlu_effective_date */    reversing_date,
                /* jlu_value_date */        jlu_value_date,
                /* jlu_entity */            jlu_entity,
                /* jlu_account */           jlu_account,
                /* jlu_segment_1 */         NVL(jlu_segment_1,'NVS'),
                /* jlu_segment_2 */         NVL(jlu_segment_2,'NVS'),
                /* jlu_segment_3 */         NVL(jlu_segment_3,'NVS'),
                /* jlu_segment_4 */         NVL(jlu_segment_4,'NVS'),
                /* jlu_segment_5 */         NVL(jlu_segment_5,'NVS'),
                /* jlu_segment_6 */         NVL(jlu_segment_6,'NVS'),
                /* jlu_segment_7 */         NVL(jlu_segment_7,'NVS'),
                /* jlu_segment_8 */         NVL(jlu_segment_8,'NVS'),
                /* jlu_segment_9 */         NVL(jlu_segment_9,'NVS'),
                /* jlu_segment_10 */        NVL(jlu_segment_10,'NVS'),
                /* jlu_attribute_1 */       NVL(jlu_attribute_1,'NVS'),
                /* jlu_attribute_2 */       NVL(jlu_attribute_2,'NVS'),
                /* jlu_attribute_3 */       NVL(jlu_attribute_3,'NVS'),
                /* jlu_attribute_4 */       NVL(jlu_attribute_4,'MANUAL_ADJ'),  -- AG Custom                
                /* jlu_attribute_5 */       NVL(jlu_attribute_5,'NVS'),
                /* jlu_reference_1 */       jlu_reference_1,
                /* jlu_reference_2 */       jlu_reference_2,
                /* jlu_reference_3 */       jlu_reference_3,
                /* jlu_reference_4 */       jlu_reference_4,
                ...
                /* jlu_local_ccy */         jlu_local_ccy,
                /* jlu_local_amount */      -jlu_local_amount,
                /* jlu_created_by */        gJournalHeader.jhu_amended_by,
                /* jlu_created_on */        SYSDATE,
                /* jlu_amended_by */        gJournalHeader.jhu_amended_by,
                /* jlu_amended_on */        SYSDATE,
                /* jlu_epg_id */            jlu_epg_id,
                /* jlu_period_month */        0,
                /* jlu_period_year */       0,
                ...
                WHERE jlu_jrnl_hdr_id = to_char(orignal_jrnl_id)
        ...
        ELSE    /*TODO: Not sure when this can be executed.
                ...
                */
                ...
                SELECT /* jlu_jrnl_hdr_id */       lvId,
                    ...
                    /* jlu_period_ltd */        0
                    FROM slr_jrnl_lines_unposted
                    WHERE jlu_jrnl_source_jrnl_id = orignal_jrnl_id;
            END IF;
    ...
    EXCEPTION
        WHEN OTHERS THEN
            ...
            prui_log_error(orignal_jrnl_id, 0, 1030,
                           'Failed to create reversing journal for '||reversing_date||'.');

            pr_error(1, SQLERRM, 0, 'fnui_create_reversing_journal', 'slr_jrnl_headers_unposted/slr_jrnl_lines_unposted', NULL, NULL, gPackageName, 'PL/SQL', NULL, NULL, NULL, NULL, NULL, NULL, NULL);
            RETURN FALSE;
    ...
    EXCEPTION
        WHEN OTHERS THEN
             pr_error(1, SQLERRM, 0, 'fnui_create_copy_journal', 'slr_jrnl_headers_unposted/slr_jrnl_lines_unposted', NULL, NULL, gPackageName, 'PL/SQL', NULL, NULL, NULL, NULL, NULL, NULL, NULL);
             RETURN FALSE;
    ...
    BEGIN
        ...
        IF sync_temp = TRUE THEN
			...
			EXCEPTION
				WHEN OTHERS THEN
					 pr_error(1, SQLERRM, 0, 'fnui_resync_journal_lines.2', 'gui_jrnl_headers_unposted', NULL, NULL, gPackageName, 'PL/SQL', NULL, NULL, NULL, NULL, NULL, NULL, NULL);
					 RETURN FALSE;
			END;
		ELSE
			if gJournalHeader.jhu_jrnl_id <> '-1' then
			  ...
			  EXCEPTION
				  WHEN OTHERS THEN
					  ...
					  pr_error(1, SQLERRM, 0, 'fnui_resync_journal_lines.1', 'gui_jrnl_headers_unposted', NULL, NULL, gPackageName, 'PL/SQL', NULL, NULL, NULL, NULL, NULL, NULL, NULL);
					  RETURN FALSE;
			  END;
			end if;
		END IF;
    ...
    BEGIN
        ...
        BEGIN
            SELECT COUNT(*) AS total_lines,
                   SUM(DECODE(SIGN(jlu_tran_amount),-1,jlu_tran_amount,0)) AS total_hash_credit,
                   SUM(DECODE(SIGN(jlu_tran_amount),1,jlu_tran_amount,0)) AS total_hash_debit,
        ...
        EXCEPTION
            WHEN OTHERS THEN
                 pr_error(1, SQLERRM, 0, 'fnui_merge_header.1', 'gui_jrnl_headers_unposted', NULL, NULL, gPackageName, 'PL/SQL', NULL, NULL, NULL, NULL, NULL, NULL, NULL);
                 RETURN FALSE;
        END;
        ...
        EXCEPTION
            WHEN OTHERS THEN
                 pr_error(1, SQLERRM, 0, 'fnui_merge_header.2', 'gui_jrnl_headers_unposted', NULL, NULL, gPackageName, 'PL/SQL', NULL, NULL, NULL, NULL, NULL, NULL, NULL);
                 RETURN FALSE;
        END;
        ...
        BEGIN
            ...
            IF NOT fnui_does_journal_exist(gJournalHeader.jhu_jrnl_id) THEN
                 ...
                 INSERT INTO gui_jrnl_headers_unposted (
                      ...
                      jhu_jrnl_total_hash_debit, jhu_jrnl_total_hash_credit, jhu_jrnl_total_lines,
                      jhu_created_by, jhu_created_on, jhu_amended_by, jhu_amended_on, jhu_jrnl_pref_static_src,
                      jhu_manual_flag, jhu_epg_id, jhu_version,jhu_jrnl_rev_date, jhu_department_id
                 )
                 SELECT
                        /* jhu_jrnl_id */             lvId,
                        /* jhu_jrnl_type */           tsjhu.jhu_jrnl_type,
                        /* jhu_jrnl_date */           tsjhu.jhu_jrnl_date,
                        /* jhu_jrnl_entity */           tsjhu.jhu_jrnl_entity,
                        /* jhu_jrnl_status */           'M',
                        /* jhu_jrnl_status_text */      'MANUAL',
                        /* jhu_jrnl_process_id */       tsjhu.jhu_jrnl_process_id,
                        /* jhu_jrnl_description */      tsjhu.jhu_jrnl_description,
                        /* jhu_jrnl_source */           tsjhu.jhu_jrnl_source,
                        /* jhu_jrnl_source_jrnl_id */     lvId,
                        /* jhu_jrnl_authorised_by */    tsjhu.jhu_jrnl_authorised_by,
                        /* jhu_jrnl_authorised_on */    tsjhu.jhu_jrnl_authorised_on,
                        /* jhu_jrnl_validated_by */     tsjhu.jhu_jrnl_validated_by,
                        /* jhu_jrnl_validated_on */     tsjhu.jhu_jrnl_validated_on,
                        /* jhu_jrnl_posted_by */      tsjhu.jhu_jrnl_posted_by,
                        /* jhu_jrnl_posted_on */      tsjhu.jhu_jrnl_posted_on,
                        /* jhu_jrnl_total_hash_debit */   NVL(tsjhu.jhu_jrnl_total_hash_debit,0),
                        /* jhu_jrnl_total_hash_credit */  NVL(tsjhu.jhu_jrnl_total_hash_credit,0),
                        /* jhu_jrnl_total_lines */      NVL(tsjhu.jhu_jrnl_total_lines,0),
                        /* jhu_created_by */          tsjhu.jhu_created_by,
                        /* jhu_created_on */          tsjhu.jhu_created_on,
                        /* jhu_amended_by */        tsjhu.jhu_amended_by,
                        /* jhu_amended_on */        tsjhu.jhu_amended_on,
                        /* jhu_jrnl_pref_static_src */    tsjhu.jhu_jrnl_pref_static_src,
                        /* jhu_manual_flag */              'Y',
                        /* jhu_epg_id */              tsjhu.jhu_epg_id,
                        /* jhu_version */             1,
            /* jhu_jrnl_rev_date */             tsjhu.jhu_jrnl_rev_date,
                        /* jhu_department_id */     tsjhu.jhu_department_id
            ...
            ELSE
                ...
                UPDATE gui_jrnl_headers_unposted sjhu
                  SET   (jhu_jrnl_type, jhu_jrnl_date, jhu_jrnl_entity, jhu_jrnl_status,
                         jhu_jrnl_description, jhu_jrnl_source, jhu_jrnl_total_hash_debit,
                         jhu_jrnl_total_hash_credit, jhu_jrnl_total_lines,
                         jhu_amended_by, jhu_amended_on, jhu_epg_id, jhu_version, jhu_jrnl_rev_date) =
        ...
        EXCEPTION
            WHEN OTHERS THEN
                 pr_error(1, SQLERRM, 0, 'fnui_merge_header.5', 'gui_jrnl_headers_unposted', NULL, NULL, gPackageName, 'PL/SQL', NULL, NULL, NULL, NULL, NULL, NULL, NULL);
                 RETURN FALSE;
        END;
    ...
    EXCEPTION
        WHEN OTHERS THEN
             pr_error(1, SQLERRM, 0, 'fnui_merge_header', 'gui_jrnl_headers_unposted', NULL, NULL, gPackageName, 'PL/SQL', NULL, NULL, NULL, NULL, NULL, NULL, NULL);
             RETURN FALSE;
    ...
    BEGIN
        ...
        BEGIN
            UPDATE gui_jrnl_lines_unposted sjlu
              SET  (jlu_fak_id, jlu_eba_id, jlu_jrnl_status, jlu_jrnl_status_text, jlu_jrnl_process_id,
                    jlu_description, jlu_source_jrnl_id, jlu_effective_date, jlu_value_date, jlu_entity,
                    jlu_account, jlu_segment_1, jlu_segment_2, jlu_segment_3, jlu_segment_4, jlu_segment_5,
                    jlu_segment_6, jlu_segment_7, jlu_segment_8, jlu_segment_9, jlu_segment_10, jlu_attribute_1,
                    jlu_attribute_2, jlu_attribute_3, jlu_attribute_4, jlu_attribute_5, jlu_reference_1, jlu_reference_2,
                    jlu_reference_3, jlu_reference_4, jlu_reference_5, jlu_reference_6, jlu_reference_7, jlu_reference_8,
                    jlu_reference_9, jlu_reference_10, jlu_tran_ccy, jlu_tran_amount, jlu_base_rate, jlu_base_ccy, jlu_base_amount,
                    jlu_local_rate, jlu_local_ccy, jlu_local_amount, jlu_created_by, jlu_created_on, jlu_amended_by, jlu_amended_on,
          jlu_epg_id, jlu_period_month, jlu_period_year, jlu_period_ltd) =
               ...
               nvl(tsjlu.jlu_period_ltd,0)
                    ...
                    AND sjlu.jlu_jrnl_line_number = tsjlu.jlu_jrnl_line_number
                    AND tsjlu.user_session_id = gSessionId)
        ...
        EXCEPTION
            WHEN NO_DATA_FOUND THEN
                 NULL; -- do nothing
            WHEN OTHERS THEN
                 pr_error(1, SQLERRM, 0, 'fnui_merge_lines.1', 'gui_jrnl_lines_unposted', NULL, NULL, gPackageName, 'PL/SQL', NULL, NULL, NULL, NULL, NULL, NULL, NULL);
                 RETURN FALSE;
        END;

        -- Insert new rows
        BEGIN
            INSERT INTO gui_jrnl_lines_unposted (
                jlu_jrnl_hdr_id, jlu_jrnl_line_number, jlu_fak_id, jlu_eba_id, jlu_jrnl_status,
                jlu_jrnl_status_text, jlu_jrnl_process_id, jlu_description, jlu_source_jrnl_id,
                jlu_effective_date, jlu_value_date, jlu_entity, jlu_account, jlu_segment_1,
                jlu_segment_2, jlu_segment_3, jlu_segment_4, jlu_segment_5, jlu_segment_6,
            ...
            SELECT
                   /* jlu_jrnl_hdr_id */		gJournalHeader.jhu_jrnl_id,
                   /* jlu_jrnl_line_number */	tsjlu.jlu_jrnl_line_number,
                   /* jlu_fak_id */				0,
                   /* jlu_eba_id */				0,
                   /* jlu_jrnl_status */		'M',
                   /* jlu_jrnl_status_text */	'MANUAL',
                   /* jlu_jrnl_process_id */	tsjlu.jlu_jrnl_process_id,
                   /* jlu_description */		tsjlu.jlu_description,
                   /* jlu_source_jrnl_id */		gJournalHeader.jhu_jrnl_id,
                   /* jlu_effective_date */		tsjlu.jlu_effective_date,
                   /* jlu_value_date */			tsjlu.jlu_value_date,
                   /* jlu_entity */				tsjlu.jlu_entity,
                   /* jlu_account */			tsjlu.jlu_account,
                   /* jlu_segment_1 */			NVL(tsjlu.jlu_segment_1,'NVS'),
                   /* jlu_segment_2 */			NVL(tsjlu.jlu_segment_2,'NVS'),
                   /* jlu_segment_3 */			NVL(tsjlu.jlu_segment_3,'NVS'),
                   /* jlu_segment_4 */			NVL(tsjlu.jlu_segment_4,'NVS'),
                   /* jlu_segment_5 */			NVL(tsjlu.jlu_segment_5,'NVS'),
                   /* jlu_segment_6 */			NVL(tsjlu.jlu_segment_6,'NVS'),
                   /* jlu_segment_7 */ 			NVL(tsjlu.jlu_segment_7,'NVS'),
                   /* jlu_segment_8 */			NVL(tsjlu.jlu_segment_8,'NVS'),
                   /* jlu_segment_9 */			NVL(tsjlu.jlu_segment_9,'NVS'),
                   /* jlu_segment_10 */			NVL(tsjlu.jlu_segment_10,'NVS'),
                   /* jlu_attribute_1 */		NVL(tsjlu.jlu_attribute_1,'NVS'),
                   /* jlu_attribute_2 */		NVL(tsjlu.jlu_attribute_2,'NVS'),
                   /* jlu_attribute_3 */		NVL(tsjlu.jlu_attribute_3,'NVS'),
                   /* jlu_attribute_4 */		NVL(tsjlu.jlu_attribute_4,'MANUAL_ADJ'),
                   /* jlu_attribute_5 */		NVL(tsjlu.jlu_attribute_5,'NVS'),
                   /* jlu_reference_1 */		tsjlu.jlu_reference_1,
                   /* jlu_reference_2 */		tsjlu.jlu_reference_2,
                   /* jlu_reference_3 */		tsjlu.jlu_reference_3,
                   /* jlu_reference_4 */		tsjlu.jlu_reference_4,
                   /* jlu_reference_5 */		tsjlu.jlu_reference_5,
                   /* jlu_reference_6 */		tsjlu.jlu_reference_6,
                   /* jlu_reference_7 */		tsjlu.jlu_reference_7,
                   /* jlu_reference_8 */		tsjlu.jlu_reference_8,
                   /* jlu_reference_9 */		tsjlu.jlu_reference_9,
                   /* jlu_reference_10 */		tsjlu.jlu_reference_10,
                   /* jlu_tran_ccy */			tsjlu.jlu_tran_ccy,
                   /* jlu_tran_amount */		tsjlu.jlu_tran_amount,
                   /* jlu_base_rate */			tsjlu.jlu_base_rate,
                   /* jlu_base_ccy */			tsjlu.jlu_base_ccy,
                   /* jlu_base_amount */		tsjlu.jlu_base_amount,
                   /* jlu_local_rate */			tsjlu.jlu_local_rate,
                   /* jlu_local_ccy */			tsjlu.jlu_local_ccy,
                   /* jlu_local_amount */		tsjlu.jlu_local_amount,
                   /* jlu_created_by */			tsjlu.jlu_created_by,
                   /* jlu_created_on */			tsjlu.jlu_created_on,
                   /* jlu_amended_by */			tsjlu.jlu_amended_by,
                   /* jlu_amended_on */			tsjlu.jlu_amended_on,
				   /* jlu_epg_id */  			tsjlu.jlu_epg_id,
				   /* jlu_period_month */		nvl(tsjlu.jlu_period_month,0),
				   /* jlu_period_year */		nvl(tsjlu.jlu_period_year,0),
				   /* jlu_period_ltd */			nvl(tsjlu.jlu_period_ltd,0)
             FROM   temp_gui_jrnl_lines_unposted tsjlu
             WHERE  tsjlu.jlu_jrnl_hdr_id      = gJournalHeader.jhu_jrnl_id
             AND  tsjlu.user_session_id      = gSessionId
             AND  NOT EXISTS (SELECT 1
    ...
    EXCEPTION
        WHEN OTHERS THEN
             pr_error(1, SQLERRM, 0, 'fnui_merge_lines', 'gui_jrnl_lines_unposted', NULL, NULL, gPackageName, 'PL/SQL', NULL, NULL, NULL, NULL, NULL, NULL, NULL);
             RETURN FALSE;
    ...
    BEGIN
         ...
         EXCEPTION
            WHEN NO_DATA_FOUND THEN
                 NULL;
            WHEN OTHERS THEN
                 pr_error(1, SQLERRM, 0, 'fnui_get_reversing_journal', 'slr_jrnl_headers_unposted', NULL, NULL, gPackageName, 'PL/SQL', NULL, NULL, NULL, NULL, NULL, NULL, NULL);
                 RAISE;
         END;
     ...
     */
     ...
     lvSeq := FNSLR_GETHEADERID;
         ...
         SELECT STANDARD_HASH(lvSeq, 'MD5') INTO lvJournalId FROM dual;
         gJournalHeader.jhu_jrnl_id := lvJournalId;

         RETURN lvJournalId;

    EXCEPTION
         WHEN OTHERS THEN
              pr_error(1, SQLERRM, 0, 'fnui_get_next_journal_id', 'seq_slr_jrnl_headers_id', NULL, NULL, gPackageName, 'PL/SQL', NULL, NULL, NULL, NULL, NULL, NULL, NULL);
              RAISE;
    ...
    EXCEPTION
         WHEN NO_DATA_FOUND THEN
              ...
              RETURN lvSeq;
         WHEN OTHERS THEN
              pr_error(1, SQLERRM, 0, 'fnui_get_next_line_no', 'gui_jrnl_lines_unposted', NULL, NULL, gPackageName, 'PL/SQL', NULL, NULL, NULL, NULL, NULL, NULL, NULL);
              RETURN -1;
    ...
    EXCEPTION
        WHEN NO_DATA_FOUND THEN
            RETURN FALSE;
        WHEN OTHERS THEN
            pr_error(1, SQLERRM, 0, 'fnui_does_journal_exist', 'gui_jrnl_headers_unposted', NULL, NULL, gPackageName, 'PL/SQL', NULL, NULL, NULL, NULL, NULL, NULL, NULL);
            RETURN FALSE;
    ...
    EXCEPTION
        WHEN NO_DATA_FOUND THEN
            RETURN FALSE;
        WHEN OTHERS THEN
            pr_error(1, SQLERRM, 0, 'fnui_does_line_exist', 'gui_jrnl_lines_unposted', NULL, NULL, gPackageName, 'PL/SQL', NULL, NULL, NULL, NULL, NULL, NULL, NULL);
            RETURN FALSE;
    ...
    BEGIN
        ...
        LOOP
            ...
            IF SUBSTR(list_string, loop_count, 1) = '|' THEN
                ...
                IF loop_count < LENGTH(list_string)  THEN
                   array_count := array_count + 1;
                END IF;

            ELSIF loop_count = LENGTH(list_string) THEN
    ...
    EXCEPTION
        WHEN OTHERS THEN
            pr_error(1, SQLERRM, 0, 'fnui_process_param_list', NULL, NULL, NULL, gPackageName, 'PL/SQL', NULL, NULL, NULL, NULL, NULL, NULL, NULL);
    ...
    EXCEPTION
        WHEN OTHERS THEN
            pr_error(1, SQLERRM, 0, 'prui_update_header_stats', NULL, NULL, NULL, gPackageName, 'PL/SQL', NULL, NULL, NULL, NULL, NULL, NULL, NULL);
    ...
    IS
      ...
      CURSOR cur_journal_lines(jrnl_id VARCHAR2) IS
          SELECT jlu_jrnl_line_number
          FROM   gui_jrnl_lines_unposted
    ...
    EXCEPTION
        WHEN OTHERS THEN
            ...
            pr_error(1, SQLERRM, 0, 'prui_reorder_journal_lines', NULL, NULL, NULL, gPackageName, 'PL/SQL', NULL, NULL, NULL, NULL, NULL, NULL, NULL);
            RAISE;
    ...
    EXCEPTION
         WHEN NO_DATA_FOUND THEN
            pr_error(1, 'SLR calendar is not configured correctly for entity '||gEntityConfiguration.ent_entity, 0, 'fnui_check_calendar', 'slr_entity_days/slr_entity_periods', NULL, NULL, gPackageName, 'PL/SQL', NULL, NULL, NULL, NULL, NULL, NULL, NULL);
            prui_log_error(gJournalHeader.jhu_jrnl_id, 0, 1003, 'SLR calendar is not configured correctly for entity '||gEntityConfiguration.ent_entity);
            RETURN FALSE;
         WHEN OTHERS THEN
            pr_error(1, SQLERRM, 0, 'fnui_check_calendar', 'slr_entity_days', NULL, NULL, gPackageName, 'PL/SQL', NULL, NULL, NULL, NULL, NULL, NULL, NULL);
            RETURN FALSE;
    ...
    BEGIN
            ...
            FROM
             (SELECT ed_date,
                     MIN(ed_date) OVER (PARTITION BY ed_entity_set,TO_CHAR(ed_date, 'yyyy'),TO_CHAR(ed_date, 'mm') ORDER BY ed_date,ed_entity_set) as period_start_monthly,
                     MAX(ed_date) OVER (PARTITION BY ed_entity_set,TO_CHAR(ed_date, 'yyyy'),TO_CHAR(ed_date, 'mm') ORDER BY ed_date DESC,ed_entity_set) as period_end_monthly,
                     LAG(ed_date,1) OVER (PARTITION BY ed_entity_set ORDER BY ed_date,ed_entity_set) as prev_bus_date,
                     LEAD(ed_date,1) OVER (PARTITION BY ed_entity_set ORDER BY ed_date,ed_entity_set) as next_bus_date
              FROM  SLR_ENTITY_DAYS
              WHERE ed_entity_set = period_days_set
              AND ed_status   = 'O') days,
             (SELECT lag(EP_BUS_PERIOD_START) over (PARTITION BY ep_entity ORDER BY EP_BUS_YEAR,EP_BUS_PERIOD,ep_entity) as fist_day_of_prev_mon,
lead(EP_BUS_PERIOD_START) over (PARTITION BY ep_entity ORDER BY EP_BUS_YEAR,EP_BUS_PERIOD,ep_entity) as fist_day_of_next_mon,
                     lag(EP_BUS_PERIOD_END,1) over (PARTITION BY ep_entity ORDER BY EP_BUS_YEAR,EP_BUS_PERIOD,ep_entity) as last_day_of_prev_mon,
                     lead(EP_BUS_PERIOD_END,1) over (PARTITION BY ep_entity ORDER BY EP_BUS_YEAR,EP_BUS_PERIOD,ep_entity) as last_day_of_next_mon,
                     ep_cal_period_start period_start,
                     ep_cal_period_end period_end
              FROM  SLR_ENTITY_PERIODS
              WHERE ep_entity = entity
              AND   ep_period_type != 0) periods
    ...
    EXCEPTION
         WHEN NO_DATA_FOUND THEN
            pr_error(1, 'SLR calendar is not configured correctly for entity '||entity, 0, 'prui_get_calendar_details', 'slr_entity_days', NULL, NULL, gPackageName, 'PL/SQL', NULL, NULL, NULL, NULL, NULL, NULL, NULL);
            IF NVL(gJournalLineNumber,-1) < 1 THEN
                prui_log_error(gJournalHeader.jhu_jrnl_id, 0, 1003, 'SLR calendar is not configured correctly for entity '||entity);
            ELSE
                prui_log_error(gJournalHeader.jhu_jrnl_id, gJournalLineNumber, 1003, 'SLR calendar is not configured correctly for entity '||entity);
            END IF;
         WHEN OTHERS THEN
            pr_error(1, SQLERRM, 0, 'prui_get_calendar_details', 'slr_entity_days', NULL, NULL, gPackageName, 'PL/SQL', NULL, NULL, NULL, NULL, NULL, NULL, NULL);
  ...
  --********************************************************************************
   ...
   prui_process_param_list(list_string, journal_list, list_count);
    ...
    LOOP
       BEGIN
       UPDATE slr_jrnl_headers_unposted SET jhu_jrnl_status = status_to WHERE  jhu_jrnl_status = status_from and jhu_jrnl_id = journal_list(loop_count);

        EXCEPTION
           WHEN OTHERS THEN
            pr_error(1, SQLERRM, 0, 'prui_update_unprocessed_jrnls', 'slr_jrnl_headers_unposted', NULL, NULL, gPackageName, 'PL/SQL', NULL, NULL, NULL, NULL, NULL, NULL, NULL);
   ...
   BEGIN
       BEGIN
            UPDATE slr_jrnl_headers_unposted SET jhu_jrnl_status = status WHERE jhu_jrnl_id = journal_id;

            COMMIT;
        EXCEPTION
           WHEN OTHERS THEN
            ROLLBACK;
            pr_error(1, SQLERRM, 0, 'prui_removed_failed_jrnls', 'slr_jrnl_headers_unposted', NULL, NULL, gPackageName, 'PL/SQL', NULL, NULL, NULL, NULL, NULL, NULL, NULL);
       END;
  ...
  AS
    s_proc_name                 VARCHAR2(80) := 'PGUI_MANUAL_JOURNAL.fGetEntityProcGroup';
    ...
    BEGIN
      ...
      EXCEPTION
          WHEN NO_DATA_FOUND THEN
            null;
          WHEN OTHERS THEN
            fdr.pr_error(1, NULL, 0, 'fnui_validate_jrnl_type.1', 'temp_gui_jrnl_headers_unposted', NULL, NULL, NULL, 'PL/SQL', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, SQLCODE);
            lvSuccess := FALSE;
      ...
      EXCEPTION
        WHEN OTHERS THEN
          pr_error(1, SQLERRM, 0, 'fnui_validate_jrnl_type', 'temp_gui_jrnl_headers_unposted', NULL, NULL, gPackageName, 'PL/SQL', NULL, NULL, NULL, NULL, NULL, NULL, NULL);
          RETURN FALSE;
      ...
      CASE
        ...
        THEN 0 ELSE
          case when SFTC_base.FTC_FX_MODE = 'Step-by-Step' then
            CASE WHEN jlu_local_amount IS NULL OR LENGTH(ABS(trunc(ROUND(jlu_base_amount/jlu_local_amount, 9)))) > 9
            THEN 0
  ...
  PROCEDURE prui_upsert_attachment(
    ...
    EXCEPTION
        WHEN OTHERS THEN
             pr_error(1, SQLERRM, 0, 'prui_upsert_attachment', 'gui_jrnl_file', NULL, NULL, gPackageName, 'PL/SQL', NULL, NULL, NULL, NULL, NULL, NULL, NULL);
    ...
    begin
      ...
      FOR jrnl_file_cursor IN (
         ...
         ROW_NUMBER() OVER(PARTITION BY jf_jrnl_hdr_id ORDER BY jf_file_no) AS new_no
         FROM gui_jrnl_file
         WHERE jf_jrnl_hdr_id = journal_id
         order by jf_file_no
      )
    ...
    is
    BEGIN
      DELETE FROM GUI_JRNL_EDIT_LOCK WHERE JEL_JRNL_HDR_ID = journal_id and JEL_LOCKED_BY = locked_by;
      COMMIT;
    ...
    IS
      ...
      vSql VARCHAR2(32000);
      vProcessId CONSTANT NUMBER := SLR_UTILITIES_PKG.fSLR_SEQ_PROCESS_ID();

      gui_jrnls_not_foud_exeption exception;

    BEGIN
      savepoint copy_journals_to_slr;
      process_id:=vProcessId;
      ...
      vSql :=
       'INSERT INTO slr_jrnl_headers_unposted (
          ...
          jhu_jrnl_total_hash_debit,jhu_jrnl_total_hash_credit,jhu_jrnl_total_lines,
          jhu_created_by,jhu_created_on,jhu_amended_by,jhu_amended_on,jhu_jrnl_pref_static_src,
          jhu_manual_flag,jhu_epg_id,jhu_jrnl_rev_date,jhu_department_id)
       SELECT
          gjhu.jhu_jrnl_id,
          gjhu.jhu_jrnl_type,
          gjhu.jhu_jrnl_date,
          ...
          coalesce(to_char(gjhu.jhu_jrnl_source_jrnl_id), to_char(gjhu.jhu_jrnl_id)),
        ...
        SELECT
            ...
            coalesce(to_char(gjlu.jlu_source_jrnl_id), to_char(jlu_jrnl_hdr_id)),
            ...
            gjlu.jlu_base_rate,
            gjlu.jlu_base_ccy,
            case when ent_apply_fx_translation = ''Y'' or gjlu.jlu_base_amount is not null then gjlu.jlu_base_amount else 0 end,
            gjlu.jlu_local_rate,
            gjlu.jlu_local_ccy,
            case when ent_apply_fx_translation = ''Y'' or gjlu.jlu_local_amount is not null then gjlu.jlu_local_amount else 0 end,
            gjlu.jlu_created_by,
            gjlu.jlu_created_on,
            gjlu.jlu_amended_by,
            gjlu.jlu_amended_on,
     ...
     loop
        ...
        returning JF_FILE_ID into v_file_id;

        INSERT INTO slr.slr_jrnl_file_attachment
        ( JFA_JH_JRNL_ID,
          JFA_JF_FILE_ID
        )
        SELECT
        jrnl_file_rec.jf_jrnl_hdr_id,
         v_file_id
        FROM DUAL;
    ...
    exception
      WHEN gui_jrnls_not_foud_exeption then
        pr_error(1, 'Journals ('||journal_id_list||') not found in gui or not in ''Q'' status', 0, 'prui_copy_journals_to_slr', 'gui_jrnl_headers_unposted', NULL, NULL, gPackageName, 'PL/SQL', NULL, NULL, NULL, NULL, NULL, NULL, NULL);
        raise;
      WHEN others THEN
        rollback to savepoint copy_journals_to_slr;
        pr_error(1, SQLERRM||': '||dbms_utility.format_error_backtrace, 0, 'prui_copy_journals_to_slr', 'slr_jrnl_headers_unposted/slr_jrnl_lines_unposted', NULL, NULL, gPackageName, 'PL/SQL', NULL, NULL, NULL, NULL, NULL, NULL, NULL);

        IF jrnl_file_cursor%isopen THEN
          close jrnl_file_cursor;
        end if;
    ...
    IS
      ...
      lv_header_id_list  VARCHAR2 (10000); -- AG custom
    ...
    BEGIN
        ...
        DBMS_LOCK.ALLOCATE_UNIQUE('MAH_PROCESS_SLR_' || epg_id, lv_lock_handle);

        lv_lock_result := DBMS_LOCK.REQUEST(lv_lock_handle, DBMS_LOCK.X_MODE, 5, false);
        ...
        BEGIN
         ...
         --AG Custom process elimination records for each journal header
          ...
          prui_copy_journals_to_slr(epg_id, lv_journal_id_list, lv_process_id);
          COMMIT;
          -- end AG Custom

        exception
          WHEN others THEN
            prui_set_gui_jrnls_status(journal_id_list,'E');
            commit;
      ...
      EXCEPTION
          WHEN OTHERS THEN
              pr_error(1, SQLERRM, 0, 'prui_post_queued_journals', 'preparation_and_validation', NULL, NULL, gPackageName, 'PL/SQL', NULL, NULL, NULL, NULL, NULL, NULL, NULL);
      ...
      IF fnui_anything_to_post(lv_journal_id_list,gSTATUS_VALIDATED) THEN
        ...
        exception
          WHEN others THEN
            pr_error(1, SQLERRM, 0, 'prui_post_queued_journals', 'slr_post', NULL, NULL, gPackageName, 'PL/SQL', NULL, NULL, NULL, NULL, NULL, NULL, NULL);
        end;
      END IF;
    ...
    EXCEPTION
      WHEN epg_locked_exception THEN
        status := 'L';
      WHEN batch_critical_exception THEN
        --delete all copied to slr journals, copy errors to gui--
        prui_rollback_err_slr_journals(epg_id => epg_id,journal_id_list => lv_journal_id_list, rollback_all => TRUE);
  ...
  PROCEDURE prui_create_reversing_journal(epg_id in varchar2, journal_id_list in varchar2, process_id NUMBER, status in char)
   ...
   BEGIN
    ...
    WHERE sjhu.jhu_jrnl_id in ('||journal_id_list||')
    AND sjhu.jhu_jrnl_status = :status
    AND sjhu.jhu_jrnl_process_id = :process_id
    AND sjhu.jhu_jrnl_type = ejt.ejt_type
    AND jt.jt_type = ejt.ejt_jt_type
    AND (jt.jt_reverse_flag = ''Y'' or jt.jt_reverse_flag = ''C'')' ;

    EXECUTE IMMEDIATE vSql into vRevJrnlCount USING status, process_id;

    IF vRevJrnlCount > 0 THEN
    ...
    exception
      ...
      pr_error(1, SQLERRM, 0, 'prui_create_reversing_journal.2', 'slr_jrnl_headers_unposted/slr_jrnl_lines_unposted', NULL, NULL, gPackageName, 'PL/SQL', NULL, NULL, NULL, NULL, NULL, NULL, NULL);
      ...
      execute immediate
       'INSERT INTO gui_jrnl_line_errors (
        ...
        jle_error_code, jle_error_string, jle_created_by, jle_created_on,
        jle_amended_by, jle_amended_on)
       SELECT  :process_id, jhu_jrnl_source_jrnl_id, 0,
      ...
      'UPDATE slr_jrnl_lines_unposted sjlu
       ...
       AND sjlu.jlu_jrnl_process_id = :process_id
       AND sjlu.jlu_epg_id = '''||epg_id||''''
      using status, status, process_id;
   ...
   exception
      WHEN others THEN
        pr_error(1, SQLERRM, 0, 'prui_create_reversing_journal', 'slr_jrnl_headers_unposted/slr_jrnl_lines_unposted', NULL, NULL, gPackageName, 'PL/SQL', NULL, NULL, NULL, NULL, NULL, NULL, NULL);
        raise;
   ...
   BEGIN
     ...
     IF NOT rollback_all THEN
        vSql := vSql||' and exists (select 1 from slr_jrnl_headers_unposted sjhu
          where sjhu.jhu_jrnl_id in ('||journal_id_list||')
     ...
     'insert into gui_jrnl_line_errors (
        ...
        jle_error_code, jle_error_string, jle_created_by, jle_created_on,
        jle_amended_by, jle_amended_on)
     select jle_jrnl_process_id, gjhu.jhu_jrnl_id, jle_jrnl_line_number,
            jle_error_code, jle_error_string, jle_created_by, jle_created_on,
            jle_amended_by, jle_amended_on
     from   slr_jrnl_line_errors jle, slr_jrnl_headers_unposted jhu, gui_jrnl_headers_unposted gjhu
     where  jle_jrnl_hdr_id = jhu.jhu_jrnl_id
     and    jhu.jhu_jrnl_id = gjhu.jhu_jrnl_id
     and    jhu.jhu_jrnl_process_id = coalesce(:process_id, jhu.jhu_jrnl_process_id)
     and    jhu.jhu_jrnl_id in ('||journal_id_list||')';
     IF not rollback_all THEN
     ...
     where jlu_jrnl_hdr_id in ('||journal_id_list||')
     ...
     select jhu_jrnl_id from slr_jrnl_headers_unposted where jhu_jrnl_id in ('||journal_id_list||')';
     IF NOT rollback_all THEN
        vSql := vSql||' and jhu_jrnl_status in (''E'',''V'')';
     END IF;
     vSql := vSql||') and jle_jrnl_process_id = coalesce(to_char(:process_id), jle_jrnl_process_id)';
     ...
     where jlu_jrnl_hdr_id in (
      select c.jhu_jrnl_id from slr_jrnl_headers_unposted c
      where c.jhu_jrnl_id <> c.jhu_jrnl_ref_id and c.jhu_jrnl_ref_id in
      (select p.jhu_jrnl_id from slr_jrnl_headers_unposted p where p.jhu_jrnl_id in ('||journal_id_list||')';
     IF NOT rollback_all THEN
        vSql := vSql||' and p.jhu_jrnl_status in (''E'',''V'')';
     END IF;
     vSql := vSql||')) and jlu_jrnl_process_id = coalesce(:process_id, jlu_jrnl_process_id) and jlu_epg_id = '''||epg_id||'''';
     ...
     IF NOT rollback_all THEN
        vSql := vSql||' and p.jhu_jrnl_status in (''E'',''V'')';
     END IF;
     vSql := vSql||') and jhu_jrnl_process_id = coalesce(:process_id, jhu_jrnl_process_id)';

     EXECUTE IMMEDIATE vSql USING process_id;

     vSql := 'select jfa_jf_file_id
        from slr.slr_jrnl_file_attachment
        where jfa_jh_jrnl_id in (select jhu_jrnl_id from slr_jrnl_headers_unposted  where jhu_jrnl_id in ('||journal_id_list||')';
     IF NOT rollback_all THEN
        vSql := vSql||' and jhu_jrnl_status in (''E'',''V'')';
     END IF;
     vSql := vSql||')';
   ...
   /* build attachment file id list */
      ...
      loop
        ...
        IF v_file_id_list IS NOT NULL THEN
      ...
      IF v_file_id_list IS NOT NULL THEN
      vSql := 'delete from slr.slr_jrnl_file_attachment
      where jfa_jf_file_id in ('||v_file_id_list||')';
     ...
     where jhu_jrnl_id in ('||journal_id_list||')
     and jhu_jrnl_process_id = coalesce(:process_id, jhu_jrnl_process_id)';
     IF not rollback_all THEN
        vSql := vSql||' and jhu_jrnl_status in (''E'',''V'')';
     END IF;
  ...
  BEGIN
    --delete journals posted to slr from gui tables, those will have the 'Q' status as oposed to the failed journals ('E' status).--
     ...
     -- In the following AG had customized where sjhu.jhu_jrnl_id = gjhu.jhu_jrnl_id by substituting  sjhu.jhu_jrnl_id in ('||journal_id_list||')  In two places
     -- Allowing the base version to overrite our customization
  ...
  EXCEPTION
        WHEN OTHERS THEN
            pr_error(1, SQLERRM, 0, 'prui_set_gui_jrnls_status', 'gui_jrnl_headers_unposted/gui_jrnl_lines_unposted', NULL, NULL, gPackageName, 'PL/SQL', NULL, NULL, NULL, NULL, NULL, NULL, NULL);
            raise;
  ...
  exception
    WHEN others THEN
      pr_error(1, SQLERRM, 0, 'fnui_anything_to_post', 'slr_jrnl_headers_unposted', NULL, NULL, gPackageName, 'PL/SQL', NULL, NULL, NULL, NULL, NULL, NULL, NULL);
      raise;
  ...
  BEGIN
    ...
    WHERE JLU_EPG_ID = '''||epg_id||'''
    and jlu_jrnl_status = :status
    and jlu_jrnl_hdr_id in (select jhu_jrnl_id from slr_jrnl_headers_unposted
      where jhu_jrnl_id in ('||journal_id_list||') and jhu_jrnl_status = ''W'')'
    USING status;

  exception
    WHEN others THEN
      pr_error(1, SQLERRM, 0, 'prui_mark_future_dated_jrnls', 'slr_jrnl_headers_unposted/slr_jrnl_lines_unposted', NULL, NULL, gPackageName, 'PL/SQL', NULL, NULL, NULL, NULL, NULL, NULL, NULL);
      raise;
...
--BEGIN
--      RETURN '(
--        select standard_hash(regexp_substr('''||journal_id_list||''', ''[^,]+'', 1, level), ''MD5'') from dual
--        connect by regexp_substr('''||journal_id_list||''', ''[^,]+'', 1, level) is not null
--      )';
--  END fnui_get_standard_hash_sql;
   ...
   --********************************************************************************
   -- AG custom 
   FUNCTION fnui_validate_madj_effective_date -- AG Custom
      RETURN BOOLEAN
   IS
      lvFound     NUMBER := NULL;
      lvSuccess   BOOLEAN;
         ...
         INSERT INTO temp_gui_jrnl_line_errors (jle_jrnl_process_id,
            ...
            SELECT                                   /* jle_jrnl_process_id */
                  0,
                   ...
                   'MADJ-1010',
                   /* jle_error_string */
                   'Effective Date can not be JAN 1',
                   /* jle_created_by */
                   'SYSTEM',
                   /* jle_created_on */
                   SYSDATE,
             ...
             WHERE     jlu_jrnl_hdr_id = gJournalHeader.jhu_jrnl_id
                   AND user_session_id = gSessionId
                   AND to_number(to_char(jlu_effective_date,'MM')) = 1 and to_number(to_char(jlu_effective_date,'DD')) = 1;
      EXCEPTION
         WHEN OTHERS
         THEN
            pr_error (1,
                      SQLERRM,
                      0,
                      'fnui_validate_madj_effective_date',
                      'vw_ui_madj_source_system',
                      NULL,
                      NULL,
                      gPackageName,
   ...
   EXCEPTION
      ...
      THEN
         pr_error (1,
                   ...
                   NULL);
         RETURN FALSE;
   END fnui_validate_madj_effective_date;
