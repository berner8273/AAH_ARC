create or replace view slr.vbm_ag_retainedearningseba01
(
   key_id,
   fak_id,
   balance_type,
...
as
   select /*+ parallel(slr_eba_daily_balances )*/
    ...
    where ea.ea_account_type_flag = 'P' and edb.edb_balance_type = 50
    and (ea.ea_account like '4%'
         or ea.ea_account like '5%'
         or ea.ea_account like '6%'
         or ea.ea_account like '7%'
         or ea.ea_account like '9%'
         or ea.ea_account like '31460150%');
