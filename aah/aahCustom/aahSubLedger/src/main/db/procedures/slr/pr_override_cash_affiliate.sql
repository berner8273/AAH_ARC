...
JLU_EBA_ID=standard_hash(
          jlu_entity||jlu_epg_id||jlu_account||jlu_segment_1||jlu_segment_2||jlu_segment_3||'NVS'||jlu_segment_5||jlu_segment_6||jlu_segment_7||jlu_segment_8||jlu_segment_9||jlu_segment_10||jlu_tran_ccy||
          jlu_attribute_1||jlu_attribute_2||jlu_attribute_3||jlu_attribute_4||jlu_attribute_5,
        'MD5')
 WHERE     SUBSTR (JLU_ACCOUNT, 1, 8) <> '18250255'
