create or replace view stn.hopper_event_group
as
select
       fsrgl.srlk_lkt_lookup_type_code  feed_typ
     , fsrgl.srlk_match_key1            event_grp
     , fsrgl.srlk_lookup_value1         event_grp_descr
     , fsrgl.srlk_effective_from        effective_from
     , fsrgl.srlk_effective_to          effective_to
     , fsrgl.srlk_active                event_grp_sts
 ...
 where
       fsrgl.srlk_lkt_lookup_type_code = 'EVENT_GROUP'
  with
       check option
     ;