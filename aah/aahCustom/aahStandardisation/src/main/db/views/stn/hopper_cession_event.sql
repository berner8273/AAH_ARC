...
/* Formatted on 04/11/2024 12:51:42 PM (QP5 v5.252.13127.32847) */
CREATE OR REPLACE FORCE VIEW STN.HOPPER_CESSION_EVENT
(
   BUSINESS_UNIT,
   BOOK_CD,
   CHARTFIELD_1,
   ...
   BEQUEATH DEFINER
AS
   SELECT fsrae.srae_gl_entity business_unit,
...
GRANT SELECT ON STN.HOPPER_CESSION_EVENT TO AAH_READ_ONLY;