create table stn.accounting_basis_ledger
(
...
,   basis_descr             varchar2 ( 80 char )                                              not null
,   basis_cat               varchar2 ( 1 char )                                               not null
...
,   constraint pk_abl primary key ( row_sid )
,   constraint uk_abl unique      ( ledger_cd, basis_cd, feed_uuid )
);