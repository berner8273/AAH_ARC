...
,   owner_derivation_method           varchar2 ( 20 char )  not null
,   cparty_derivation_method          varchar2 ( 20 char )  not null
...
,   constraint ck_owner_derivation_method     check       ( owner_derivation_method     in ( 'CESSION' , 'PARENT_CESSION' , 'N/A' ) )
,   constraint ck_cparty_derivation_method    check       ( cparty_derivation_method    in ( 'CESSION' , 'PARENT_CESSION' , 'N/A' ) )
);