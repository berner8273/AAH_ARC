  ...
  LOOP    
         ...
         INSERT INTO SLR_FAK_DAILY_BALANCES
            ...
            ON fdb1.FDB_ENTITY = EP_ENTITY
                AND fdb1.FDB_BALANCE_DATE < EP_BUS_PERIOD_END
                AND fdb1.FDB_BALANCE_DATE >= EP_BUS_PERIOD_START
                AND fdb1.FDB_BALANCE_DATE <= pDate
            ...
            WHERE
                ...
                AND fdb1.FDB_BALANCE_TYPE = r_jt.BAL_TYPE
                AND fdb1.FDB_BALANCE_DATE =
												(   SELECT MAX(FDB_BALANCE_DATE)
                                                    FROM SLR_FAK_DAILY_BALANCES fdb
                                                    WHERE fdb1.FDB_BALANCE_TYPE = fdb.FDB_BALANCE_TYPE
                                                        AND fdb1.FDB_FAK_ID = fdb.FDB_FAK_ID
                                                        AND fdb.FDB_BALANCE_DATE < EP_BUS_PERIOD_END
                                                        AND fdb.FDB_BALANCE_DATE >= EP_BUS_PERIOD_START
                                                        AND fdb.FDB_BALANCE_DATE <= pDate
                                                        AND fdb1.FDB_ENTITY = fdb.FDB_ENTITY
                                                        AND fdb1.FDB_EPG_ID = fdb.FDB_EPG_ID
                                                )
               ;
