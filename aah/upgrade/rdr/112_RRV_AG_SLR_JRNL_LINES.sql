CREATE OR REPLACE FORCE EDITIONABLE VIEW RDR.RRV_AG_SLR_JRNL_LINES (JL_JRNL_HDR_ID, JL_JRNL_LINE_NUMBER, JL_FAK_ID, JL_EBA_ID, JL_JRNL_STATUS, JL_JRNL_STATUS_TEXT, JL_JRNL_PROCESS_ID, JL_DESCRIPTION, JL_SOURCE_JRNL_ID, EFFECTIVE_DATE, POSTING_PERIOD, BUSINESS_UNIT, JL_EPG_ID, SUB_ACCOUNT, LEDGER, ACCOUNTING_BASIS, DEPARTMENT, AFFILIATE, CHARTFIELD1, EXECUTION_TYPE, BUSINESS_TYPE, POLICY_ID, STREAM, TAX_JURISDICTION, PREMIUM_TYPE, ACCOUNTING_EVENT_TYPE, JOURNAL_DESCR, GROSS_STREAM_OWNER, UNDERWRITING_YEAR, OWNER_ENTITY, BUSINESS_EVENT_TYPE, ACCIDENT_YEAR, INT_EXT_COUNTERPARTY, CURRENCY, TRANSACTION_AMT, REPORTING_RATE, REPORTING_CURRENCY, REPORTING_AMT, FUNCTIONAL_RATE, FUNCTIONAL_CURRENCY, FUNCTIONAL_AMT, JL_CREATED_BY, JL_CREATED_ON, JL_AMENDED_BY, JL_AMENDED_ON, JL_RECON_STATUS, JL_TRANSLATION_DATE, JL_BUS_POSTING_DATE, JL_PERIOD_MONTH, JL_PERIOD_YEAR, JL_PERIOD_LTD, JL_TYPE, CORRELATION_UUID, EVENT_SEQ_ID, POSTING_INDICATOR, JLU_JRNL_TYPE, JLU_JRNL_DATE, JLU_JRNL_DESCRIPTION, JLU_JRNL_SOURCE, JLU_JRNL_SOURCE_JRNL_ID, JLU_JRNL_AUTHORISED_BY, JLU_JRNL_AUTHORISED_ON, JLU_JRNL_VALIDATED_BY, JLU_JRNL_VALIDATED_ON, JLU_JRNL_POSTED_BY, JLU_JRNL_POSTED_ON, JLU_JRNL_TOTAL_HASH_DEBIT, JLU_JRNL_TOTAL_HASH_CREDIT, JLU_JRNL_PREF_STATIC_SRC, JLU_JRNL_REF_ID, JLU_JRNL_REV_DATE, JLU_TRANSLATION_DATE, JLU_PERIOD_MONTH, JLU_PERIOD_YEAR, JLU_PERIOD_LTD, JLU_JRNL_INTERNAL_PERIOD_FLAG, JLU_JRNL_ENT_RATE_SET) AS 
