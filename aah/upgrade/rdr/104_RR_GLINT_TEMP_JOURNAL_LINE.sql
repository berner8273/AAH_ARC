DROP TABLE RR_GLINT_TEMP_JOURNAL_LINE;

CREATE GLOBAL TEMPORARY TABLE RDR.RR_GLINT_TEMP_JOURNAL_LINE 
(
  JH_JRNL_ID VARCHAR2(32) NOT NULL ENABLE, 
  ...
  JOURNAL_DATE DATE, 
  JOURNAL_LINE NUMBER(9,0), 
  ACCOUNTING_DT DATE, 
  FISCAL_YEAR NUMBER(4,0), 
  ACCOUNTING_PERIOD NUMBER(3,0), 
...
CREATE BITMAP INDEX RDR.XIE1GL_PREVIOUS_FLAG ON RDR.RR_GLINT_TEMP_JOURNAL_LINE (PREVIOUS_FLAG) ;
