...
BEGIN
    ...
    SELECT COUNT(*) INTO i FROM USER_CONSTRAINTS WHERE CONSTRAINT_NAME = 'XPK_RR_GLINT_TO_SLR_AG' and table_name = 'BAK_RR_GLINT_TO_SLR_AG';
    ...
    --rename pk constraint add add primary key 
    SELECT COUNT(*) INTO i FROM USER_CONSTRAINTS WHERE CONSTRAINT_NAME = 'BAK_XPK_RR_GLINT_TO_SLR_AG' and table_name = 'BAK_RR_GLINT_TO_SLR_AG';
    IF i = 0 THEN
        EXECUTE IMMEDIATE 'ALTER TABLE BAK_RR_GLINT_TO_SLR_AG RENAME CONSTRAINT XPK_RR_GLINT_TO_SLR_AG TO BAK_XPK_RR_GLINT_TO_SLR_AG';
    END IF;

    SELECT COUNT(*) INTO i FROM USER_CONSTRAINTS WHERE index_name = 'XPK_RR_GLINT_TO_SLR_AG' and table_name = 'RR_GLINT_TO_SLR_AG';
    IF i = 0 THEN
        EXECUTE IMMEDIATE 'ALTER TABLE RR_GLINT_TO_SLR_AG ADD CONSTRAINT XPK_RR_GLINT_TO_SLR_AG PRIMARY KEY (RGJL_ID, JL_JRNL_HDR_ID, JL_JRNL_LINE_NUMBER)';
    END IF;   
