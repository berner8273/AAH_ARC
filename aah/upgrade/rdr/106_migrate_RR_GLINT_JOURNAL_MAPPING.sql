ALTER INDEX XPK_GLINT_JOURNAL_MAPPING RENAME TO BAK_XPK_GLINT_JOURNAL_MAPPING;
ALTER INDEX XIF1GL_INTERFACE_JOURNAL_MAPPI RENAME TO BAK_INDEXXIF1GL_INTERFACE_JOURNAL_MAPPI;
ALTER INDEX XIF2GL_INTERFACE_JOURNAL_MAPPI RENAME TO BAK_INDEXXIF2GL_INTERFACE_JOURNAL_MAPPI;
ALTER TABLE RR_GLINT_JOURNAL_MAPPING RENAME CONSTRAINT XPK_GLINT_JOURNAL_MAPPING TO BAK_XPK_GLINT_JOURNAL_MAPPING;
ALTER TABLE RR_GLINT_JOURNAL_MAPPING RENAME CONSTRAINT GLINT_BC_JM TO BAK_GLINT_BC_JM;
ALTER TABLE RR_GLINT_JOURNAL_MAPPING RENAME CONSTRAINT GLINT_JM_J TO BAK_GLINT_JM_J;
ALTER TABLE RR_GLINT_JOURNAL_MAPPING RENAME TO BAK_RR_GLINT_JOURNAL_MAPPING;
