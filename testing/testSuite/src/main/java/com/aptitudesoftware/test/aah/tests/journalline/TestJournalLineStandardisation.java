...
public class TestJournalLineStandardisation extends AAHTest
{
    ...
    public void testSingleValidFeedCE () throws Exception
    {
        ...
        SEED_TABLES.add(
            new AAHSeedTable( AAHTablenameConstants.INSURANCEC_POLICY_TAX_JURISD,
            PATH_TO_TEST_RESOURCES,
            "SeedData.xlsx"));
        ...
        cleardown ();
        AAHBusinessDateOperations.setBusinessDate ( LocalDate.of ( 2018 , 9 , 30 ) , 1 );
        ArrayList<AAHStep> steps = new ArrayList<AAHStep> ();
        ...
        steps.add(AAHStep.processGLComboEdit);
				...
				steps.add(AAHStep.processJournal_lines);
				steps.add(AAHStep.processSLR);
    ...
    public void testDayOnDayProcessingCE () throws Exception
  	{  	
        ...
        setupTest();
        AAHBusinessDateOperations.setBusinessDate ( LocalDate.of ( 2017 , 11 , 23 ) , 1 );
				steps.add(AAHStep.processJournalLines);
				steps.add(AAHStep.processSLR);              
        for (AAHStep pStep : steps) {
        	runStep(pStep.getName());
