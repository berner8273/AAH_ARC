    ...
    private void bindCellValueToSQL ( final PreparedStatement pStmt , final Cell pCell , final ExcelColumnDetails pColumnDetails , final int pNumSQLColumns) throws Exception
    {
        ...
        else
        {
            if ( pColumnDetails.isDate )
            {
                ...
                pCell.setCellType(Cell.CELL_TYPE_NUMERIC);
            ...
            else if ( pColumnDetails.isNumber )
            {
                ...
                pStmt.setDouble ( PARAMETER_INDEX , pCell.getNumericCellValue () );
            ...
            else if ( pColumnDetails.isInteger )
            {
                ...
                pStmt.setInt ( PARAMETER_INDEX , ( int ) ( pCell.getNumericCellValue () ) );
            ...
            else
            {
                if ( pCell.getCellType () == Cell.CELL_TYPE_NUMERIC )
                {
                    ...
                    pStmt.setString ( PARAMETER_INDEX , String.valueOf ( pCell.getNumericCellValue () ) );
                ...
                else
                {
                    ...
                    pStmt.setString ( PARAMETER_INDEX , pCell.getStringCellValue () );
