create table stn.cev_intercompany_data
(
...
;
  ...
  GRANT UPDATE ON "STN"."CEV_INTERCOMPANY_DATA" TO "AUTOMATED_UNIT_TEST";
  GRANT SELECT ON "STN"."CEV_INTERCOMPANY_DATA" TO "AUTOMATED_UNIT_TEST";
  GRANT INSERT ON "STN"."CEV_INTERCOMPANY_DATA" TO "AUTOMATED_UNIT_TEST";
  GRANT DELETE ON "STN"."CEV_INTERCOMPANY_DATA" TO "AUTOMATED_UNIT_TEST";
  GRANT ALTER ON "STN"."CEV_INTERCOMPANY_DATA" TO "AUTOMATED_UNIT_TEST";
