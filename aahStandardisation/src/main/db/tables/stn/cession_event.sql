...
,   premium_typ         varchar2 ( 1 char )                                    null
...
,   constraint uk_cev unique      ( feed_uuid , correlation_uuid , event_id , accounting_dt , stream_id , basis_cd , premium_typ , business_typ )
);