...
as
   select
        ...
        , fsra.sra_si_account_sys_inst_code                 sra_si_account_sys_inst_code
        , fsra.sra_si_instr_sys_inst_code                   sra_si_instr_sys_inst_code
        , fsra.sra_si_party_sys_inst_code                   sra_si_party_sys_inst_code
        , fsra.sra_si_static_sys_inst_code                  sra_si_static_sys_inst_code
        , fsra.sra_ae_pbu_ext_party_code                    sra_ae_pbu_ext_party_code
        , fsra.sra_ae_ipe_int_entity_code                   sra_ae_ipe_int_entity_code
        , fsra.sra_ae_aet_acc_event_type_code               sra_ae_aet_acc_event_type_code
        , fsra.sra_ae_cu_local_currency_code                sra_ae_cu_local_currency_code
        , fsra.sra_ae_cu_base_currency_code                 sra_ae_cu_base_currency_code
        , fsra.sra_ae_i_instrument_clicode                  sra_ae_i_instrument_clicode
        , fsra.sra_ae_it_instr_type_code                    sra_ae_it_instr_type_code
        , fsra.sra_ae_itc_inst_typ_cls_code                 sra_ae_itc_inst_typ_cls_code
        , fsra.sra_ae_pe_person_code                        sra_ae_pe_person_code
        , fsra.sra_ae_gl_instrument_id                      sra_ae_gl_instrument_id
        , fsra.process_id                                   process_id
