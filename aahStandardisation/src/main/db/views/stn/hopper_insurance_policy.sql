...
select
     ...
     , fsrip.srin_cover_note_description            policy_name
     , fsrip.srin_cost_centre_code                  original_policy_id
     , fsrip.srin_party_id1                         underwriting_le_cd
     , fsrip.srin_party_id2                         external_reinsurer_le_cd
     , fsrip.srin_t_client_text10                   accident_yr
     , fsrip.srin_trade_date                        close_dt
     , fsrip.srin_date1                             expected_maturity_dt
     , fsrip.srin_date2                             actual_maturity_dt
     , fsrip.srin_fee                               underwriting_yr
     ...
     , fsrip.srin_t_client_text6                    line_of_business_cd
     ...
     , fsrip.srin_t_client_text9                    is_uncollectable
     ...
     , fsrip.srin_party_id3                         rpt_le_cd
     ...
     , fsrip.srin_cover_signed                      vie_cd
