    ...
    BEGIN
        INSERT INTO HOPPER_CESSION_EVENT
            ...
            SELECT
                ...
                cep.POLICY_PREMIUM_TYP AS PREMIUM_TYP,
                ...
                'Client Static' AS PARTY_BUSINESS_SYSTEM_CD,
                cep.EVENT_TYP AS AAH_EVENT_TYP,
                'Client Static' AS SRAE_STATIC_SYS_INST_CODE,
                'Client Static' AS SRAE_INSTR_SYS_INST_CODE,
                (CASE
                    WHEN cep.TRANSACTION_AMT > 0 THEN 'POS'
                    ELSE 'NEG'
                END) AS TRANSACTION_POS_NEG,
                'DEFAULT' AS SRAE_GL_PERSON_CODE,
                cep.BUSINESS_UNIT AS DEPT_CD,
                'DEFAULT' AS SRAE_SOURCE_SYSTEM,
                'INSURANCE_POLICY' AS SRAE_INSTR_SUPER_CLASS,
                'INSURANCE_POLICY' AS SRAE_INSTRUMENT_CODE,
                ...
                'X' AS CHARTFIELD_1,
                'X' AS COUNTERPARTY_LE_CD,
                'A' AS EXECUTION_TYP,
                1 AS OWNER_LE_ID,
                'Descr' AS JOURNAL_DESCR,
                ...
                'POLICY_DIRTY' AS BUSINESS_EVENT_TYP,
                1 AS EVENT_SEQ_ID,
