create or replace view slr.v_slr_fxreval_rule1_events(accounting_basis , source_event , execution_type, premium_type, business_type, event_class, fx_event_type) as 
select distinct 
